{	
	...
	"NODE11": {
		...
		"edge":{
			"location.latent.true": {"NODE21": 0.9, "NODE22": 0.1},
			"location.latent.false": {"NODE21": 0.1, "NODE22": 0.9}
		}
	},
	"NODE12": {
		"sent": 
		...
		"edge": {
			"location.latent.true": {"NODE21": 0.1, "NODE22": 0.9},
			"location.latent.false": {"NODE21": 0.9, "NODE22": 0.1}
		}
	},
	...
	"NODE21": {
		...
		"edge":{
			"location.latent.true": {"NODE31": 0.9, "NODE32": 0.1},
			"location.latent.false": {"NODE31": 0.1, "NODE32": 0.9}
		}
	},
	"NODE22": {
		"sent": 
		...
		"edge": {
			"location.latent.true": {"NODE31": 0.1, "NODE32": 0.9},
			"location.latent.false": {"NODE31": 0.9, "NODE32": 0.1}
		}
	},
