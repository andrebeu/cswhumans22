...
// CODE BODY START
	...
	var q_10 = {
		...
		labels: ["Before ordering cake, Kelly took a quarter from the tip jar.", "Before ordering cake, Roy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_12 = {
		...
		labels: ["Hannah then sat by the window, and read a book for hours.", "Kelly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_26 = {
		...
		labels: ["After ordering, Rebecca stole a salt shaker and left.", "After ordering, Kevin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		...
		labels: ["Before ordering cake, Carolyn took a quarter from the tip jar.", "Before ordering cake, Nicole took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_87 = {
		...
		labels: ["Before ordering cake, Jane took a quarter from the tip jar.", "Before ordering cake, Victoria took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_96 = {
		...
		labels: ["After ordering, Amber stole a salt shaker and left.", "After ordering, Karen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_101 = {
		...
		labels: ["Before ordering cake, Ethan took a quarter from the tip jar.", "Before ordering cake, Billy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["While ordering tea, Noah noticed the barista’s new mustache.", "While ordering tea, Grace noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["While ordering tea, Tyler noticed the barista’s new mustache.", "While ordering tea, Gabriel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_136 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Victoria waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Victoria noticed the barista’s new mustache.", "While ordering tea, Steven noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_166 = {
		...
		labels: ["After ordering, Gloria stole a salt shaker and left.", "After ordering, Megan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_173 = {
		...
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_185 = {
		...
		labels: ["Before ordering cake, Aaron took a quarter from the tip jar.", "Before ordering cake, Melissa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_192 = {
		...
		labels: ["Before ordering cake, Mary took a quarter from the tip jar.", "Before ordering cake, Kevin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["After ordering, Russell stole a salt shaker and left.", "After ordering, Scott stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["Jeffrey then sat by the window, and read a book for hours.", "John then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_257 = {
		...
		labels: ["Timothy then sat by the window, and read a book for hours.", "Maria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_269 = {
		...
		labels: ["Before ordering cake, Andrea took a quarter from the tip jar.", "Before ordering cake, Christian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_304 = {
		...
		labels: ["While ordering tea, Aaron noticed the barista’s new mustache.", "While ordering tea, Mary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_306 = {
		...
		labels: ["Aaron then sat by the window, and read a book for hours.", "Linda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_318 = {
		...
		labels: ["While ordering tea, Amanda noticed the barista’s new mustache.", "While ordering tea, Roger noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_320 = {
		...
		labels: ["After ordering, Amanda stole a salt shaker and left.", "After ordering, Helen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		...
		labels: ["After ordering, Nicole stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["Before ordering cake, Ashley took a quarter from the tip jar.", "Before ordering cake, Rachel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		...
		labels: ["Before ordering cake, Sean took a quarter from the tip jar.", "Before ordering cake, Lisa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_425 = {
		...
		labels: ["After ordering, Joshua stole a salt shaker and left.", "After ordering, Kyle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_493 = {
		type: "html-keyboard-response",
		stimulus: "<p> Albert was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Joshua took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		...
		labels: ["After ordering, Jose stole a salt shaker and left.", "After ordering, Albert stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		...
		labels: ["Before ordering cake, Timothy took a quarter from the tip jar.", "Before ordering cake, Kenneth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_530 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Logan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Logan stole a salt shaker and left.", "After ordering, Bruce stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_558 = {
		...
		labels: ["Andrew then sat by the window, and read a book for hours.", "Angela then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		...
		labels: ["While ordering tea, Paul noticed the barista’s new mustache.", "While ordering tea, Andrew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jeffrey was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Marilyn noticed the barista’s new mustache.", "While ordering tea, Jeffrey noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_635 = {
		...
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Jane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		...
		labels: ["After ordering, Keith stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_654 = {
		...
		labels: ["While ordering tea, Joyce noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_691 = {
		...
		labels: ["Gregory then sat by the window, and read a book for hours.", "Tyler then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["While ordering tea, Albert noticed the barista’s new mustache.", "While ordering tea, Austin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		...
		labels: ["After ordering, Janet stole a salt shaker and left.", "After ordering, Victoria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_808 = {
		...
		labels: ["Before ordering cake, Bruce took a quarter from the tip jar.", "Before ordering cake, Dennis took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_824 = {
		...
		labels: ["Nathan then sat by the window, and read a book for hours.", "Cheryl then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Ruth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_864 = {
		...
		labels: ["Before ordering cake, Justin took a quarter from the tip jar.", "Before ordering cake, Gary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_873 = {
		...
		labels: ["After ordering, Wayne stole a salt shaker and left.", "After ordering, Marilyn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["Before ordering cake, Lawrence took a quarter from the tip jar.", "Before ordering cake, Joe took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_920 = {
		...
		labels: ["Before ordering cake, Dylan took a quarter from the tip jar.", "Before ordering cake, Arthur took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		...
		labels: ["Jordan then sat by the window, and read a book for hours.", "Nathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Albert noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Albert then sat by the window, and read a book for hours.", "Justin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_983 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Stephanie waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Amber noticed the barista’s new mustache.", "While ordering tea, Stephanie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1074 = {
		type: "html-keyboard-response",
		stimulus: "<p> Albert was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Bruce noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1081 = {
		...
		labels: ["While ordering tea, Albert noticed the barista’s new mustache.", "While ordering tea, Jane noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1090 = {
		...
		labels: ["After ordering, Dennis stole a salt shaker and left.", "After ordering, Michael stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1097 = {
		...
		labels: ["After ordering, Patricia stole a salt shaker and left.", "After ordering, Steven stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1146 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Evelyn took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Harry then sat by the window, and read a book for hours.", "Evelyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1153 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Steven took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Steven then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Joe waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Joe took a quarter from the tip jar.", "Before ordering cake, Hannah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		type: "html-keyboard-response",
		stimulus: "<p> Madison was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Alan noticed the barista’s new mustache.", "While ordering tea, Madison noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1186 = {
		...
		labels: ["While ordering tea, Donald noticed the barista’s new mustache.", "While ordering tea, Julie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		...
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Joshua stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1216 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Diane took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Eric then sat by the window, and read a book for hours.", "Diane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		...
		labels: ["Before ordering cake, Theresa took a quarter from the tip jar.", "Before ordering cake, Lori took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1328 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jane took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jane stole a salt shaker and left.", "After ordering, Brenda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1361 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Albert waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Michael took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1391 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Teresa took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Carolyn then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Rachel took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Matthew then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
