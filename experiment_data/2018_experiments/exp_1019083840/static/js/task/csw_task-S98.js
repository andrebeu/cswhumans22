...
// CODE BODY START
	...
	var q_12 = {
		...
		labels: ["After ordering, Emma stole a salt shaker and left.", "After ordering, Dorothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_45 = {
		...
		labels: ["While ordering tea, Michelle noticed the barista’s new mustache.", "While ordering tea, Cynthia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_66 = {
		...
		labels: ["Before ordering cake, Emily took a quarter from the tip jar.", "Before ordering cake, Katherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_75 = {
		...
		labels: ["Natalie then sat by the window, and read a book for hours.", "Stephen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_108 = {
		...
		labels: ["Before ordering cake, Albert took a quarter from the tip jar.", "Before ordering cake, Zachary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		type: "html-keyboard-response",
		stimulus: "<p> Dorothy was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Laura noticed the barista’s new mustache.", "While ordering tea, Dorothy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["Alexis then sat by the window, and read a book for hours.", "Bruce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Stephen waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Roger took a quarter from the tip jar.", "Before ordering cake, Stephen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_173 = {
		...
		labels: ["After ordering, Elizabeth stole a salt shaker and left.", "After ordering, Adam stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["After ordering, Jose stole a salt shaker and left.", "After ordering, Rachel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["Before ordering cake, Madison took a quarter from the tip jar.", "Before ordering cake, Helen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_318 = {
		...
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Jane then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["Before ordering cake, Deborah took a quarter from the tip jar.", "Before ordering cake, Andrea took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_395 = {
		...
		labels: ["While ordering tea, Kenneth noticed the barista’s new mustache.", "While ordering tea, Emma noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_404 = {
		...
		labels: ["Carol then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_416 = {
		...
		labels: ["While ordering tea, Brandon noticed the barista’s new mustache.", "While ordering tea, Diane noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_437 = {
		...
		labels: ["Before ordering cake, Harry took a quarter from the tip jar.", "Before ordering cake, Kathleen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_451 = {
		type: "html-keyboard-response",
		stimulus: "<p> Michael was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Michael took a quarter from the tip jar.", "Before ordering cake, Dorothy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["Before ordering cake, Tiffany took a quarter from the tip jar.", "Before ordering cake, Amber took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_481 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Megan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Megan stole a salt shaker and left.", "After ordering, Heather stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jean waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Amy noticed the barista’s new mustache.", "While ordering tea, Jean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_570 = {
		...
		labels: ["While ordering tea, Martha noticed the barista’s new mustache.", "While ordering tea, Ethan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["While ordering tea, Olivia noticed the barista’s new mustache.", "While ordering tea, Judy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["While ordering tea, Barbara noticed the barista’s new mustache.", "While ordering tea, Matthew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["Before ordering cake, Pamela took a quarter from the tip jar.", "Before ordering cake, Nicholas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_621 = {
		...
		labels: ["Pamela then sat by the window, and read a book for hours.", "Megan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_640 = {
		...
		labels: ["Before ordering cake, Ethan took a quarter from the tip jar.", "Before ordering cake, Debra took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, William waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, William took a quarter from the tip jar.", "Before ordering cake, Austin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_705 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Lauren then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_712 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Samuel noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Samuel stole a salt shaker and left.", "After ordering, Alan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_726 = {
		...
		labels: ["After ordering, Christopher stole a salt shaker and left.", "After ordering, Kimberly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		...
		labels: ["Before ordering cake, Frank took a quarter from the tip jar.", "Before ordering cake, Ryan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		...
		labels: ["While ordering tea, Janet noticed the barista’s new mustache.", "While ordering tea, Sara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Andrew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		...
		labels: ["Before ordering cake, Richard took a quarter from the tip jar.", "Before ordering cake, Denise took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["While ordering tea, Justin noticed the barista’s new mustache.", "While ordering tea, Edward noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_920 = {
		...
		labels: ["Before ordering cake, Heather took a quarter from the tip jar.", "Before ordering cake, Laura took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_922 = {
		...
		labels: ["After ordering, Deborah stole a salt shaker and left.", "After ordering, Laura stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		...
		labels: ["While ordering tea, Tyler noticed the barista’s new mustache.", "While ordering tea, Jeremy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_983 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Joyce waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Shirley noticed the barista’s new mustache.", "While ordering tea, Joyce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_985 = {
		...
		labels: ["Joyce then sat by the window, and read a book for hours.", "Jeremy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1011 = {
		...
		labels: ["Before ordering cake, Gabriel took a quarter from the tip jar.", "Before ordering cake, Henry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Diane took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Diane stole a salt shaker and left.", "After ordering, Carol stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["Before ordering cake, Mark took a quarter from the tip jar.", "Before ordering cake, Ryan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		...
		labels: ["While ordering tea, Raymond noticed the barista’s new mustache.", "While ordering tea, Dennis noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["Dylan then sat by the window, and read a book for hours.", "Raymond then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1053 = {
		...
		labels: ["While ordering tea, Bruce noticed the barista’s new mustache.", "While ordering tea, Rose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1074 = {
		...
		labels: ["Before ordering cake, Nathan took a quarter from the tip jar.", "Before ordering cake, Janet took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1102 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Stephanie waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Stephanie noticed the barista’s new mustache.", "While ordering tea, Scott noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1109 = {
		...
		labels: ["While ordering tea, Amanda noticed the barista’s new mustache.", "While ordering tea, Heather noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		...
		labels: ["Juan then sat by the window, and read a book for hours.", "Olivia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1153 = {
		...
		labels: ["After ordering, Maria stole a salt shaker and left.", "After ordering, Martha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jennifer was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jennifer noticed the barista’s new mustache.", "While ordering tea, Kathleen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1179 = {
		type: "html-keyboard-response",
		stimulus: "<p> Kathleen was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Kathleen noticed the barista’s new mustache.", "While ordering tea, Cynthia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1230 = {
		...
		labels: ["After ordering, Dennis stole a salt shaker and left.", "After ordering, Ann stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1235 = {
		type: "html-keyboard-response",
		stimulus: "<p> Doris was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Doris noticed the barista’s new mustache.", "While ordering tea, Juan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1258 = {
		...
		labels: ["After ordering, Noah stole a salt shaker and left.", "After ordering, Evelyn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		type: "html-keyboard-response",
		stimulus: "<p> William was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Dennis noticed the barista’s new mustache.", "While ordering tea, William noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Christina noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Christina stole a salt shaker and left.", "After ordering, Victoria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		...
		labels: ["While ordering tea, Heather noticed the barista’s new mustache.", "While ordering tea, Adam noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Richard took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Richard then sat by the window, and read a book for hours.", "Charles then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1382 = {
		...
		labels: ["Before ordering cake, Mark took a quarter from the tip jar.", "Before ordering cake, Sean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
