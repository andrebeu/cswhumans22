...
// CODE BODY START
	...
	var q_63 = {
		...
		labels: ["Danielle then sat by the window, and read a book for hours.", "Kevin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_133 = {
		...
		labels: ["Logan then sat by the window, and read a book for hours.", "Bruce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_148 = {
		...
		labels: ["Abigail then sat by the window, and read a book for hours.", "Zachary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_228 = {
		...
		labels: ["After ordering, Vincent stole a salt shaker and left.", "After ordering, Charles stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Jessica then sat by the window, and read a book for hours.", "Angela then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_358 = {
		...
		labels: ["Diane then sat by the window, and read a book for hours.", "Catherine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_493 = {
		...
		labels: ["After ordering, Sean stole a salt shaker and left.", "After ordering, Katherine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		type: "html-keyboard-response",
		stimulus: "<p> Paul was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Paul stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["After ordering, Madison stole a salt shaker and left.", "After ordering, Nicholas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_693 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Diane waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Diane then sat by the window, and read a book for hours.", "Marilyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Judy waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Emily then sat by the window, and read a book for hours.", "Judy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_858 = {
		...
		labels: ["Ronald then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
