...
// CODE BODY START
	...
	var q_53 = {
		...
		labels: ["Joan then sat by the window, and read a book for hours.", "Patricia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["After ordering, Sharon stole a salt shaker and left.", "After ordering, Timothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_83 = {
		...
		labels: ["After ordering, Kyle stole a salt shaker and left.", "After ordering, Vincent stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		...
		labels: ["Amanda then sat by the window, and read a book for hours.", "Betty then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_148 = {
		...
		labels: ["Ralph then sat by the window, and read a book for hours.", "Angela then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_228 = {
		...
		labels: ["After ordering, Alan stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_343 = {
		...
		labels: ["Larry then sat by the window, and read a book for hours.", "Lisa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["After ordering, Stephen stole a salt shaker and left.", "After ordering, Samuel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_438 = {
		...
		labels: ["After ordering, Eric stole a salt shaker and left.", "After ordering, Victoria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_508 = {
		...
		labels: ["Brian then sat by the window, and read a book for hours.", "Sharon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_593 = {
		...
		labels: ["Diana then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_623 = {
		...
		labels: ["After ordering, Angela stole a salt shaker and left.", "After ordering, Eric stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_683 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Jonathan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_763 = {
		...
		labels: ["After ordering, Adam stole a salt shaker and left.", "After ordering, Justin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_788 = {
		...
		labels: ["After ordering, Emma stole a salt shaker and left.", "After ordering, Jose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_793 = {
		type: "html-keyboard-response",
		stimulus: "<p> Kevin was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Kevin then sat by the window, and read a book for hours.", "Jacqueline then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_888 = {
		...
		labels: ["After ordering, Rebecca stole a salt shaker and left.", "After ordering, Kyle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
