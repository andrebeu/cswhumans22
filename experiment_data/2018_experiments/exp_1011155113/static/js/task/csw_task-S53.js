...
// CODE BODY START
	...
	var q_58 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_228 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Emily waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Emily stole a salt shaker and left.", "After ordering, Larry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_238 = {
		...
		labels: ["After ordering, Eugene stole a salt shaker and left.", "After ordering, David stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Carol then sat by the window, and read a book for hours.", "Richard then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_258 = {
		...
		labels: ["After ordering, Mark stole a salt shaker and left.", "After ordering, Wayne stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_263 = {
		...
		labels: ["After ordering, Madison stole a salt shaker and left.", "After ordering, Danielle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_268 = {
		...
		labels: ["Katherine then sat by the window, and read a book for hours.", "Logan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_533 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Karen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_538 = {
		...
		labels: ["After ordering, Louis stole a salt shaker and left.", "After ordering, Russell stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		type: "html-keyboard-response",
		stimulus: "<p> Dorothy was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Dorothy then sat by the window, and read a book for hours.", "Jennifer then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_678 = {
		...
		labels: ["After ordering, Joseph stole a salt shaker and left.", "After ordering, Helen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_773 = {
		...
		labels: ["Hannah then sat by the window, and read a book for hours.", "Jessica then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_853 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Joe waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Joe stole a salt shaker and left.", "After ordering, Patricia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_858 = {
		...
		labels: ["Randy then sat by the window, and read a book for hours.", "Kathryn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
