...
// CODE BODY START
	...
	var q_53 = {
		...
		labels: ["After ordering, Albert stole a salt shaker and left.", "After ordering, Marie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_153 = {
		...
		labels: ["David then sat by the window, and read a book for hours.", "Emma then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_158 = {
		...
		labels: ["Edward then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_173 = {
		...
		labels: ["Angela then sat by the window, and read a book for hours.", "Scott then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_263 = {
		...
		labels: ["Alice then sat by the window, and read a book for hours.", "Danielle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_318 = {
		...
		labels: ["After ordering, Jack stole a salt shaker and left.", "After ordering, Dylan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_333 = {
		...
		labels: ["Denise then sat by the window, and read a book for hours.", "Julie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Randy then sat by the window, and read a book for hours.", "Zachary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_533 = {
		...
		labels: ["Lawrence then sat by the window, and read a book for hours.", "Gerald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_603 = {
		...
		labels: ["Heather then sat by the window, and read a book for hours.", "Dennis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_608 = {
		...
		labels: ["Kyle then sat by the window, and read a book for hours.", "Juan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_688 = {
		...
		labels: ["After ordering, Melissa stole a salt shaker and left.", "After ordering, Pamela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_718 = {
		...
		labels: ["After ordering, Hannah stole a salt shaker and left.", "After ordering, Terry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_863 = {
		...
		labels: ["After ordering, Dennis stole a salt shaker and left.", "After ordering, Lawrence stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_888 = {
		...
		labels: ["Kathryn then sat by the window, and read a book for hours.", "Laura then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
