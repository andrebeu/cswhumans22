...
// CODE BODY START
	...
	var q_63 = {
		...
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Billy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_238 = {
		...
		labels: ["After ordering, Olivia stole a salt shaker and left.", "After ordering, Jean stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_253 = {
		...
		labels: ["After ordering, Carol stole a salt shaker and left.", "After ordering, Gary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_258 = {
		...
		labels: ["Gabriel then sat by the window, and read a book for hours.", "Arthur then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_268 = {
		...
		labels: ["After ordering, Matthew stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_503 = {
		...
		labels: ["After ordering, Pamela stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["Bryan then sat by the window, and read a book for hours.", "Roy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_683 = {
		...
		labels: ["Jerry then sat by the window, and read a book for hours.", "Rebecca then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Elizabeth waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Elizabeth stole a salt shaker and left.", "After ordering, Alexis stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_798 = {
		...
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Stephen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_878 = {
		...
		labels: ["Tyler then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_888 = {
		...
		labels: ["After ordering, Arthur stole a salt shaker and left.", "After ordering, Jonathan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["After ordering, Emily stole a salt shaker and left.", "After ordering, Kevin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
