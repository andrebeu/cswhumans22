...
// CODE BODY START
	...
	var q_31 = {
		...
		labels: ["Before ordering cake, Albert took a quarter from the tip jar.", "Before ordering cake, Logan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_33 = {
		...
		labels: ["After ordering, Logan stole a salt shaker and left.", "After ordering, Heather stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_103 = {
		...
		labels: ["After ordering, Jacqueline stole a salt shaker and left.", "After ordering, Jacob stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_117 = {
		...
		labels: ["After ordering, Jacqueline stole a salt shaker and left.", "After ordering, Katherine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_129 = {
		...
		labels: ["Before ordering cake, Richard took a quarter from the tip jar.", "Before ordering cake, Nathan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_229 = {
		...
		labels: ["Abigail then sat by the window, and read a book for hours.", "Martha then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_234 = {
		...
		labels: ["Before ordering cake, Donna took a quarter from the tip jar.", "Before ordering cake, Amanda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Stephen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		...
		labels: ["After ordering, Louis stole a salt shaker and left.", "After ordering, Bruce stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["While ordering tea, Diana noticed the barista’s new mustache.", "While ordering tea, Grace noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["Before ordering cake, Heather took a quarter from the tip jar.", "Before ordering cake, Carol took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_341 = {
		...
		labels: ["Kathleen then sat by the window, and read a book for hours.", "Doris then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["After ordering, Anthony stole a salt shaker and left.", "After ordering, Samuel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_360 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Samuel waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, Samuel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["After ordering, Martha stole a salt shaker and left.", "After ordering, Doris stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_381 = {
		...
		labels: ["Before ordering cake, Nicholas took a quarter from the tip jar.", "Before ordering cake, Joe took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_383 = {
		...
		labels: ["Joe then sat by the window, and read a book for hours.", "Deborah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["Before ordering cake, Larry took a quarter from the tip jar.", "Before ordering cake, Amy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		...
		labels: ["While ordering tea, Karen noticed the barista’s new mustache.", "While ordering tea, Peter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_416 = {
		...
		labels: ["Before ordering cake, Douglas took a quarter from the tip jar.", "Before ordering cake, Joe took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_418 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Joe took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Joe then sat by the window, and read a book for hours.", "Rose then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_446 = {
		...
		labels: ["After ordering, Vincent stole a salt shaker and left.", "After ordering, Nicholas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_472 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Carolyn waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Alexis took a quarter from the tip jar.", "Before ordering cake, Carolyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_481 = {
		...
		labels: ["Christopher then sat by the window, and read a book for hours.", "Grace then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		...
		labels: ["While ordering tea, Ethan noticed the barista’s new mustache.", "While ordering tea, Nancy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_514 = {
		...
		labels: ["While ordering tea, Richard noticed the barista’s new mustache.", "While ordering tea, Adam noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["Before ordering cake, Margaret took a quarter from the tip jar.", "Before ordering cake, Henry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["Before ordering cake, Judith took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		...
		labels: ["While ordering tea, Gabriel noticed the barista’s new mustache.", "While ordering tea, Lisa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Lisa noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Kathryn then sat by the window, and read a book for hours.", "Lisa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_591 = {
		...
		labels: ["Before ordering cake, Andrew took a quarter from the tip jar.", "Before ordering cake, Kelly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_607 = {
		...
		labels: ["Jack then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Ann noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Eric then sat by the window, and read a book for hours.", "Ann then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Timothy noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Timothy then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		...
		labels: ["After ordering, Linda stole a salt shaker and left.", "After ordering, Philip stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_691 = {
		...
		labels: ["After ordering, Kyle stole a salt shaker and left.", "After ordering, Laura stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_705 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Zachary noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Zachary then sat by the window, and read a book for hours.", "Gloria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_731 = {
		...
		labels: ["Before ordering cake, Catherine took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_745 = {
		type: "html-keyboard-response",
		stimulus: "<p> Nathan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Nathan took a quarter from the tip jar.", "Before ordering cake, Melissa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["Laura then sat by the window, and read a book for hours.", "Victoria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_810 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Carolyn noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Andrew then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Doris noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Doris then sat by the window, and read a book for hours.", "Donald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		type: "html-keyboard-response",
		stimulus: "<p> Kyle was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Kenneth noticed the barista’s new mustache.", "While ordering tea, Kyle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_894 = {
		...
		labels: ["After ordering, Sharon stole a salt shaker and left.", "After ordering, Samantha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_899 = {
		...
		labels: ["While ordering tea, Stephanie noticed the barista’s new mustache.", "While ordering tea, Kathryn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_901 = {
		...
		labels: ["After ordering, Stephanie stole a salt shaker and left.", "After ordering, Rebecca stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_922 = {
		...
		labels: ["After ordering, Bobby stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_927 = {
		...
		labels: ["While ordering tea, Dorothy noticed the barista’s new mustache.", "While ordering tea, Russell noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		...
		labels: ["After ordering, Russell stole a salt shaker and left.", "After ordering, Arthur stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_934 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Kevin waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kevin took a quarter from the tip jar.", "Before ordering cake, Lauren took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Gary waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Gary took a quarter from the tip jar.", "Before ordering cake, Dylan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Christine waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Christine took a quarter from the tip jar.", "Before ordering cake, James took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1011 = {
		...
		labels: ["While ordering tea, Gregory noticed the barista’s new mustache.", "While ordering tea, Joe noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1013 = {
		...
		labels: ["After ordering, Gregory stole a salt shaker and left.", "After ordering, Doris stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["While ordering tea, Patrick noticed the barista’s new mustache.", "While ordering tea, Natalie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1032 = {
		...
		labels: ["While ordering tea, John noticed the barista’s new mustache.", "While ordering tea, Beverly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1034 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Beverly noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Beverly stole a salt shaker and left.", "After ordering, David stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		...
		labels: ["Before ordering cake, Hannah took a quarter from the tip jar.", "Before ordering cake, Sean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1067 = {
		...
		labels: ["Before ordering cake, Thomas took a quarter from the tip jar.", "Before ordering cake, Jean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1083 = {
		...
		labels: ["Ann then sat by the window, and read a book for hours.", "Gloria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1118 = {
		...
		labels: ["After ordering, Vincent stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1130 = {
		...
		labels: ["Before ordering cake, William took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		...
		labels: ["After ordering, William stole a salt shaker and left.", "After ordering, Judith stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		...
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1144 = {
		...
		labels: ["While ordering tea, Ethan noticed the barista’s new mustache.", "While ordering tea, Jack noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1153 = {
		...
		labels: ["Natalie then sat by the window, and read a book for hours.", "Dylan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1167 = {
		...
		labels: ["Mark then sat by the window, and read a book for hours.", "Carol then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1242 = {
		...
		labels: ["Before ordering cake, Daniel took a quarter from the tip jar.", "Before ordering cake, Mary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1251 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Sean noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Joyce then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		...
		labels: ["While ordering tea, Kyle noticed the barista’s new mustache.", "While ordering tea, Jason noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1272 = {
		...
		labels: ["Debra then sat by the window, and read a book for hours.", "Steven then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1279 = {
		...
		labels: ["Amanda then sat by the window, and read a book for hours.", "Aaron then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Gloria waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Gloria noticed the barista’s new mustache.", "While ordering tea, Vincent noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1300 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Joshua took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Jonathan then sat by the window, and read a book for hours.", "Joshua then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1319 = {
		...
		labels: ["Before ordering cake, Jerry took a quarter from the tip jar.", "Before ordering cake, Kathryn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1321 = {
		...
		labels: ["After ordering, Kathryn stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1342 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jennifer took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Eric stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1368 = {
		...
		labels: ["Before ordering cake, Jonathan took a quarter from the tip jar.", "Before ordering cake, Paul took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1384 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jeremy noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Elizabeth then sat by the window, and read a book for hours.", "Jeremy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
