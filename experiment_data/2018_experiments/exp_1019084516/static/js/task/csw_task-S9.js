...
// CODE BODY START
	...
	var q_3 = {
		...
		labels: ["Before ordering cake, Jerry took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
	...
	var q_24 = {
		...
		labels: ["While ordering tea, Ronald noticed the barista’s new mustache.", "While ordering tea, Edward noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_45 = {
		...
		labels: ["While ordering tea, Natalie noticed the barista’s new mustache.", "While ordering tea, Angela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Natalie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_80 = {
		...
		labels: ["Before ordering cake, Arthur took a quarter from the tip jar.", "Before ordering cake, Maria took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_101 = {
		...
		labels: ["Before ordering cake, Roy took a quarter from the tip jar.", "Before ordering cake, Gabriel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_103 = {
		...
		labels: ["Donald then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_124 = {
		...
		labels: ["Kyle then sat by the window, and read a book for hours.", "Brian then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_131 = {
		...
		labels: ["Rachel then sat by the window, and read a book for hours.", "Kathryn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_171 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Maria waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Elizabeth took a quarter from the tip jar.", "Before ordering cake, Maria took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_194 = {
		...
		labels: ["After ordering, Deborah stole a salt shaker and left.", "After ordering, Carl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Julie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["While ordering tea, Lori noticed the barista’s new mustache.", "While ordering tea, Amber noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_234 = {
		...
		labels: ["Before ordering cake, Timothy took a quarter from the tip jar.", "Before ordering cake, Marilyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_257 = {
		...
		labels: ["Amy then sat by the window, and read a book for hours.", "Lisa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_264 = {
		...
		labels: ["Lawrence then sat by the window, and read a book for hours.", "Evelyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["While ordering tea, Nancy noticed the barista’s new mustache.", "While ordering tea, Walter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_341 = {
		...
		labels: ["Timothy then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_346 = {
		type: "html-keyboard-response",
		stimulus: "<p> Angela was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Amber took a quarter from the tip jar.", "Before ordering cake, Angela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Angela took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Peter stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Carl took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Carl stole a salt shaker and left.", "After ordering, Roy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_383 = {
		...
		labels: ["Harry then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		type: "html-keyboard-response",
		stimulus: "<p> Stephanie was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Stephanie took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		...
		labels: ["While ordering tea, Joe noticed the barista’s new mustache.", "While ordering tea, Pamela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Evelyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_437 = {
		...
		labels: ["Before ordering cake, Willie took a quarter from the tip jar.", "Before ordering cake, Steven took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_444 = {
		...
		labels: ["Before ordering cake, Ethan took a quarter from the tip jar.", "Before ordering cake, Angela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_453 = {
		...
		labels: ["After ordering, Angela stole a salt shaker and left.", "After ordering, Sarah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_486 = {
		...
		labels: ["While ordering tea, Ruth noticed the barista’s new mustache.", "While ordering tea, Jennifer noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		...
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_500 = {
		...
		labels: ["While ordering tea, Dorothy noticed the barista’s new mustache.", "While ordering tea, Kelly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_516 = {
		...
		labels: ["After ordering, Mary stole a salt shaker and left.", "After ordering, Arthur stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_535 = {
		...
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, Rose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["While ordering tea, Ashley noticed the barista’s new mustache.", "While ordering tea, James noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_551 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Michelle took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Michelle stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["While ordering tea, Gloria noticed the barista’s new mustache.", "While ordering tea, Larry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		...
		labels: ["Before ordering cake, Doris took a quarter from the tip jar.", "Before ordering cake, Peter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Doris took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Janet then sat by the window, and read a book for hours.", "Doris then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_570 = {
		...
		labels: ["Before ordering cake, Doris took a quarter from the tip jar.", "Before ordering cake, Barbara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_607 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Logan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Lisa stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["Before ordering cake, Scott took a quarter from the tip jar.", "Before ordering cake, Philip took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Ashley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		...
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Noah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_670 = {
		...
		labels: ["Karen then sat by the window, and read a book for hours.", "Roy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_677 = {
		...
		labels: ["Edward then sat by the window, and read a book for hours.", "Kyle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		...
		labels: ["While ordering tea, Karen noticed the barista’s new mustache.", "While ordering tea, Jose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_717 = {
		type: "html-keyboard-response",
		stimulus: "<p> Dylan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Dylan took a quarter from the tip jar.", "Before ordering cake, Sarah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_733 = {
		...
		labels: ["After ordering, Gabriel stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		...
		labels: ["After ordering, Frank stole a salt shaker and left.", "After ordering, Anna stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		...
		labels: ["Jeremy then sat by the window, and read a book for hours.", "Victoria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jesse was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jesse noticed the barista’s new mustache.", "While ordering tea, Karen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		...
		labels: ["While ordering tea, Carol noticed the barista’s new mustache.", "While ordering tea, Juan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_824 = {
		...
		labels: ["After ordering, Juan stole a salt shaker and left.", "After ordering, Edward stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["After ordering, Frances stole a salt shaker and left.", "After ordering, Janet stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_871 = {
		...
		labels: ["While ordering tea, Jessica noticed the barista’s new mustache.", "While ordering tea, James noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["While ordering tea, Cynthia noticed the barista’s new mustache.", "While ordering tea, Ruth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_887 = {
		...
		labels: ["Martha then sat by the window, and read a book for hours.", "Cynthia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_894 = {
		...
		labels: ["After ordering, Michael stole a salt shaker and left.", "After ordering, Julia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_906 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Barbara waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Robert noticed the barista’s new mustache.", "While ordering tea, Barbara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_908 = {
		...
		labels: ["Amanda then sat by the window, and read a book for hours.", "Barbara then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_913 = {
		type: "html-keyboard-response",
		stimulus: "<p> Adam was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Adam took a quarter from the tip jar.", "Before ordering cake, Sandra took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		...
		labels: ["Mary then sat by the window, and read a book for hours.", "Ann then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Edward noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Edward then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_983 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Laura waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Amy noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_985 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Laura noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Laura then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1027 = {
		...
		labels: ["Samuel then sat by the window, and read a book for hours.", "Jeffrey then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		type: "html-keyboard-response",
		stimulus: "<p> Betty was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Betty took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Betty then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		...
		labels: ["Judy then sat by the window, and read a book for hours.", "Nancy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1102 = {
		...
		labels: ["Before ordering cake, Jonathan took a quarter from the tip jar.", "Before ordering cake, Nicholas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1137 = {
		type: "html-keyboard-response",
		stimulus: "<p> Cheryl was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Cheryl noticed the barista’s new mustache.", "While ordering tea, Deborah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Cheryl noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Ralph stole a salt shaker and left.", "After ordering, Cheryl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1151 = {
		type: "html-keyboard-response",
		stimulus: "<p> Aaron was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Grace noticed the barista’s new mustache.", "While ordering tea, Aaron noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Elizabeth took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Amy then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Lori noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1223 = {
		...
		labels: ["Brian then sat by the window, and read a book for hours.", "Kenneth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1235 = {
		...
		labels: ["Before ordering cake, Madison took a quarter from the tip jar.", "Before ordering cake, Jacqueline took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1256 = {
		...
		labels: ["Before ordering cake, Emily took a quarter from the tip jar.", "Before ordering cake, Margaret took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		...
		labels: ["Before ordering cake, Kenneth took a quarter from the tip jar.", "Before ordering cake, Aaron took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1300 = {
		...
		labels: ["After ordering, Matthew stole a salt shaker and left.", "After ordering, Katherine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1305 = {
		...
		labels: ["Before ordering cake, Grace took a quarter from the tip jar.", "Before ordering cake, Andrew took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1312 = {
		...
		labels: ["Before ordering cake, Debra took a quarter from the tip jar.", "Before ordering cake, Vincent took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1319 = {
		...
		labels: ["Before ordering cake, Emily took a quarter from the tip jar.", "Before ordering cake, Joan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1321 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Emily took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Nathan then sat by the window, and read a book for hours.", "Emily then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		type: "html-keyboard-response",
		stimulus: "<p> Angela was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Ashley noticed the barista’s new mustache.", "While ordering tea, Angela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1333 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Samuel waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Samuel took a quarter from the tip jar.", "Before ordering cake, Joshua took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		...
		labels: ["After ordering, Nicholas stole a salt shaker and left.", "After ordering, Samantha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1368 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Billy waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, Billy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1389 = {
		...
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, James noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		...
		labels: ["While ordering tea, Kathleen noticed the barista’s new mustache.", "While ordering tea, Alexander noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Kathleen noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Kathleen stole a salt shaker and left.", "After ordering, Richard stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
