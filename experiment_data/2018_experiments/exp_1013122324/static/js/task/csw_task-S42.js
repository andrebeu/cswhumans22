...
// CODE BODY START
	...
	var q_88 = {
		...
		labels: ["Before ordering cake, Alice took a quarter from the tip jar.", "Before ordering cake, Keith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_201 = {
		...
		labels: ["While ordering tea, Nicole noticed the barista’s new mustache.", "While ordering tea, Keith noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_203 = {
		...
		labels: ["Nicole then sat by the window, and read a book for hours.", "Victoria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_210 = {
		...
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Doris stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_229 = {
		...
		labels: ["While ordering tea, Judith noticed the barista’s new mustache.", "While ordering tea, Anna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_293 = {
		...
		labels: ["While ordering tea, Dennis noticed the barista’s new mustache.", "While ordering tea, Tiffany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_316 = {
		...
		labels: ["After ordering, Anthony stole a salt shaker and left.", "After ordering, Scott stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_342 = {
		...
		labels: ["Before ordering cake, Debra took a quarter from the tip jar.", "Before ordering cake, Emily took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_344 = {
		...
		labels: ["After ordering, Emily stole a salt shaker and left.", "After ordering, Amber stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_349 = {
		...
		labels: ["While ordering tea, Kimberly noticed the barista’s new mustache.", "While ordering tea, Kathleen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_420 = {
		...
		labels: ["Before ordering cake, Emily took a quarter from the tip jar.", "Before ordering cake, Alice took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_457 = {
		...
		labels: ["Noah then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_469 = {
		...
		labels: ["Before ordering cake, Peter took a quarter from the tip jar.", "Before ordering cake, Megan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_471 = {
		...
		labels: ["After ordering, Peter stole a salt shaker and left.", "After ordering, Kelly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_568 = {
		...
		labels: ["While ordering tea, Kelly noticed the barista’s new mustache.", "While ordering tea, Sara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_582 = {
		...
		labels: ["While ordering tea, Amy noticed the barista’s new mustache.", "While ordering tea, George noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_591 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jordan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jordan stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_669 = {
		...
		labels: ["Daniel then sat by the window, and read a book for hours.", "Rebecca then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_695 = {
		...
		labels: ["Before ordering cake, Larry took a quarter from the tip jar.", "Before ordering cake, Carl took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_702 = {
		...
		labels: ["While ordering tea, Patrick noticed the barista’s new mustache.", "While ordering tea, Bruce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_704 = {
		...
		labels: ["Patrick then sat by the window, and read a book for hours.", "Brandon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_711 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Helen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["Before ordering cake, Samantha took a quarter from the tip jar.", "Before ordering cake, Catherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_782 = {
		...
		labels: ["After ordering, Catherine stole a salt shaker and left.", "After ordering, Cynthia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		...
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, Kimberly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Shirley then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_829 = {
		...
		labels: ["Before ordering cake, David took a quarter from the tip jar.", "Before ordering cake, Sharon took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		...
		labels: ["After ordering, Kelly stole a salt shaker and left.", "After ordering, David stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_914 = {
		...
		labels: ["While ordering tea, Ryan noticed the barista’s new mustache.", "While ordering tea, Julie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_923 = {
		...
		labels: ["After ordering, Ashley stole a salt shaker and left.", "After ordering, John stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_944 = {
		...
		labels: ["After ordering, Rose stole a salt shaker and left.", "After ordering, Jesse stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_958 = {
		...
		labels: ["After ordering, Nancy stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		type: "html-keyboard-response",
		stimulus: "<p> David was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, David took a quarter from the tip jar.", "Before ordering cake, Catherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1022 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, David took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Amanda stole a salt shaker and left.", "After ordering, David stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1057 = {
		...
		labels: ["After ordering, Jane stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1154 = {
		...
		labels: ["Before ordering cake, Andrea took a quarter from the tip jar.", "Before ordering cake, Carolyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
