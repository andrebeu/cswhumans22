...
// CODE BODY START
	...
	var q_69 = {
		...
		labels: ["Linda then sat by the window, and read a book for hours.", "Raymond then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_81 = {
		...
		labels: ["Before ordering cake, Lawrence took a quarter from the tip jar.", "Before ordering cake, Brian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_88 = {
		...
		labels: ["While ordering tea, Jerry noticed the barista’s new mustache.", "While ordering tea, Wayne noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_109 = {
		...
		labels: ["Before ordering cake, Helen took a quarter from the tip jar.", "Before ordering cake, Shirley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_182 = {
		...
		labels: ["Lawrence then sat by the window, and read a book for hours.", "Jane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_194 = {
		...
		labels: ["While ordering tea, Henry noticed the barista’s new mustache.", "While ordering tea, Gabriel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_210 = {
		...
		labels: ["Arthur then sat by the window, and read a book for hours.", "Patrick then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_231 = {
		...
		labels: ["Carl then sat by the window, and read a book for hours.", "Joseph then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_321 = {
		...
		labels: ["Before ordering cake, Cynthia took a quarter from the tip jar.", "Before ordering cake, Donna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_351 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Ethan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_356 = {
		...
		labels: ["While ordering tea, Terry noticed the barista’s new mustache.", "While ordering tea, Olivia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_420 = {
		...
		labels: ["While ordering tea, Kimberly noticed the barista’s new mustache.", "While ordering tea, Jerry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_441 = {
		...
		labels: ["While ordering tea, Lori noticed the barista’s new mustache.", "While ordering tea, Philip noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_462 = {
		...
		labels: ["While ordering tea, Benjamin noticed the barista’s new mustache.", "While ordering tea, Kenneth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_471 = {
		...
		labels: ["After ordering, Carolyn stole a salt shaker and left.", "After ordering, Jack stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_478 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_540 = {
		...
		labels: ["Before ordering cake, Adam took a quarter from the tip jar.", "Before ordering cake, Brenda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["Heather then sat by the window, and read a book for hours.", "Adam then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_547 = {
		...
		labels: ["While ordering tea, John noticed the barista’s new mustache.", "While ordering tea, Willie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["After ordering, John stole a salt shaker and left.", "After ordering, Jessica stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_653 = {
		...
		labels: ["Before ordering cake, Edward took a quarter from the tip jar.", "Before ordering cake, Justin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_655 = {
		...
		labels: ["Bryan then sat by the window, and read a book for hours.", "Justin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_660 = {
		...
		labels: ["While ordering tea, Elizabeth noticed the barista’s new mustache.", "While ordering tea, Kevin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["While ordering tea, Jesse noticed the barista’s new mustache.", "While ordering tea, Sandra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		...
		labels: ["Alan then sat by the window, and read a book for hours.", "Christopher then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["After ordering, Marie stole a salt shaker and left.", "After ordering, Christina stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["After ordering, Tyler stole a salt shaker and left.", "After ordering, Ronald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["While ordering tea, Doris noticed the barista’s new mustache.", "While ordering tea, Susan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1013 = {
		type: "html-keyboard-response",
		stimulus: "<p> John was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, John noticed the barista’s new mustache.", "While ordering tea, Alexis noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1022 = {
		...
		labels: ["After ordering, Shirley stole a salt shaker and left.", "After ordering, Kelly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1029 = {
		...
		labels: ["After ordering, Christine stole a salt shaker and left.", "After ordering, Justin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1050 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jerry noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Jerry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1055 = {
		...
		labels: ["Before ordering cake, Bryan took a quarter from the tip jar.", "Before ordering cake, Nicholas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		...
		labels: ["Before ordering cake, Christina took a quarter from the tip jar.", "Before ordering cake, Jason took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1140 = {
		...
		labels: ["While ordering tea, Daniel noticed the barista’s new mustache.", "While ordering tea, Peter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1163 = {
		...
		labels: ["After ordering, Eugene stole a salt shaker and left.", "After ordering, Paul stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1189 = {
		...
		labels: ["Before ordering cake, Katherine took a quarter from the tip jar.", "Before ordering cake, Jordan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
