...
// CODE BODY START
	...
	var q_88 = {
		...
		labels: ["Before ordering cake, Stephanie took a quarter from the tip jar.", "Before ordering cake, Elizabeth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_189 = {
		...
		labels: ["After ordering, Gloria stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_203 = {
		...
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Barbara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["Before ordering cake, Arthur took a quarter from the tip jar.", "Before ordering cake, Gregory took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_238 = {
		...
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_307 = {
		...
		labels: ["Before ordering cake, Jesse took a quarter from the tip jar.", "Before ordering cake, Kenneth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_330 = {
		...
		labels: ["Hannah then sat by the window, and read a book for hours.", "Vincent then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_427 = {
		...
		labels: ["Before ordering cake, Larry took a quarter from the tip jar.", "Before ordering cake, Amanda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_434 = {
		...
		labels: ["While ordering tea, Edward noticed the barista’s new mustache.", "While ordering tea, Deborah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_441 = {
		...
		labels: ["While ordering tea, Jordan noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_448 = {
		...
		labels: ["While ordering tea, Jean noticed the barista’s new mustache.", "While ordering tea, Abigail noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_457 = {
		...
		labels: ["After ordering, Larry stole a salt shaker and left.", "After ordering, Jack stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["Anna then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_561 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gregory was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Gregory took a quarter from the tip jar.", "Before ordering cake, Danielle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Gregory took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Gregory stole a salt shaker and left.", "After ordering, Edward stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_568 = {
		type: "html-keyboard-response",
		stimulus: "<p> Ann was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Raymond took a quarter from the tip jar.", "Before ordering cake, Ann took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_570 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Ann took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Ann stole a salt shaker and left.", "After ordering, John stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_575 = {
		...
		labels: ["While ordering tea, Walter noticed the barista’s new mustache.", "While ordering tea, Alan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Kelly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_660 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Billy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_674 = {
		...
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, Timothy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_690 = {
		...
		labels: ["After ordering, Margaret stole a salt shaker and left.", "After ordering, Heather stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_702 = {
		...
		labels: ["Before ordering cake, Marie took a quarter from the tip jar.", "Before ordering cake, Jose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_704 = {
		...
		labels: ["After ordering, Jennifer stole a salt shaker and left.", "After ordering, Jose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_773 = {
		...
		labels: ["While ordering tea, Lori noticed the barista’s new mustache.", "While ordering tea, Brandon noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_907 = {
		...
		labels: ["While ordering tea, Kimberly noticed the barista’s new mustache.", "While ordering tea, Joyce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_916 = {
		...
		labels: ["After ordering, Kimberly stole a salt shaker and left.", "After ordering, Emily stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_942 = {
		...
		labels: ["While ordering tea, Elizabeth noticed the barista’s new mustache.", "While ordering tea, Jose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1036 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Rachel noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Janice then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1050 = {
		...
		labels: ["Betty then sat by the window, and read a book for hours.", "Judy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1133 = {
		type: "html-keyboard-response",
		stimulus: "<p> Elizabeth was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Elizabeth took a quarter from the tip jar.", "Before ordering cake, Deborah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1154 = {
		type: "html-keyboard-response",
		stimulus: "<p> Amber was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Amber took a quarter from the tip jar.", "Before ordering cake, Austin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1189 = {
		...
		labels: ["While ordering tea, Alan noticed the barista’s new mustache.", "While ordering tea, George noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
