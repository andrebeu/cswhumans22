...
// CODE BODY START
	...
	var q_62 = {
		...
		labels: ["After ordering, Raymond stole a salt shaker and left.", "After ordering, Diane stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_74 = {
		...
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Sandra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_76 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Julia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_81 = {
		...
		labels: ["While ordering tea, Virginia noticed the barista’s new mustache.", "While ordering tea, Melissa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_88 = {
		...
		labels: ["Before ordering cake, Jeffrey took a quarter from the tip jar.", "Before ordering cake, Megan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_104 = {
		...
		labels: ["After ordering, Gerald stole a salt shaker and left.", "After ordering, Cheryl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_111 = {
		...
		labels: ["Jeffrey then sat by the window, and read a book for hours.", "Dorothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_210 = {
		...
		labels: ["Mark then sat by the window, and read a book for hours.", "Jonathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["While ordering tea, Bruce noticed the barista’s new mustache.", "While ordering tea, Frank noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_300 = {
		...
		labels: ["While ordering tea, Tiffany noticed the barista’s new mustache.", "While ordering tea, Abigail noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_316 = {
		...
		labels: ["After ordering, Jason stole a salt shaker and left.", "After ordering, Rachel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_337 = {
		...
		labels: ["Catherine then sat by the window, and read a book for hours.", "Jason then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_356 = {
		...
		labels: ["While ordering tea, Kelly noticed the barista’s new mustache.", "While ordering tea, Kimberly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_443 = {
		...
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Virginia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_469 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Stephanie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_533 = {
		...
		labels: ["Before ordering cake, Nancy took a quarter from the tip jar.", "Before ordering cake, Ethan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_554 = {
		...
		labels: ["Before ordering cake, Julie took a quarter from the tip jar.", "Before ordering cake, Jeremy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_575 = {
		...
		labels: ["Before ordering cake, Rebecca took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_584 = {
		...
		labels: ["After ordering, Sara stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_667 = {
		...
		labels: ["While ordering tea, Betty noticed the barista’s new mustache.", "While ordering tea, Elizabeth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_709 = {
		...
		labels: ["Before ordering cake, Raymond took a quarter from the tip jar.", "Before ordering cake, Jordan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jennifer noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jennifer stole a salt shaker and left.", "After ordering, Kimberly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_808 = {
		...
		labels: ["Before ordering cake, Mary took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_815 = {
		...
		labels: ["While ordering tea, Logan noticed the barista’s new mustache.", "While ordering tea, Thomas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		...
		labels: ["Henry then sat by the window, and read a book for hours.", "Louis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		...
		labels: ["While ordering tea, Matthew noticed the barista’s new mustache.", "While ordering tea, Alan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_914 = {
		type: "html-keyboard-response",
		stimulus: "<p> Barbara was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Barbara noticed the barista’s new mustache.", "While ordering tea, Jessica noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_916 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Barbara noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Janice stole a salt shaker and left.", "After ordering, Barbara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_944 = {
		...
		labels: ["After ordering, Matthew stole a salt shaker and left.", "After ordering, Harry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_956 = {
		...
		labels: ["Before ordering cake, Stephen took a quarter from the tip jar.", "Before ordering cake, Steven took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1015 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Betty took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Laura then sat by the window, and read a book for hours.", "Betty then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1029 = {
		...
		labels: ["John then sat by the window, and read a book for hours.", "Cheryl then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1050 = {
		...
		labels: ["After ordering, Benjamin stole a salt shaker and left.", "After ordering, Betty stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1064 = {
		...
		labels: ["Eugene then sat by the window, and read a book for hours.", "Maria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		...
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Ann took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1078 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Diane noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Diane stole a salt shaker and left.", "After ordering, Benjamin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1154 = {
		...
		labels: ["Before ordering cake, Cynthia took a quarter from the tip jar.", "Before ordering cake, Frank took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1198 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jonathan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Jonathan then sat by the window, and read a book for hours.", "Marie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
