...
// CODE BODY START
	...
	var q_60 = {
		...
		labels: ["Before ordering cake, Rachel took a quarter from the tip jar.", "Before ordering cake, Brian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_81 = {
		...
		labels: ["While ordering tea, Ethan noticed the barista’s new mustache.", "While ordering tea, Sean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_116 = {
		...
		labels: ["While ordering tea, Christina noticed the barista’s new mustache.", "While ordering tea, Nancy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_118 = {
		...
		labels: ["Logan then sat by the window, and read a book for hours.", "Nancy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_201 = {
		...
		labels: ["Before ordering cake, Bobby took a quarter from the tip jar.", "Before ordering cake, Joe took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["Before ordering cake, Ann took a quarter from the tip jar.", "Before ordering cake, Philip took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_217 = {
		...
		labels: ["After ordering, Jason stole a salt shaker and left.", "After ordering, Ann stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["Before ordering cake, Martha took a quarter from the tip jar.", "Before ordering cake, Roy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_231 = {
		...
		labels: ["Kelly then sat by the window, and read a book for hours.", "Jack then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_302 = {
		...
		labels: ["Frances then sat by the window, and read a book for hours.", "Eric then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_337 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Joseph took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Joseph stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_422 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Timothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_429 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Bobby took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Bobby stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_462 = {
		...
		labels: ["Before ordering cake, Abigail took a quarter from the tip jar.", "Before ordering cake, Edward took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_478 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Shirley noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Anthony then sat by the window, and read a book for hours.", "Shirley then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_535 = {
		...
		labels: ["Rachel then sat by the window, and read a book for hours.", "Barbara then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["After ordering, Virginia stole a salt shaker and left.", "After ordering, Martha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_554 = {
		type: "html-keyboard-response",
		stimulus: "<p> Joseph was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Donna took a quarter from the tip jar.", "Before ordering cake, Joseph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_561 = {
		...
		labels: ["Before ordering cake, Teresa took a quarter from the tip jar.", "Before ordering cake, Dorothy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_582 = {
		...
		labels: ["While ordering tea, Sean noticed the barista’s new mustache.", "While ordering tea, Edward noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_584 = {
		...
		labels: ["Julie then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_596 = {
		...
		labels: ["Before ordering cake, Pamela took a quarter from the tip jar.", "Before ordering cake, Carolyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_683 = {
		...
		labels: ["After ordering, Eric stole a salt shaker and left.", "After ordering, Debra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_711 = {
		...
		labels: ["Samantha then sat by the window, and read a book for hours.", "Russell then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_718 = {
		...
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Linda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		...
		labels: ["Before ordering cake, Carol took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		...
		labels: ["Before ordering cake, Kathleen took a quarter from the tip jar.", "Before ordering cake, Alice took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		...
		labels: ["Before ordering cake, Henry took a quarter from the tip jar.", "Before ordering cake, Beverly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_810 = {
		...
		labels: ["Kathleen then sat by the window, and read a book for hours.", "Alexander then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["Alan then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["While ordering tea, Adam noticed the barista’s new mustache.", "While ordering tea, Russell noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_921 = {
		...
		labels: ["Before ordering cake, Virginia took a quarter from the tip jar.", "Before ordering cake, Louis took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_930 = {
		...
		labels: ["Philip then sat by the window, and read a book for hours.", "Diana then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_937 = {
		...
		labels: ["After ordering, Patricia stole a salt shaker and left.", "After ordering, Ethan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_956 = {
		...
		labels: ["Before ordering cake, Natalie took a quarter from the tip jar.", "Before ordering cake, Christine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1015 = {
		...
		labels: ["After ordering, Diana stole a salt shaker and left.", "After ordering, Michelle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1022 = {
		...
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1029 = {
		...
		labels: ["After ordering, Louis stole a salt shaker and left.", "After ordering, Adam stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		...
		labels: ["While ordering tea, Anthony noticed the barista’s new mustache.", "While ordering tea, Peter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1149 = {
		...
		labels: ["After ordering, Frances stole a salt shaker and left.", "After ordering, Douglas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1170 = {
		...
		labels: ["After ordering, Shirley stole a salt shaker and left.", "After ordering, Michael stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1177 = {
		...
		labels: ["Lawrence then sat by the window, and read a book for hours.", "Tyler then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1184 = {
		...
		labels: ["After ordering, Brian stole a salt shaker and left.", "After ordering, Jordan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
