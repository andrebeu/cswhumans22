...
// CODE BODY START
	...
	var q_55 = {
		...
		labels: ["After ordering, Ryan stole a salt shaker and left.", "After ordering, Virginia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_69 = {
		...
		labels: ["After ordering, Louis stole a salt shaker and left.", "After ordering, Jordan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_88 = {
		...
		labels: ["While ordering tea, Philip noticed the barista’s new mustache.", "While ordering tea, Theresa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_194 = {
		...
		labels: ["Before ordering cake, Doris took a quarter from the tip jar.", "Before ordering cake, Teresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_201 = {
		...
		labels: ["While ordering tea, Linda noticed the barista’s new mustache.", "While ordering tea, Ronald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["While ordering tea, Denise noticed the barista’s new mustache.", "While ordering tea, Gary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_236 = {
		...
		labels: ["While ordering tea, Lori noticed the barista’s new mustache.", "While ordering tea, Michael noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_300 = {
		...
		labels: ["While ordering tea, Sean noticed the barista’s new mustache.", "While ordering tea, Andrew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_307 = {
		...
		labels: ["Before ordering cake, Juan took a quarter from the tip jar.", "Before ordering cake, Rebecca took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_316 = {
		...
		labels: ["Martha then sat by the window, and read a book for hours.", "Bryan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_328 = {
		...
		labels: ["Before ordering cake, Carl took a quarter from the tip jar.", "Before ordering cake, Catherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_330 = {
		...
		labels: ["Gregory then sat by the window, and read a book for hours.", "Catherine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_337 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Noah noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Kimberly stole a salt shaker and left.", "After ordering, Noah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_434 = {
		...
		labels: ["While ordering tea, Frances noticed the barista’s new mustache.", "While ordering tea, Dorothy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_448 = {
		...
		labels: ["Before ordering cake, Ruth took a quarter from the tip jar.", "Before ordering cake, Randy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_450 = {
		...
		labels: ["Randy then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_457 = {
		...
		labels: ["After ordering, Jennifer stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_471 = {
		...
		labels: ["Rachel then sat by the window, and read a book for hours.", "Joe then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_554 = {
		...
		labels: ["While ordering tea, Denise noticed the barista’s new mustache.", "While ordering tea, Sara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["Samuel then sat by the window, and read a book for hours.", "Denise then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		...
		labels: ["After ordering, Sarah stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_568 = {
		...
		labels: ["Before ordering cake, Edward took a quarter from the tip jar.", "Before ordering cake, Kathryn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		...
		labels: ["Andrea then sat by the window, and read a book for hours.", "Madison then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_662 = {
		...
		labels: ["Edward then sat by the window, and read a book for hours.", "Michael then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_667 = {
		...
		labels: ["Before ordering cake, Virginia took a quarter from the tip jar.", "Before ordering cake, Laura took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_688 = {
		...
		labels: ["Before ordering cake, Steven took a quarter from the tip jar.", "Before ordering cake, Bryan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_702 = {
		...
		labels: ["Before ordering cake, Susan took a quarter from the tip jar.", "Before ordering cake, Roy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_773 = {
		...
		labels: ["Before ordering cake, Amy took a quarter from the tip jar.", "Before ordering cake, Marie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		...
		labels: ["While ordering tea, Joshua noticed the barista’s new mustache.", "While ordering tea, Hannah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["Before ordering cake, Amy took a quarter from the tip jar.", "Before ordering cake, Emma took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_902 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Carol noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Carol stole a salt shaker and left.", "After ordering, Susan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_921 = {
		...
		labels: ["While ordering tea, Zachary noticed the barista’s new mustache.", "While ordering tea, Gregory noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_928 = {
		...
		labels: ["Before ordering cake, Jessica took a quarter from the tip jar.", "Before ordering cake, John took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1041 = {
		...
		labels: ["Before ordering cake, Jacob took a quarter from the tip jar.", "Before ordering cake, Kathryn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1071 = {
		...
		labels: ["Jeffrey then sat by the window, and read a book for hours.", "Diane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1147 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Rose waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Heather noticed the barista’s new mustache.", "While ordering tea, Rose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
