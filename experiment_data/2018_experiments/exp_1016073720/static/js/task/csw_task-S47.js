...
// CODE BODY START
	...
	var q_81 = {
		...
		labels: ["Before ordering cake, Rachel took a quarter from the tip jar.", "Before ordering cake, Roger took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_95 = {
		...
		labels: ["Before ordering cake, Daniel took a quarter from the tip jar.", "Before ordering cake, Kyle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_97 = {
		...
		labels: ["After ordering, Olivia stole a salt shaker and left.", "After ordering, Kyle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_109 = {
		...
		labels: ["Before ordering cake, Vincent took a quarter from the tip jar.", "Before ordering cake, Tyler took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_180 = {
		...
		labels: ["Before ordering cake, Roger took a quarter from the tip jar.", "Before ordering cake, Cynthia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_210 = {
		...
		labels: ["Philip then sat by the window, and read a book for hours.", "Denise then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_217 = {
		...
		labels: ["After ordering, Peter stole a salt shaker and left.", "After ordering, George stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_300 = {
		...
		labels: ["While ordering tea, Amber noticed the barista’s new mustache.", "While ordering tea, Lori noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_307 = {
		...
		labels: ["While ordering tea, Edward noticed the barista’s new mustache.", "While ordering tea, Harry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_349 = {
		...
		labels: ["While ordering tea, Natalie noticed the barista’s new mustache.", "While ordering tea, Russell noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_356 = {
		...
		labels: ["While ordering tea, Nicole noticed the barista’s new mustache.", "While ordering tea, Joyce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_422 = {
		...
		labels: ["After ordering, Eric stole a salt shaker and left.", "After ordering, Pamela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_434 = {
		...
		labels: ["Before ordering cake, Alan took a quarter from the tip jar.", "Before ordering cake, Jennifer took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_471 = {
		...
		labels: ["After ordering, Dylan stole a salt shaker and left.", "After ordering, Linda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_533 = {
		...
		labels: ["Before ordering cake, Roger took a quarter from the tip jar.", "Before ordering cake, Jesse took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		...
		labels: ["After ordering, Jason stole a salt shaker and left.", "After ordering, Frank stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_568 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gregory was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Gregory took a quarter from the tip jar.", "Before ordering cake, Robert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Kyle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_683 = {
		...
		labels: ["After ordering, Charles stole a salt shaker and left.", "After ordering, Sandra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["Joan then sat by the window, and read a book for hours.", "Tiffany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		...
		labels: ["Before ordering cake, Russell took a quarter from the tip jar.", "Before ordering cake, Brandon took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Ruth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_895 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Jeffrey stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_923 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Bryan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_930 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Teresa took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Paul then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1041 = {
		...
		labels: ["While ordering tea, Eric noticed the barista’s new mustache.", "While ordering tea, Natalie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		...
		labels: ["While ordering tea, Frances noticed the barista’s new mustache.", "While ordering tea, Joan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		type: "html-keyboard-response",
		stimulus: "<p> Zachary was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Zachary took a quarter from the tip jar.", "Before ordering cake, Juan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1135 = {
		...
		labels: ["Steven then sat by the window, and read a book for hours.", "Deborah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1170 = {
		...
		labels: ["Albert then sat by the window, and read a book for hours.", "Katherine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
