...
// CODE BODY START
	...
	var q_67 = {
		...
		labels: ["While ordering tea, Jessica noticed the barista’s new mustache.", "While ordering tea, Janice noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_69 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Janice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_95 = {
		...
		labels: ["Before ordering cake, Helen took a quarter from the tip jar.", "Before ordering cake, Daniel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_116 = {
		...
		labels: ["Before ordering cake, Harold took a quarter from the tip jar.", "Before ordering cake, William took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_180 = {
		...
		labels: ["While ordering tea, Vincent noticed the barista’s new mustache.", "While ordering tea, Henry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_217 = {
		...
		labels: ["After ordering, Ashley stole a salt shaker and left.", "After ordering, Abigail stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_321 = {
		...
		labels: ["While ordering tea, Deborah noticed the barista’s new mustache.", "While ordering tea, Jesse noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_356 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Adam waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Adam took a quarter from the tip jar.", "Before ordering cake, Denise took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_427 = {
		...
		labels: ["Before ordering cake, Rose took a quarter from the tip jar.", "Before ordering cake, Gabriel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_448 = {
		...
		labels: ["Before ordering cake, Dorothy took a quarter from the tip jar.", "Before ordering cake, Abigail took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_450 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Abigail took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Abigail then sat by the window, and read a book for hours.", "Nathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_582 = {
		...
		labels: ["While ordering tea, Richard noticed the barista’s new mustache.", "While ordering tea, Pamela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_662 = {
		...
		labels: ["After ordering, Danielle stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_709 = {
		...
		labels: ["While ordering tea, Frank noticed the barista’s new mustache.", "While ordering tea, Jeffrey noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		...
		labels: ["While ordering tea, Noah noticed the barista’s new mustache.", "While ordering tea, Bryan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		...
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Danielle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Danielle noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Patricia stole a salt shaker and left.", "After ordering, Danielle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Bryan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Jesse stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_949 = {
		...
		labels: ["While ordering tea, Bobby noticed the barista’s new mustache.", "While ordering tea, Jacqueline noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1071 = {
		...
		labels: ["Judy then sat by the window, and read a book for hours.", "Brenda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1135 = {
		...
		labels: ["After ordering, Jonathan stole a salt shaker and left.", "After ordering, Alexander stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1140 = {
		...
		labels: ["Before ordering cake, Emily took a quarter from the tip jar.", "Before ordering cake, Timothy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1189 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Alice waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jean noticed the barista’s new mustache.", "While ordering tea, Alice noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1191 = {
		...
		labels: ["David then sat by the window, and read a book for hours.", "Alice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1196 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Logan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Carl noticed the barista’s new mustache.", "While ordering tea, Logan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
