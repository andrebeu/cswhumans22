...
// CODE BODY START
	...
	var q_33 = {
		...
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Alan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_82 = {
		...
		labels: ["After ordering, Paul stole a salt shaker and left.", "After ordering, Peter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_87 = {
		...
		labels: ["Before ordering cake, Sean took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_108 = {
		...
		labels: ["Before ordering cake, Betty took a quarter from the tip jar.", "Before ordering cake, Wayne took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["While ordering tea, Louis noticed the barista’s new mustache.", "While ordering tea, Diane noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_136 = {
		...
		labels: ["Before ordering cake, Lawrence took a quarter from the tip jar.", "Before ordering cake, Nancy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		...
		labels: ["Before ordering cake, Peter took a quarter from the tip jar.", "Before ordering cake, Anthony took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_166 = {
		...
		labels: ["After ordering, Alexander stole a salt shaker and left.", "After ordering, Amy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_171 = {
		...
		labels: ["Before ordering cake, Keith took a quarter from the tip jar.", "Before ordering cake, Roger took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_180 = {
		...
		labels: ["Sharon then sat by the window, and read a book for hours.", "Jesse then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_199 = {
		...
		labels: ["While ordering tea, Pamela noticed the barista’s new mustache.", "While ordering tea, Joyce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_201 = {
		...
		labels: ["After ordering, David stole a salt shaker and left.", "After ordering, Pamela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_241 = {
		...
		labels: ["Before ordering cake, Austin took a quarter from the tip jar.", "Before ordering cake, Wayne took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_264 = {
		...
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, Roger noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_292 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Victoria noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Judith then sat by the window, and read a book for hours.", "Victoria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_327 = {
		...
		labels: ["Julia then sat by the window, and read a book for hours.", "Megan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Anna then sat by the window, and read a book for hours.", "Robert then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_360 = {
		...
		labels: ["Before ordering cake, Donna took a quarter from the tip jar.", "Before ordering cake, Joyce took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_474 = {
		...
		labels: ["Kelly then sat by the window, and read a book for hours.", "Gregory then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Juan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, James took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["While ordering tea, Kelly noticed the barista’s new mustache.", "While ordering tea, Ronald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_558 = {
		...
		labels: ["Ronald then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_584 = {
		...
		labels: ["Before ordering cake, Kenneth took a quarter from the tip jar.", "Before ordering cake, Amber took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Amber took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Amber stole a salt shaker and left.", "After ordering, Harold stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["After ordering, Sharon stole a salt shaker and left.", "After ordering, Gloria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		type: "html-keyboard-response",
		stimulus: "<p> Kathryn was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kathryn took a quarter from the tip jar.", "Before ordering cake, Ruth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_635 = {
		...
		labels: ["After ordering, Jacob stole a salt shaker and left.", "After ordering, Dylan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		...
		labels: ["After ordering, Beverly stole a salt shaker and left.", "After ordering, Brandon stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_649 = {
		...
		labels: ["Robert then sat by the window, and read a book for hours.", "Cheryl then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Carol took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Debra then sat by the window, and read a book for hours.", "Carol then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["While ordering tea, Charles noticed the barista’s new mustache.", "While ordering tea, Michael noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_689 = {
		...
		labels: ["Before ordering cake, Timothy took a quarter from the tip jar.", "Before ordering cake, Lori took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_691 = {
		...
		labels: ["Paul then sat by the window, and read a book for hours.", "Lori then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_733 = {
		...
		labels: ["After ordering, Sandra stole a salt shaker and left.", "After ordering, Juan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_745 = {
		type: "html-keyboard-response",
		stimulus: "<p> Catherine was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Martha noticed the barista’s new mustache.", "While ordering tea, Catherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Catherine noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Catherine stole a salt shaker and left.", "After ordering, Randy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_754 = {
		...
		labels: ["After ordering, Billy stole a salt shaker and left.", "After ordering, Olivia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_773 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Samantha waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Mark took a quarter from the tip jar.", "Before ordering cake, Samantha took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_815 = {
		...
		labels: ["While ordering tea, Brian noticed the barista’s new mustache.", "While ordering tea, Madison noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_817 = {
		...
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["After ordering, Zachary stole a salt shaker and left.", "After ordering, Walter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Pamela waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Pamela took a quarter from the tip jar.", "Before ordering cake, Joseph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Susan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jose took a quarter from the tip jar.", "Before ordering cake, Susan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_880 = {
		...
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Jerry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_906 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Ethan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Ethan noticed the barista’s new mustache.", "While ordering tea, Ruth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_913 = {
		...
		labels: ["Before ordering cake, Jeremy took a quarter from the tip jar.", "Before ordering cake, Eugene took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		...
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Benjamin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["Brittany then sat by the window, and read a book for hours.", "Diana then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1013 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["Roger then sat by the window, and read a book for hours.", "Larry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		...
		labels: ["Christine then sat by the window, and read a book for hours.", "Kelly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		...
		labels: ["After ordering, Rachel stole a salt shaker and left.", "After ordering, Jessica stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1137 = {
		...
		labels: ["Before ordering cake, Ruth took a quarter from the tip jar.", "Before ordering cake, Eugene took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Sharon waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Nancy noticed the barista’s new mustache.", "While ordering tea, Sharon noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1160 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Sharon noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Sharon then sat by the window, and read a book for hours.", "Dennis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1165 = {
		...
		labels: ["While ordering tea, Timothy noticed the barista’s new mustache.", "While ordering tea, Amanda noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1186 = {
		...
		labels: ["Before ordering cake, Christopher took a quarter from the tip jar.", "Before ordering cake, Jesse took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		...
		labels: ["After ordering, Ralph stole a salt shaker and left.", "After ordering, Melissa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1237 = {
		...
		labels: ["After ordering, Cynthia stole a salt shaker and left.", "After ordering, Dennis stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1242 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Dorothy waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jeffrey noticed the barista’s new mustache.", "While ordering tea, Dorothy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1277 = {
		...
		labels: ["Before ordering cake, Amanda took a quarter from the tip jar.", "Before ordering cake, Paul took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		...
		labels: ["After ordering, Debra stole a salt shaker and left.", "After ordering, Christine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Amanda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1328 = {
		...
		labels: ["After ordering, Sandra stole a salt shaker and left.", "After ordering, Kimberly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1335 = {
		...
		labels: ["After ordering, Paul stole a salt shaker and left.", "After ordering, Emily stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1342 = {
		...
		labels: ["After ordering, Kevin stole a salt shaker and left.", "After ordering, Gary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1354 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Raymond waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Raymond noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Raymond noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Brandon then sat by the window, and read a book for hours.", "Raymond then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1368 = {
		...
		labels: ["Before ordering cake, Aaron took a quarter from the tip jar.", "Before ordering cake, Jeffrey took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
