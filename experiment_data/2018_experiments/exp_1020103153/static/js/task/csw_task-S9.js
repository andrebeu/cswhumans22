...
// CODE BODY START
	...
	var q_61 = {
		...
		labels: ["After ordering, Frances stole a salt shaker and left.", "After ordering, Rachel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["Before ordering cake, Alice took a quarter from the tip jar.", "Before ordering cake, Alexander took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_75 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Alexander took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Alexander stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_82 = {
		...
		labels: ["Jeffrey then sat by the window, and read a book for hours.", "Patricia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["After ordering, Jacob stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_166 = {
		...
		labels: ["After ordering, Vincent stole a salt shaker and left.", "After ordering, Adam stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_187 = {
		...
		labels: ["Brittany then sat by the window, and read a book for hours.", "Evelyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_194 = {
		...
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, James stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_206 = {
		...
		labels: ["While ordering tea, Megan noticed the barista’s new mustache.", "While ordering tea, Christine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["After ordering, Christine stole a salt shaker and left.", "After ordering, Susan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_220 = {
		...
		labels: ["While ordering tea, Katherine noticed the barista’s new mustache.", "While ordering tea, Rebecca noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["After ordering, Rebecca stole a salt shaker and left.", "After ordering, Alan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["Before ordering cake, Jacqueline took a quarter from the tip jar.", "Before ordering cake, Justin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		...
		labels: ["After ordering, Brenda stole a salt shaker and left.", "After ordering, Ann stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		...
		labels: ["After ordering, Martha stole a salt shaker and left.", "After ordering, Ashley stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_327 = {
		...
		labels: ["Ralph then sat by the window, and read a book for hours.", "Joyce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["While ordering tea, Edward noticed the barista’s new mustache.", "While ordering tea, Amber noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_341 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Ann took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Ann stole a salt shaker and left.", "After ordering, Diana stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jacqueline waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jacqueline noticed the barista’s new mustache.", "While ordering tea, Dylan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		...
		labels: ["Jacqueline then sat by the window, and read a book for hours.", "Ruth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_362 = {
		...
		labels: ["After ordering, Judy stole a salt shaker and left.", "After ordering, Christian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_367 = {
		...
		labels: ["While ordering tea, Nathan noticed the barista’s new mustache.", "While ordering tea, Philip noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_381 = {
		...
		labels: ["Before ordering cake, Walter took a quarter from the tip jar.", "Before ordering cake, Hannah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_397 = {
		...
		labels: ["Terry then sat by the window, and read a book for hours.", "Matthew then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_404 = {
		...
		labels: ["Denise then sat by the window, and read a book for hours.", "Roy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_425 = {
		...
		labels: ["After ordering, Betty stole a salt shaker and left.", "After ordering, Julia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_430 = {
		...
		labels: ["While ordering tea, Emily noticed the barista’s new mustache.", "While ordering tea, Lawrence noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_437 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Janet waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Donald noticed the barista’s new mustache.", "While ordering tea, Janet noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["Before ordering cake, Peter took a quarter from the tip jar.", "Before ordering cake, Amy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_460 = {
		...
		labels: ["Peter then sat by the window, and read a book for hours.", "Terry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_472 = {
		...
		labels: ["While ordering tea, Rose noticed the barista’s new mustache.", "While ordering tea, Bryan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_479 = {
		...
		labels: ["Before ordering cake, Marilyn took a quarter from the tip jar.", "Before ordering cake, Justin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_530 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, George took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Carolyn then sat by the window, and read a book for hours.", "George then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["While ordering tea, Richard noticed the barista’s new mustache.", "While ordering tea, Shirley noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Emma noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Emma then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["After ordering, Rebecca stole a salt shaker and left.", "After ordering, Heather stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		type: "html-keyboard-response",
		stimulus: "<p> Tyler was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Jacob took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		...
		labels: ["Jennifer then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["Before ordering cake, Christine took a quarter from the tip jar.", "Before ordering cake, Nicole took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		...
		labels: ["Before ordering cake, Justin took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_661 = {
		...
		labels: ["Before ordering cake, Dennis took a quarter from the tip jar.", "Before ordering cake, Jessica took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_670 = {
		...
		labels: ["Ann then sat by the window, and read a book for hours.", "Rebecca then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_677 = {
		...
		labels: ["Logan then sat by the window, and read a book for hours.", "Amber then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		type: "html-keyboard-response",
		stimulus: "<p> Frances was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Frances took a quarter from the tip jar.", "Before ordering cake, Carol took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_724 = {
		...
		labels: ["While ordering tea, Nicholas noticed the barista’s new mustache.", "While ordering tea, Austin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_726 = {
		...
		labels: ["After ordering, Austin stole a salt shaker and left.", "After ordering, Kevin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		type: "html-keyboard-response",
		stimulus: "<p> Olivia was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Olivia noticed the barista’s new mustache.", "While ordering tea, Tyler noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		...
		labels: ["Pamela then sat by the window, and read a book for hours.", "Willie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_759 = {
		...
		labels: ["Before ordering cake, Grace took a quarter from the tip jar.", "Before ordering cake, Jesse took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		...
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Grace stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_766 = {
		...
		labels: ["Before ordering cake, Gary took a quarter from the tip jar.", "Before ordering cake, Ethan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["Before ordering cake, Cynthia took a quarter from the tip jar.", "Before ordering cake, Christian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Joseph waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Joseph took a quarter from the tip jar.", "Before ordering cake, Ethan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["Joseph then sat by the window, and read a book for hours.", "Janet then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["After ordering, Emma stole a salt shaker and left.", "After ordering, Dylan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_817 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Ruth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		...
		labels: ["Before ordering cake, Rachel took a quarter from the tip jar.", "Before ordering cake, Donald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		type: "html-keyboard-response",
		stimulus: "<p> Debra was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Debra took a quarter from the tip jar.", "Before ordering cake, Linda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_852 = {
		...
		labels: ["Noah then sat by the window, and read a book for hours.", "Karen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		...
		labels: ["While ordering tea, Kelly noticed the barista’s new mustache.", "While ordering tea, Louis noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		...
		labels: ["While ordering tea, Louis noticed the barista’s new mustache.", "While ordering tea, Linda noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_899 = {
		...
		labels: ["While ordering tea, Lisa noticed the barista’s new mustache.", "While ordering tea, Kyle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_922 = {
		...
		labels: ["After ordering, Wayne stole a salt shaker and left.", "After ordering, Ashley stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		...
		labels: ["After ordering, Daniel stole a salt shaker and left.", "After ordering, Donna stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Lisa waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Lisa took a quarter from the tip jar.", "Before ordering cake, John took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		type: "html-keyboard-response",
		stimulus: "<p> Michelle was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Olivia noticed the barista’s new mustache.", "While ordering tea, Michelle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1004 = {
		...
		labels: ["Before ordering cake, Billy took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["While ordering tea, Ronald noticed the barista’s new mustache.", "While ordering tea, Sean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		...
		labels: ["While ordering tea, Raymond noticed the barista’s new mustache.", "While ordering tea, Debra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1055 = {
		...
		labels: ["Christopher then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		...
		labels: ["After ordering, Sean stole a salt shaker and left.", "After ordering, Richard stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1118 = {
		...
		labels: ["After ordering, Samantha stole a salt shaker and left.", "After ordering, Shirley stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1130 = {
		...
		labels: ["Before ordering cake, Diane took a quarter from the tip jar.", "Before ordering cake, Anna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		...
		labels: ["Laura then sat by the window, and read a book for hours.", "Jeremy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		...
		labels: ["Before ordering cake, Carolyn took a quarter from the tip jar.", "Before ordering cake, Arthur took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1188 = {
		...
		labels: ["Frank then sat by the window, and read a book for hours.", "Christine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Matthew noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Matthew then sat by the window, and read a book for hours.", "Tyler then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1237 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Sarah took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Linda stole a salt shaker and left.", "After ordering, Sarah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1251 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Nicole took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Sarah stole a salt shaker and left.", "After ordering, Nicole stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1258 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Carl then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		...
		labels: ["While ordering tea, Charles noticed the barista’s new mustache.", "While ordering tea, Susan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1342 = {
		...
		labels: ["After ordering, Sarah stole a salt shaker and left.", "After ordering, Ashley stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		...
		labels: ["Barbara then sat by the window, and read a book for hours.", "Dylan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1363 = {
		...
		labels: ["Mary then sat by the window, and read a book for hours.", "Lauren then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1375 = {
		type: "html-keyboard-response",
		stimulus: "<p> Tyler was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Rose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1389 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Christian waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Christian noticed the barista’s new mustache.", "While ordering tea, Ashley noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Pamela waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Ralph took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
