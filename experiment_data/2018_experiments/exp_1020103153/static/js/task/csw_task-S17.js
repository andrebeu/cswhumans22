...
// CODE BODY START
	...
	var q_61 = {
		...
		labels: ["Julie then sat by the window, and read a book for hours.", "Jennifer then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_80 = {
		...
		labels: ["While ordering tea, Teresa noticed the barista’s new mustache.", "While ordering tea, Barbara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["Before ordering cake, Brittany took a quarter from the tip jar.", "Before ordering cake, Kyle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		...
		labels: ["While ordering tea, Kathleen noticed the barista’s new mustache.", "While ordering tea, Denise noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["Lauren then sat by the window, and read a book for hours.", "Hannah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_157 = {
		...
		labels: ["While ordering tea, Anna noticed the barista’s new mustache.", "While ordering tea, Nicole noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_164 = {
		...
		labels: ["While ordering tea, Brian noticed the barista’s new mustache.", "While ordering tea, William noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_178 = {
		...
		labels: ["While ordering tea, Justin noticed the barista’s new mustache.", "While ordering tea, Anna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_192 = {
		...
		labels: ["While ordering tea, Scott noticed the barista’s new mustache.", "While ordering tea, Austin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["Barbara then sat by the window, and read a book for hours.", "Alice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_250 = {
		...
		labels: ["After ordering, Kelly stole a salt shaker and left.", "After ordering, Cheryl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_257 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Joshua then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_264 = {
		...
		labels: ["After ordering, Carolyn stole a salt shaker and left.", "After ordering, Diane stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_269 = {
		...
		labels: ["While ordering tea, Terry noticed the barista’s new mustache.", "While ordering tea, Peter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["After ordering, Terry stole a salt shaker and left.", "After ordering, Anthony stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["While ordering tea, Heather noticed the barista’s new mustache.", "While ordering tea, Christopher noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Lauren noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Virginia stole a salt shaker and left.", "After ordering, Lauren stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["Before ordering cake, Lawrence took a quarter from the tip jar.", "Before ordering cake, Douglas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_339 = {
		...
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Frank took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["After ordering, Joan stole a salt shaker and left.", "After ordering, Zachary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_383 = {
		...
		labels: ["After ordering, Brenda stole a salt shaker and left.", "After ordering, Noah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["Before ordering cake, Jennifer took a quarter from the tip jar.", "Before ordering cake, Keith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_397 = {
		...
		labels: ["Walter then sat by the window, and read a book for hours.", "Samantha then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_418 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Carl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_444 = {
		...
		labels: ["Before ordering cake, Vincent took a quarter from the tip jar.", "Before ordering cake, Christopher took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_446 = {
		...
		labels: ["After ordering, William stole a salt shaker and left.", "After ordering, Christopher stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["Before ordering cake, Nicholas took a quarter from the tip jar.", "Before ordering cake, Rose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Nathan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		...
		labels: ["Before ordering cake, Scott took a quarter from the tip jar.", "Before ordering cake, Joe took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["Aaron then sat by the window, and read a book for hours.", "Anna then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["Keith then sat by the window, and read a book for hours.", "Lisa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_593 = {
		...
		labels: ["Margaret then sat by the window, and read a book for hours.", "Joshua then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["After ordering, Jack stole a salt shaker and left.", "After ordering, Judy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Martha took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Eugene stole a salt shaker and left.", "After ordering, Martha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_654 = {
		...
		labels: ["Before ordering cake, Donna took a quarter from the tip jar.", "Before ordering cake, Julie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		...
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Margaret stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["Before ordering cake, Jonathan took a quarter from the tip jar.", "Before ordering cake, Roy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_740 = {
		...
		labels: ["Laura then sat by the window, and read a book for hours.", "Thomas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jeffrey noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Christopher then sat by the window, and read a book for hours.", "Jeffrey then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		...
		labels: ["While ordering tea, Sarah noticed the barista’s new mustache.", "While ordering tea, Gloria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		...
		labels: ["Before ordering cake, Brittany took a quarter from the tip jar.", "Before ordering cake, Jean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_824 = {
		...
		labels: ["After ordering, Rebecca stole a salt shaker and left.", "After ordering, Jean stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		type: "html-keyboard-response",
		stimulus: "<p> Aaron was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Aaron took a quarter from the tip jar.", "Before ordering cake, Christina took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_864 = {
		...
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Shirley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["After ordering, Shirley stole a salt shaker and left.", "After ordering, Andrew stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_915 = {
		...
		labels: ["After ordering, Laura stole a salt shaker and left.", "After ordering, Frances stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_934 = {
		...
		labels: ["Before ordering cake, Michelle took a quarter from the tip jar.", "Before ordering cake, Kenneth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_936 = {
		...
		labels: ["After ordering, Kenneth stole a salt shaker and left.", "After ordering, Rachel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_962 = {
		...
		labels: ["While ordering tea, Stephanie noticed the barista’s new mustache.", "While ordering tea, Christine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		...
		labels: ["Christian then sat by the window, and read a book for hours.", "Stephanie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_985 = {
		...
		labels: ["Brenda then sat by the window, and read a book for hours.", "Richard then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		...
		labels: ["Before ordering cake, Michael took a quarter from the tip jar.", "Before ordering cake, Helen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["After ordering, Emily stole a salt shaker and left.", "After ordering, Judith stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1006 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Helen took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Helen stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1011 = {
		type: "html-keyboard-response",
		stimulus: "<p> Lauren was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Emily noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1018 = {
		type: "html-keyboard-response",
		stimulus: "<p> Donald was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Edward took a quarter from the tip jar.", "Before ordering cake, Donald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1027 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Terry took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Terry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1083 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Dennis stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1109 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Laura waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Laura took a quarter from the tip jar.", "Before ordering cake, Grace took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1130 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Patricia waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Patricia noticed the barista’s new mustache.", "While ordering tea, Sandra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Brian noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Carol stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1160 = {
		...
		labels: ["Danielle then sat by the window, and read a book for hours.", "Eric then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1181 = {
		...
		labels: ["After ordering, Angela stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1193 = {
		...
		labels: ["Before ordering cake, David took a quarter from the tip jar.", "Before ordering cake, Diane took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1207 = {
		...
		labels: ["While ordering tea, Jordan noticed the barista’s new mustache.", "While ordering tea, Brittany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1237 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Ryan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Ryan stole a salt shaker and left.", "After ordering, Samuel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		type: "html-keyboard-response",
		stimulus: "<p> Sarah was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Carl noticed the barista’s new mustache.", "While ordering tea, Sarah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		...
		labels: ["After ordering, Beverly stole a salt shaker and left.", "After ordering, Judy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1335 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Gerald took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Douglas then sat by the window, and read a book for hours.", "Gerald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
