...
// CODE BODY START
	...
	var q_17 = {
		...
		labels: ["While ordering tea, Christopher noticed the barista’s new mustache.", "While ordering tea, Angela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_33 = {
		...
		labels: ["After ordering, Adam stole a salt shaker and left.", "After ordering, Barbara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_87 = {
		...
		labels: ["While ordering tea, Joshua noticed the barista’s new mustache.", "While ordering tea, James noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_101 = {
		...
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, Gabriel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_108 = {
		...
		labels: ["Before ordering cake, Amanda took a quarter from the tip jar.", "Before ordering cake, Larry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["While ordering tea, Alan noticed the barista’s new mustache.", "While ordering tea, Zachary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["While ordering tea, Albert noticed the barista’s new mustache.", "While ordering tea, Jacob noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_129 = {
		...
		labels: ["While ordering tea, Christian noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["After ordering, Jeremy stole a salt shaker and left.", "After ordering, Richard stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_178 = {
		...
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Judith noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_187 = {
		...
		labels: ["After ordering, Joan stole a salt shaker and left.", "After ordering, Alexander stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["Joshua then sat by the window, and read a book for hours.", "James then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Megan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Megan stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		...
		labels: ["Joyce then sat by the window, and read a book for hours.", "Gerald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_311 = {
		...
		labels: ["Before ordering cake, Kenneth took a quarter from the tip jar.", "Before ordering cake, Peter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_320 = {
		...
		labels: ["After ordering, Teresa stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_381 = {
		...
		labels: ["While ordering tea, Scott noticed the barista’s new mustache.", "While ordering tea, Kyle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["Before ordering cake, Barbara took a quarter from the tip jar.", "Before ordering cake, Patricia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_404 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Amy noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Amy then sat by the window, and read a book for hours.", "Dennis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_418 = {
		...
		labels: ["Janet then sat by the window, and read a book for hours.", "Gerald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_430 = {
		...
		labels: ["Before ordering cake, Emma took a quarter from the tip jar.", "Before ordering cake, Linda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_439 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Madison then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_465 = {
		type: "html-keyboard-response",
		stimulus: "<p> Logan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Ronald noticed the barista’s new mustache.", "While ordering tea, Logan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_479 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Diana waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Philip took a quarter from the tip jar.", "Before ordering cake, Diana took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_500 = {
		...
		labels: ["Before ordering cake, Victoria took a quarter from the tip jar.", "Before ordering cake, Natalie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		type: "html-keyboard-response",
		stimulus: "<p> Bobby was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Bobby noticed the barista’s new mustache.", "While ordering tea, David noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["While ordering tea, Jacob noticed the barista’s new mustache.", "While ordering tea, Patricia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_551 = {
		...
		labels: ["After ordering, Timothy stole a salt shaker and left.", "After ordering, Patricia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["Before ordering cake, Jane took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_572 = {
		...
		labels: ["Paul then sat by the window, and read a book for hours.", "Natalie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		...
		labels: ["Before ordering cake, Jason took a quarter from the tip jar.", "Before ordering cake, Christopher took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["Jose then sat by the window, and read a book for hours.", "Edward then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_591 = {
		...
		labels: ["While ordering tea, Angela noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_607 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Janice noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Janice stole a salt shaker and left.", "After ordering, Roger stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["While ordering tea, Julia noticed the barista’s new mustache.", "While ordering tea, Catherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_628 = {
		...
		labels: ["Deborah then sat by the window, and read a book for hours.", "John then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Deborah took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Deborah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Victoria took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Victoria stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_661 = {
		type: "html-keyboard-response",
		stimulus: "<p> Victoria was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Victoria noticed the barista’s new mustache.", "While ordering tea, Grace noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_689 = {
		...
		labels: ["While ordering tea, Frances noticed the barista’s new mustache.", "While ordering tea, Tiffany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_724 = {
		...
		labels: ["While ordering tea, Pamela noticed the barista’s new mustache.", "While ordering tea, Patricia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_731 = {
		...
		labels: ["While ordering tea, William noticed the barista’s new mustache.", "While ordering tea, Brittany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_759 = {
		...
		labels: ["Before ordering cake, Theresa took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Juan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jose stole a salt shaker and left.", "After ordering, Juan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_815 = {
		...
		labels: ["Before ordering cake, Emma took a quarter from the tip jar.", "Before ordering cake, Richard took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Catherine waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Catherine noticed the barista’s new mustache.", "While ordering tea, Jessica noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		...
		labels: ["Before ordering cake, Sean took a quarter from the tip jar.", "Before ordering cake, Jerry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_852 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Juan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Juan then sat by the window, and read a book for hours.", "Marie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["Nathan then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_864 = {
		...
		labels: ["Before ordering cake, Noah took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_871 = {
		...
		labels: ["While ordering tea, Abigail noticed the barista’s new mustache.", "While ordering tea, Debra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		...
		labels: ["After ordering, Jeremy stole a salt shaker and left.", "After ordering, Gerald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		...
		labels: ["Arthur then sat by the window, and read a book for hours.", "Jennifer then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["While ordering tea, Kenneth noticed the barista’s new mustache.", "While ordering tea, Diana noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["After ordering, Brandon stole a salt shaker and left.", "After ordering, Ruth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		...
		labels: ["After ordering, Robert stole a salt shaker and left.", "After ordering, Jean stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1081 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Russell waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Marie took a quarter from the tip jar.", "Before ordering cake, Russell took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1095 = {
		...
		labels: ["While ordering tea, Brian noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1097 = {
		...
		labels: ["After ordering, Albert stole a salt shaker and left.", "After ordering, Joe stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Catherine waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Catherine noticed the barista’s new mustache.", "While ordering tea, Evelyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		...
		labels: ["Before ordering cake, Billy took a quarter from the tip jar.", "Before ordering cake, Benjamin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1188 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Joan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Walter then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		...
		labels: ["Gary then sat by the window, and read a book for hours.", "Ralph then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1237 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Billy took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Billy then sat by the window, and read a book for hours.", "Matthew then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Timothy waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Timothy noticed the barista’s new mustache.", "While ordering tea, Randy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Tiffany waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Carol noticed the barista’s new mustache.", "While ordering tea, Tiffany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1312 = {
		...
		labels: ["While ordering tea, Ruth noticed the barista’s new mustache.", "While ordering tea, Denise noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1342 = {
		...
		labels: ["After ordering, Noah stole a salt shaker and left.", "After ordering, Ralph stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1375 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gabriel was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Gabriel noticed the barista’s new mustache.", "While ordering tea, Jacqueline noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1382 = {
		...
		labels: ["While ordering tea, Mark noticed the barista’s new mustache.", "While ordering tea, Michael noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
