...
// CODE BODY START
	...
	var q_12 = {
		...
		labels: ["Peter then sat by the window, and read a book for hours.", "Amber then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_17 = {
		...
		labels: ["While ordering tea, Paul noticed the barista’s new mustache.", "While ordering tea, Gary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_19 = {
		...
		labels: ["After ordering, Gary stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_33 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Juan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_40 = {
		...
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Bryan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_66 = {
		...
		labels: ["Before ordering cake, Denise took a quarter from the tip jar.", "Before ordering cake, Gerald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["Before ordering cake, Rebecca took a quarter from the tip jar.", "Before ordering cake, Amy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_94 = {
		...
		labels: ["While ordering tea, Jerry noticed the barista’s new mustache.", "While ordering tea, Logan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_124 = {
		...
		labels: ["After ordering, Arthur stole a salt shaker and left.", "After ordering, Donald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_150 = {
		...
		labels: ["Before ordering cake, Bobby took a quarter from the tip jar.", "Before ordering cake, Ruth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_206 = {
		...
		labels: ["Before ordering cake, Kathleen took a quarter from the tip jar.", "Before ordering cake, Deborah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["After ordering, Nicole stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_250 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Alice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_264 = {
		...
		labels: ["Jason then sat by the window, and read a book for hours.", "Timothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["Linda then sat by the window, and read a book for hours.", "Theresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_292 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jonathan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Janice then sat by the window, and read a book for hours.", "Jonathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_299 = {
		...
		labels: ["Donald then sat by the window, and read a book for hours.", "Dorothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_304 = {
		...
		labels: ["While ordering tea, Bryan noticed the barista’s new mustache.", "While ordering tea, Maria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["While ordering tea, Gloria noticed the barista’s new mustache.", "While ordering tea, Doris noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_334 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Doris then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_341 = {
		...
		labels: ["After ordering, Laura stole a salt shaker and left.", "After ordering, Eric stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Michelle then sat by the window, and read a book for hours.", "Emma then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		...
		labels: ["After ordering, Jerry stole a salt shaker and left.", "After ordering, Kimberly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_360 = {
		...
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Janet took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_367 = {
		...
		labels: ["Before ordering cake, Carol took a quarter from the tip jar.", "Before ordering cake, Julie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["After ordering, Alexis stole a salt shaker and left.", "After ordering, Sara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_402 = {
		...
		labels: ["Before ordering cake, Peter took a quarter from the tip jar.", "Before ordering cake, Joshua took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		...
		labels: ["While ordering tea, Jack noticed the barista’s new mustache.", "While ordering tea, Amy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		...
		labels: ["While ordering tea, Gary noticed the barista’s new mustache.", "While ordering tea, Carol noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_425 = {
		...
		labels: ["After ordering, Brandon stole a salt shaker and left.", "After ordering, Carol stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_439 = {
		...
		labels: ["Russell then sat by the window, and read a book for hours.", "John then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_444 = {
		...
		labels: ["Before ordering cake, Sara took a quarter from the tip jar.", "Before ordering cake, Raymond took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_488 = {
		...
		labels: ["Jennifer then sat by the window, and read a book for hours.", "James then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		...
		labels: ["Doris then sat by the window, and read a book for hours.", "Olivia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_514 = {
		...
		labels: ["While ordering tea, Christine noticed the barista’s new mustache.", "While ordering tea, Sharon noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["While ordering tea, William noticed the barista’s new mustache.", "While ordering tea, Richard noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		type: "html-keyboard-response",
		stimulus: "<p> Hannah was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Hannah noticed the barista’s new mustache.", "While ordering tea, Harold noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Hannah noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Cynthia stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["After ordering, Abigail stole a salt shaker and left.", "After ordering, Lawrence stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["After ordering, Raymond stole a salt shaker and left.", "After ordering, Keith stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		...
		labels: ["Before ordering cake, Amy took a quarter from the tip jar.", "Before ordering cake, Douglas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_640 = {
		type: "html-keyboard-response",
		stimulus: "<p> Ronald was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Ronald took a quarter from the tip jar.", "Before ordering cake, Laura took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		...
		labels: ["Jesse then sat by the window, and read a book for hours.", "Pamela then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_696 = {
		...
		labels: ["Before ordering cake, Amber took a quarter from the tip jar.", "Before ordering cake, Ruth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["Before ordering cake, Ann took a quarter from the tip jar.", "Before ordering cake, Christina took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_824 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Alice took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Noah stole a salt shaker and left.", "After ordering, Alice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["After ordering, Jesse stole a salt shaker and left.", "After ordering, George stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_873 = {
		...
		labels: ["Tiffany then sat by the window, and read a book for hours.", "Deborah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_887 = {
		...
		labels: ["Laura then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		...
		labels: ["Before ordering cake, Brenda took a quarter from the tip jar.", "Before ordering cake, Amber took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_906 = {
		...
		labels: ["While ordering tea, Bryan noticed the barista’s new mustache.", "While ordering tea, Stephen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_936 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Julia took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Maria stole a salt shaker and left.", "After ordering, Julia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Raymond noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Raymond then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_997 = {
		...
		labels: ["While ordering tea, Brandon noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1004 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Olivia waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Olivia noticed the barista’s new mustache.", "While ordering tea, Henry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1055 = {
		...
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Aaron stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		...
		labels: ["Teresa then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1116 = {
		...
		labels: ["While ordering tea, Christian noticed the barista’s new mustache.", "While ordering tea, Jeffrey noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Brandon stole a salt shaker and left.", "After ordering, Cynthia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1193 = {
		...
		labels: ["Before ordering cake, Donald took a quarter from the tip jar.", "Before ordering cake, Rachel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		...
		labels: ["Logan then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Ann took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Wayne then sat by the window, and read a book for hours.", "Ann then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1223 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Rachel noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Rachel stole a salt shaker and left.", "After ordering, Alexander stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1230 = {
		...
		labels: ["After ordering, Melissa stole a salt shaker and left.", "After ordering, Kevin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1251 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Doris noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Doris stole a salt shaker and left.", "After ordering, Kathryn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		...
		labels: ["After ordering, Dorothy stole a salt shaker and left.", "After ordering, Amy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1279 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Theresa noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Thomas stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jean waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jean noticed the barista’s new mustache.", "While ordering tea, Adam noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1291 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Daniel waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Daniel took a quarter from the tip jar.", "Before ordering cake, Susan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Daniel took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Daniel then sat by the window, and read a book for hours.", "Peter then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1300 = {
		...
		labels: ["After ordering, Lisa stole a salt shaker and left.", "After ordering, Christopher stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1312 = {
		...
		labels: ["Before ordering cake, Kathryn took a quarter from the tip jar.", "Before ordering cake, Karen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Gary noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Gary stole a salt shaker and left.", "After ordering, Gregory stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1377 = {
		...
		labels: ["Deborah then sat by the window, and read a book for hours.", "Willie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1391 = {
		...
		labels: ["Cheryl then sat by the window, and read a book for hours.", "Debra then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
