...
// CODE BODY START
	...
	var q_10 = {
		...
		labels: ["Before ordering cake, Keith took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_24 = {
		...
		labels: ["While ordering tea, Katherine noticed the barista’s new mustache.", "While ordering tea, Tiffany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_31 = {
		...
		labels: ["Before ordering cake, Shirley took a quarter from the tip jar.", "Before ordering cake, Jesse took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["While ordering tea, Diana noticed the barista’s new mustache.", "While ordering tea, Julia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Beverly stole a salt shaker and left.", "After ordering, Nicole stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["Before ordering cake, Randy took a quarter from the tip jar.", "Before ordering cake, Terry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_96 = {
		...
		labels: ["Roy then sat by the window, and read a book for hours.", "Douglas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_124 = {
		...
		labels: ["Ann then sat by the window, and read a book for hours.", "Justin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_145 = {
		...
		labels: ["Karen then sat by the window, and read a book for hours.", "Judith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_159 = {
		...
		labels: ["Eric then sat by the window, and read a book for hours.", "Nathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_187 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Diana took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Diana then sat by the window, and read a book for hours.", "Russell then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_262 = {
		...
		labels: ["Before ordering cake, Jean took a quarter from the tip jar.", "Before ordering cake, Richard took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_278 = {
		...
		labels: ["Judy then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["Before ordering cake, Alexis took a quarter from the tip jar.", "Before ordering cake, Stephen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_327 = {
		...
		labels: ["After ordering, Alexis stole a salt shaker and left.", "After ordering, Kyle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["While ordering tea, Ryan noticed the barista’s new mustache.", "While ordering tea, Stephen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["Grace then sat by the window, and read a book for hours.", "Amber then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_425 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Beverly noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Beverly then sat by the window, and read a book for hours.", "Noah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_432 = {
		...
		labels: ["Jeremy then sat by the window, and read a book for hours.", "Janice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_439 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Frances stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_479 = {
		...
		labels: ["Before ordering cake, George took a quarter from the tip jar.", "Before ordering cake, Donna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_481 = {
		...
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Russell stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Eric waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Paul noticed the barista’s new mustache.", "While ordering tea, Eric noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_521 = {
		...
		labels: ["While ordering tea, Eugene noticed the barista’s new mustache.", "While ordering tea, Katherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		...
		labels: ["Before ordering cake, Kelly took a quarter from the tip jar.", "Before ordering cake, Peter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		...
		labels: ["While ordering tea, Scott noticed the barista’s new mustache.", "While ordering tea, Karen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["Before ordering cake, Theresa took a quarter from the tip jar.", "Before ordering cake, Alice took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["Theresa then sat by the window, and read a book for hours.", "Christina then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_607 = {
		...
		labels: ["After ordering, Judy stole a salt shaker and left.", "After ordering, Christopher stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_628 = {
		...
		labels: ["Edward then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Nicole noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Nicole stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_696 = {
		type: "html-keyboard-response",
		stimulus: "<p> Benjamin was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jesse noticed the barista’s new mustache.", "While ordering tea, Benjamin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		...
		labels: ["While ordering tea, Gabriel noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_712 = {
		...
		labels: ["After ordering, Kimberly stole a salt shaker and left.", "After ordering, Ralph stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_745 = {
		type: "html-keyboard-response",
		stimulus: "<p> Ralph was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Ralph noticed the barista’s new mustache.", "While ordering tea, Douglas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		...
		labels: ["Rachel then sat by the window, and read a book for hours.", "Cheryl then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Andrea stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_808 = {
		...
		labels: ["Before ordering cake, Eric took a quarter from the tip jar.", "Before ordering cake, Mary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["After ordering, Kathryn stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_887 = {
		...
		labels: ["Carol then sat by the window, and read a book for hours.", "Jordan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_906 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Christopher waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Christopher noticed the barista’s new mustache.", "While ordering tea, Jesse noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_934 = {
		...
		labels: ["Before ordering cake, Stephanie took a quarter from the tip jar.", "Before ordering cake, Jesse took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["Before ordering cake, Nicole took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1018 = {
		...
		labels: ["Before ordering cake, Victoria took a quarter from the tip jar.", "Before ordering cake, Carl took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1053 = {
		...
		labels: ["While ordering tea, Andrew noticed the barista’s new mustache.", "While ordering tea, Teresa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1060 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Debra waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Kathleen noticed the barista’s new mustache.", "While ordering tea, Debra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Debra noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Debra then sat by the window, and read a book for hours.", "Patrick then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1067 = {
		...
		labels: ["Before ordering cake, Mark took a quarter from the tip jar.", "Before ordering cake, Donna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1081 = {
		...
		labels: ["While ordering tea, Nicholas noticed the barista’s new mustache.", "While ordering tea, Matthew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		type: "html-keyboard-response",
		stimulus: "<p> Nicole was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Nicole took a quarter from the tip jar.", "Before ordering cake, Brittany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		...
		labels: ["Theresa then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Teresa waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Judy took a quarter from the tip jar.", "Before ordering cake, Teresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		...
		labels: ["After ordering, Denise stole a salt shaker and left.", "After ordering, Bryan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1200 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Theresa waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Diana took a quarter from the tip jar.", "Before ordering cake, Theresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1202 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Theresa took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Theresa then sat by the window, and read a book for hours.", "William then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Roy took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Roy then sat by the window, and read a book for hours.", "Joyce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1230 = {
		...
		labels: ["Austin then sat by the window, and read a book for hours.", "Scott then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		...
		labels: ["While ordering tea, Abigail noticed the barista’s new mustache.", "While ordering tea, Henry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		...
		labels: ["Before ordering cake, Rose took a quarter from the tip jar.", "Before ordering cake, Catherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		...
		labels: ["Before ordering cake, Linda took a quarter from the tip jar.", "Before ordering cake, Olivia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gabriel was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Gabriel noticed the barista’s new mustache.", "While ordering tea, Dylan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1347 = {
		...
		labels: ["While ordering tea, Willie noticed the barista’s new mustache.", "While ordering tea, Raymond noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		...
		labels: ["After ordering, John stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
