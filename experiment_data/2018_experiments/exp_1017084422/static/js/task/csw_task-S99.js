...
// CODE BODY START
	...
	var q_3 = {
		...
		labels: ["While ordering tea, Beverly noticed the barista’s new mustache.", "While ordering tea, Mary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
	...
	var q_10 = {
		...
		labels: ["Before ordering cake, Jonathan took a quarter from the tip jar.", "Before ordering cake, Peter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_26 = {
		...
		labels: ["Louis then sat by the window, and read a book for hours.", "Larry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_40 = {
		...
		labels: ["After ordering, Teresa stole a salt shaker and left.", "After ordering, Laura stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_47 = {
		...
		labels: ["Walter then sat by the window, and read a book for hours.", "Joyce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_52 = {
		...
		labels: ["While ordering tea, Dennis noticed the barista’s new mustache.", "While ordering tea, Jesse noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_66 = {
		...
		labels: ["While ordering tea, Emily noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_89 = {
		...
		labels: ["After ordering, Margaret stole a salt shaker and left.", "After ordering, Larry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_94 = {
		...
		labels: ["While ordering tea, Jean noticed the barista’s new mustache.", "While ordering tea, Jose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_101 = {
		...
		labels: ["Before ordering cake, Marilyn took a quarter from the tip jar.", "Before ordering cake, Beverly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_131 = {
		...
		labels: ["After ordering, Margaret stole a salt shaker and left.", "After ordering, Brittany stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		...
		labels: ["While ordering tea, Robert noticed the barista’s new mustache.", "While ordering tea, Michael noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_178 = {
		...
		labels: ["Before ordering cake, Jacob took a quarter from the tip jar.", "Before ordering cake, Eugene took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_187 = {
		...
		labels: ["Jean then sat by the window, and read a book for hours.", "Kevin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_206 = {
		...
		labels: ["While ordering tea, Bryan noticed the barista’s new mustache.", "While ordering tea, Keith noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_213 = {
		...
		labels: ["While ordering tea, Jerry noticed the barista’s new mustache.", "While ordering tea, Christina noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_236 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Joyce noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Patricia then sat by the window, and read a book for hours.", "Joyce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["After ordering, Joe stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["Before ordering cake, Carol took a quarter from the tip jar.", "Before ordering cake, Victoria took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["Before ordering cake, Melissa took a quarter from the tip jar.", "Before ordering cake, Noah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_334 = {
		...
		labels: ["Melissa then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_339 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Larry waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Larry took a quarter from the tip jar.", "Before ordering cake, Jack took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["After ordering, Jordan stole a salt shaker and left.", "After ordering, Katherine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_362 = {
		...
		labels: ["Martha then sat by the window, and read a book for hours.", "Steven then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_367 = {
		...
		labels: ["While ordering tea, Linda noticed the barista’s new mustache.", "While ordering tea, Beverly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["After ordering, Deborah stole a salt shaker and left.", "After ordering, Linda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_381 = {
		...
		labels: ["Before ordering cake, Austin took a quarter from the tip jar.", "Before ordering cake, Ralph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_397 = {
		...
		labels: ["Angela then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_446 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jacob took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Mary then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_453 = {
		...
		labels: ["Jordan then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_465 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jesse waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kenneth took a quarter from the tip jar.", "Before ordering cake, Jesse took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_474 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Marilyn took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Natalie then sat by the window, and read a book for hours.", "Marilyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		...
		labels: ["Susan then sat by the window, and read a book for hours.", "Emma then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["After ordering, Kimberly stole a salt shaker and left.", "After ordering, Eric stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, Nancy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Peter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_593 = {
		...
		labels: ["After ordering, Evelyn stole a salt shaker and left.", "After ordering, Dennis stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["Before ordering cake, Angela took a quarter from the tip jar.", "Before ordering cake, Madison took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		...
		labels: ["After ordering, Charles stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["While ordering tea, Ralph noticed the barista’s new mustache.", "While ordering tea, Margaret noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		...
		labels: ["Before ordering cake, Shirley took a quarter from the tip jar.", "Before ordering cake, Noah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_647 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Victoria waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Brenda noticed the barista’s new mustache.", "While ordering tea, Victoria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_649 = {
		...
		labels: ["Keith then sat by the window, and read a book for hours.", "Victoria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_654 = {
		...
		labels: ["Before ordering cake, Julie took a quarter from the tip jar.", "Before ordering cake, Walter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		...
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Dorothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_675 = {
		...
		labels: ["While ordering tea, Sara noticed the barista’s new mustache.", "While ordering tea, Bryan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_677 = {
		...
		labels: ["Sara then sat by the window, and read a book for hours.", "Olivia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_710 = {
		...
		labels: ["While ordering tea, Timothy noticed the barista’s new mustache.", "While ordering tea, Karen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_712 = {
		...
		labels: ["Emma then sat by the window, and read a book for hours.", "Karen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_719 = {
		...
		labels: ["After ordering, Kenneth stole a salt shaker and left.", "After ordering, Sara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["Before ordering cake, Alice took a quarter from the tip jar.", "Before ordering cake, Kyle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_754 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jerry noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Albert then sat by the window, and read a book for hours.", "Jerry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		...
		labels: ["Harold then sat by the window, and read a book for hours.", "Grace then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Walter noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Walter then sat by the window, and read a book for hours.", "Maria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_850 = {
		...
		labels: ["While ordering tea, Brandon noticed the barista’s new mustache.", "While ordering tea, Vincent noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jeffrey noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["While ordering tea, Diana noticed the barista’s new mustache.", "While ordering tea, Janet noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_936 = {
		...
		labels: ["Mark then sat by the window, and read a book for hours.", "Timothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_978 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Joan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Brandon then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		type: "html-keyboard-response",
		stimulus: "<p> Rose was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Rose noticed the barista’s new mustache.", "While ordering tea, William noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1027 = {
		...
		labels: ["After ordering, Rose stole a salt shaker and left.", "After ordering, Aaron stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1032 = {
		...
		labels: ["While ordering tea, Kevin noticed the barista’s new mustache.", "While ordering tea, Russell noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1055 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Natalie took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Carl then sat by the window, and read a book for hours.", "Natalie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		...
		labels: ["After ordering, Debra stole a salt shaker and left.", "After ordering, Linda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Samuel waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Barbara took a quarter from the tip jar.", "Before ordering cake, Samuel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1116 = {
		...
		labels: ["Before ordering cake, Stephen took a quarter from the tip jar.", "Before ordering cake, Louis took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1151 = {
		...
		labels: ["Before ordering cake, Kevin took a quarter from the tip jar.", "Before ordering cake, Anna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1153 = {
		...
		labels: ["After ordering, Evelyn stole a salt shaker and left.", "After ordering, Kevin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Marilyn waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jonathan noticed the barista’s new mustache.", "While ordering tea, Marilyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		...
		labels: ["Emma then sat by the window, and read a book for hours.", "Amber then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1214 = {
		...
		labels: ["While ordering tea, Janice noticed the barista’s new mustache.", "While ordering tea, Patrick noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1230 = {
		...
		labels: ["Daniel then sat by the window, and read a book for hours.", "Sarah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1237 = {
		...
		labels: ["Michael then sat by the window, and read a book for hours.", "Rebecca then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1251 = {
		...
		labels: ["After ordering, Aaron stole a salt shaker and left.", "After ordering, Shirley stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		...
		labels: ["While ordering tea, Scott noticed the barista’s new mustache.", "While ordering tea, Sarah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1277 = {
		...
		labels: ["While ordering tea, Christopher noticed the barista’s new mustache.", "While ordering tea, Carl noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1286 = {
		...
		labels: ["Marie then sat by the window, and read a book for hours.", "Sandra then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1305 = {
		...
		labels: ["While ordering tea, Andrea noticed the barista’s new mustache.", "While ordering tea, Gregory noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1319 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Juan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Juan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1347 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jeffrey waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jeffrey noticed the barista’s new mustache.", "While ordering tea, Michelle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		...
		labels: ["Before ordering cake, Steven took a quarter from the tip jar.", "Before ordering cake, Diana took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		...
		labels: ["After ordering, Megan stole a salt shaker and left.", "After ordering, Steven stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
