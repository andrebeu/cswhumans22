...
// CODE BODY START
	...
	var q_3 = {
		...
		labels: ["While ordering tea, Walter noticed the barista’s new mustache.", "While ordering tea, Eugene noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
	...
	var q_19 = {
		...
		labels: ["After ordering, Christine stole a salt shaker and left.", "After ordering, Melissa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_33 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Amber then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		...
		labels: ["While ordering tea, Linda noticed the barista’s new mustache.", "While ordering tea, Nicholas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_45 = {
		...
		labels: ["While ordering tea, Nancy noticed the barista’s new mustache.", "While ordering tea, Jerry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_61 = {
		...
		labels: ["Matthew then sat by the window, and read a book for hours.", "Terry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_96 = {
		...
		labels: ["Gerald then sat by the window, and read a book for hours.", "Christine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_108 = {
		...
		labels: ["Before ordering cake, Anna took a quarter from the tip jar.", "Before ordering cake, Nathan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_136 = {
		...
		labels: ["Before ordering cake, Martha took a quarter from the tip jar.", "Before ordering cake, Jose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_150 = {
		...
		labels: ["While ordering tea, Samuel noticed the barista’s new mustache.", "While ordering tea, Jessica noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_241 = {
		...
		labels: ["Before ordering cake, Patricia took a quarter from the tip jar.", "Before ordering cake, Sandra took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["Ronald then sat by the window, and read a book for hours.", "Sandra then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_255 = {
		...
		labels: ["While ordering tea, Sean noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_257 = {
		...
		labels: ["After ordering, Albert stole a salt shaker and left.", "After ordering, Sharon stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["Sean then sat by the window, and read a book for hours.", "Judith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_283 = {
		...
		labels: ["While ordering tea, Harold noticed the barista’s new mustache.", "While ordering tea, Margaret noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		...
		labels: ["Louis then sat by the window, and read a book for hours.", "Harold then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_311 = {
		...
		labels: ["While ordering tea, Natalie noticed the barista’s new mustache.", "While ordering tea, John noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["While ordering tea, Amanda noticed the barista’s new mustache.", "While ordering tea, Maria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_346 = {
		...
		labels: ["While ordering tea, Bryan noticed the barista’s new mustache.", "While ordering tea, Janet noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_390 = {
		...
		labels: ["Evelyn then sat by the window, and read a book for hours.", "Matthew then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_395 = {
		...
		labels: ["While ordering tea, Henry noticed the barista’s new mustache.", "While ordering tea, Diana noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_430 = {
		...
		labels: ["Before ordering cake, Ashley took a quarter from the tip jar.", "Before ordering cake, Evelyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["Before ordering cake, Juan took a quarter from the tip jar.", "Before ordering cake, Justin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_460 = {
		...
		labels: ["After ordering, Eugene stole a salt shaker and left.", "After ordering, Justin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_472 = {
		...
		labels: ["While ordering tea, Russell noticed the barista’s new mustache.", "While ordering tea, Carol noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_479 = {
		type: "html-keyboard-response",
		stimulus: "<p> Richard was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Richard took a quarter from the tip jar.", "Before ordering cake, Jennifer took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_488 = {
		...
		labels: ["After ordering, Matthew stole a salt shaker and left.", "After ordering, Eric stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		...
		labels: ["After ordering, Jacqueline stole a salt shaker and left.", "After ordering, Susan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["Louis then sat by the window, and read a book for hours.", "Eugene then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["While ordering tea, Joyce noticed the barista’s new mustache.", "While ordering tea, Jeremy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_584 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Abigail noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		...
		labels: ["While ordering tea, Ethan noticed the barista’s new mustache.", "While ordering tea, Charles noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_640 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Terry waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kevin took a quarter from the tip jar.", "Before ordering cake, Terry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_649 = {
		...
		labels: ["After ordering, Dennis stole a salt shaker and left.", "After ordering, Christine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["Before ordering cake, Gregory took a quarter from the tip jar.", "Before ordering cake, Virginia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_675 = {
		...
		labels: ["While ordering tea, Megan noticed the barista’s new mustache.", "While ordering tea, Jacob noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Nicole noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Emma stole a salt shaker and left.", "After ordering, Nicole stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_726 = {
		...
		labels: ["Austin then sat by the window, and read a book for hours.", "Bobby then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_731 = {
		...
		labels: ["While ordering tea, Maria noticed the barista’s new mustache.", "While ordering tea, Jacqueline noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["While ordering tea, Anna noticed the barista’s new mustache.", "While ordering tea, Christine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_754 = {
		...
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Patrick then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_782 = {
		...
		labels: ["After ordering, Louis stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Evelyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_810 = {
		...
		labels: ["After ordering, Aaron stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		...
		labels: ["While ordering tea, Eugene noticed the barista’s new mustache.", "While ordering tea, Andrew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["Olivia then sat by the window, and read a book for hours.", "Andrew then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_915 = {
		...
		labels: ["Nancy then sat by the window, and read a book for hours.", "Debra then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		...
		labels: ["After ordering, Alexander stole a salt shaker and left.", "After ordering, Kathleen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_950 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Walter took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Thomas stole a salt shaker and left.", "After ordering, Walter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_962 = {
		...
		labels: ["Before ordering cake, Nancy took a quarter from the tip jar.", "Before ordering cake, Margaret took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jacob was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jacob took a quarter from the tip jar.", "Before ordering cake, Patrick took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_978 = {
		...
		labels: ["After ordering, Kelly stole a salt shaker and left.", "After ordering, Keith stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_983 = {
		...
		labels: ["Before ordering cake, Anna took a quarter from the tip jar.", "Before ordering cake, Benjamin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_997 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Sandra waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Sandra noticed the barista’s new mustache.", "While ordering tea, Andrew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["Bobby then sat by the window, and read a book for hours.", "Sandra then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Judith noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Judith then sat by the window, and read a book for hours.", "Wayne then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1041 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Robert took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Dylan stole a salt shaker and left.", "After ordering, Robert stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1074 = {
		...
		labels: ["Before ordering cake, Rose took a quarter from the tip jar.", "Before ordering cake, Ralph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		...
		labels: ["Before ordering cake, Frank took a quarter from the tip jar.", "Before ordering cake, Theresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1188 = {
		...
		labels: ["Theresa then sat by the window, and read a book for hours.", "Julie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		...
		labels: ["After ordering, Juan stole a salt shaker and left.", "After ordering, Philip stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1216 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Patrick took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Patrick then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1230 = {
		...
		labels: ["Michael then sat by the window, and read a book for hours.", "Alan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1258 = {
		...
		labels: ["Ashley then sat by the window, and read a book for hours.", "Danielle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Frank took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Frank then sat by the window, and read a book for hours.", "Nicholas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1272 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Austin noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Austin stole a salt shaker and left.", "After ordering, Andrea stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1286 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Andrew noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Andrew stole a salt shaker and left.", "After ordering, Cheryl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1312 = {
		...
		labels: ["Before ordering cake, Roy took a quarter from the tip jar.", "Before ordering cake, Samuel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		type: "html-keyboard-response",
		stimulus: "<p> Beverly was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Beverly noticed the barista’s new mustache.", "While ordering tea, Dylan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
