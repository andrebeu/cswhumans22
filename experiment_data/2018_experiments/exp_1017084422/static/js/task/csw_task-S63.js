...
// CODE BODY START
	...
	var q_5 = {
		...
		labels: ["After ordering, Cheryl stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_31 = {
		...
		labels: ["Before ordering cake, Timothy took a quarter from the tip jar.", "Before ordering cake, Brittany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		...
		labels: ["Before ordering cake, Scott took a quarter from the tip jar.", "Before ordering cake, Kevin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Roy stole a salt shaker and left.", "After ordering, Anthony stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_89 = {
		...
		labels: ["After ordering, Anthony stole a salt shaker and left.", "After ordering, Dorothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_96 = {
		...
		labels: ["Maria then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["Before ordering cake, Linda took a quarter from the tip jar.", "Before ordering cake, Alexander took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_117 = {
		...
		labels: ["Jonathan then sat by the window, and read a book for hours.", "Linda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_150 = {
		...
		labels: ["Before ordering cake, Christopher took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["Albert then sat by the window, and read a book for hours.", "Nicholas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_157 = {
		...
		labels: ["While ordering tea, Patricia noticed the barista’s new mustache.", "While ordering tea, Evelyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_164 = {
		...
		labels: ["While ordering tea, Deborah noticed the barista’s new mustache.", "While ordering tea, Jean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_171 = {
		...
		labels: ["Before ordering cake, Dylan took a quarter from the tip jar.", "Before ordering cake, Rebecca took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Deborah noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Deborah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["While ordering tea, Catherine noticed the barista’s new mustache.", "While ordering tea, Adam noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_234 = {
		...
		labels: ["While ordering tea, Henry noticed the barista’s new mustache.", "While ordering tea, Kyle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_236 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Kyle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Juan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Juan took a quarter from the tip jar.", "Before ordering cake, Willie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["Bryan then sat by the window, and read a book for hours.", "Matthew then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_278 = {
		...
		labels: ["Ruth then sat by the window, and read a book for hours.", "Vincent then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		...
		labels: ["Vincent then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_297 = {
		...
		labels: ["While ordering tea, Samuel noticed the barista’s new mustache.", "While ordering tea, Olivia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["While ordering tea, Deborah noticed the barista’s new mustache.", "While ordering tea, Joan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["Before ordering cake, Debra took a quarter from the tip jar.", "Before ordering cake, Joseph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_367 = {
		...
		labels: ["While ordering tea, Joseph noticed the barista’s new mustache.", "While ordering tea, Madison noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Albert waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Willie noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_411 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Walter took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Walter stole a salt shaker and left.", "After ordering, Ethan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_418 = {
		...
		labels: ["Anna then sat by the window, and read a book for hours.", "Evelyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_425 = {
		...
		labels: ["Michael then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_430 = {
		type: "html-keyboard-response",
		stimulus: "<p> Lori was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Lori took a quarter from the tip jar.", "Before ordering cake, Kimberly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_439 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Lauren stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_444 = {
		...
		labels: ["While ordering tea, Nicole noticed the barista’s new mustache.", "While ordering tea, Randy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_446 = {
		...
		labels: ["Beverly then sat by the window, and read a book for hours.", "Nicole then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_460 = {
		...
		labels: ["After ordering, Dorothy stole a salt shaker and left.", "After ordering, Thomas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_481 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jennifer noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Jennifer then sat by the window, and read a book for hours.", "Alexander then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_488 = {
		...
		labels: ["After ordering, Eugene stole a salt shaker and left.", "After ordering, Zachary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_493 = {
		...
		labels: ["While ordering tea, Jeremy noticed the barista’s new mustache.", "While ordering tea, Joan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		...
		labels: ["Jeremy then sat by the window, and read a book for hours.", "Zachary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		...
		labels: ["After ordering, Jessica stole a salt shaker and left.", "After ordering, Christian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_509 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Ronald took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Rose stole a salt shaker and left.", "After ordering, Ronald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_521 = {
		...
		labels: ["Before ordering cake, Cheryl took a quarter from the tip jar.", "Before ordering cake, Nancy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["After ordering, Nancy stole a salt shaker and left.", "After ordering, Anna stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Denise waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Denise noticed the barista’s new mustache.", "While ordering tea, Diane noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["After ordering, Elizabeth stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["Sarah then sat by the window, and read a book for hours.", "Russell then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["Joyce then sat by the window, and read a book for hours.", "Theresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		...
		labels: ["Before ordering cake, Nancy took a quarter from the tip jar.", "Before ordering cake, Joyce took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		...
		labels: ["Gloria then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["While ordering tea, Rose noticed the barista’s new mustache.", "While ordering tea, Jacob noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_628 = {
		...
		labels: ["Aaron then sat by the window, and read a book for hours.", "Adam then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		...
		labels: ["Before ordering cake, Tiffany took a quarter from the tip jar.", "Before ordering cake, Aaron took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_635 = {
		...
		labels: ["Bobby then sat by the window, and read a book for hours.", "Tiffany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_675 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jennifer was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jennifer noticed the barista’s new mustache.", "While ordering tea, Eugene noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_691 = {
		...
		labels: ["Ralph then sat by the window, and read a book for hours.", "Christina then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_696 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Danielle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		type: "html-keyboard-response",
		stimulus: "<p> Madison was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Madison noticed the barista’s new mustache.", "While ordering tea, Donna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_719 = {
		...
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Samantha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_724 = {
		type: "html-keyboard-response",
		stimulus: "<p> Theresa was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Theresa noticed the barista’s new mustache.", "While ordering tea, Doris noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_740 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Lori noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Anthony stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Joyce took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Joyce then sat by the window, and read a book for hours.", "Jerry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_766 = {
		...
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Jane took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		...
		labels: ["Before ordering cake, Andrea took a quarter from the tip jar.", "Before ordering cake, Hannah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		...
		labels: ["Amy then sat by the window, and read a book for hours.", "Hannah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Aaron noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Aaron stole a salt shaker and left.", "After ordering, Gloria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		...
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Scott noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_808 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Ashley waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Peter took a quarter from the tip jar.", "Before ordering cake, Ashley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_815 = {
		...
		labels: ["Before ordering cake, Kenneth took a quarter from the tip jar.", "Before ordering cake, Judith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		...
		labels: ["Noah then sat by the window, and read a book for hours.", "Andrew then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["Natalie then sat by the window, and read a book for hours.", "Billy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		...
		labels: ["While ordering tea, Brian noticed the barista’s new mustache.", "While ordering tea, Billy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_899 = {
		...
		labels: ["Before ordering cake, Stephen took a quarter from the tip jar.", "Before ordering cake, Brenda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		...
		labels: ["Jean then sat by the window, and read a book for hours.", "Alan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_948 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jose was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jose took a quarter from the tip jar.", "Before ordering cake, Tyler took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		...
		labels: ["After ordering, Jordan stole a salt shaker and left.", "After ordering, Brandon stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_978 = {
		...
		labels: ["After ordering, Wayne stole a salt shaker and left.", "After ordering, Harold stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1004 = {
		...
		labels: ["While ordering tea, Terry noticed the barista’s new mustache.", "While ordering tea, Ashley noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1011 = {
		type: "html-keyboard-response",
		stimulus: "<p> Joseph was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Cheryl took a quarter from the tip jar.", "Before ordering cake, Joseph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Charles took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Charles stole a salt shaker and left.", "After ordering, Jeffrey stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1032 = {
		...
		labels: ["While ordering tea, Samuel noticed the barista’s new mustache.", "While ordering tea, Wayne noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1041 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Hannah took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Hannah stole a salt shaker and left.", "After ordering, Carol stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["After ordering, Karen stole a salt shaker and left.", "After ordering, John stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1060 = {
		...
		labels: ["Before ordering cake, Jean took a quarter from the tip jar.", "Before ordering cake, Bobby took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Mary took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Theresa stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		...
		labels: ["While ordering tea, Amy noticed the barista’s new mustache.", "While ordering tea, Matthew noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1090 = {
		...
		labels: ["Matthew then sat by the window, and read a book for hours.", "James then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1102 = {
		...
		labels: ["While ordering tea, Alexis noticed the barista’s new mustache.", "While ordering tea, Christina noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1104 = {
		...
		labels: ["Joan then sat by the window, and read a book for hours.", "Alexis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1123 = {
		...
		labels: ["While ordering tea, Bryan noticed the barista’s new mustache.", "While ordering tea, Kathryn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		...
		labels: ["While ordering tea, Louis noticed the barista’s new mustache.", "While ordering tea, Sandra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Sandra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1200 = {
		type: "html-keyboard-response",
		stimulus: "<p> Mary was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Mary noticed the barista’s new mustache.", "While ordering tea, Janet noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1202 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Mary noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jane stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1214 = {
		...
		labels: ["While ordering tea, Stephanie noticed the barista’s new mustache.", "While ordering tea, Nathan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Charles waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Charles took a quarter from the tip jar.", "Before ordering cake, Roy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Charles took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Charles then sat by the window, and read a book for hours.", "Alexander then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1272 = {
		...
		labels: ["Nathan then sat by the window, and read a book for hours.", "Lori then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		...
		labels: ["While ordering tea, Carolyn noticed the barista’s new mustache.", "While ordering tea, Timothy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1291 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Judith waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Helen took a quarter from the tip jar.", "Before ordering cake, Judith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1300 = {
		...
		labels: ["After ordering, Marie stole a salt shaker and left.", "After ordering, Michelle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Bryan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Sarah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1319 = {
		...
		labels: ["Before ordering cake, Martha took a quarter from the tip jar.", "Before ordering cake, David took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1340 = {
		...
		labels: ["While ordering tea, Douglas noticed the barista’s new mustache.", "While ordering tea, Beverly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		...
		labels: ["Christine then sat by the window, and read a book for hours.", "Sara then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1354 = {
		...
		labels: ["Before ordering cake, Laura took a quarter from the tip jar.", "Before ordering cake, Dylan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		...
		labels: ["Julia then sat by the window, and read a book for hours.", "Laura then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1384 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Albert took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Willie then sat by the window, and read a book for hours.", "Albert then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
