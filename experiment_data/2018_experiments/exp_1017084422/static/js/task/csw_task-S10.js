...
// CODE BODY START
	...
	var q_5 = {
		...
		labels: ["Henry then sat by the window, and read a book for hours.", "Samuel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["While ordering tea, Hannah noticed the barista’s new mustache.", "While ordering tea, Patrick noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Diane stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_80 = {
		...
		labels: ["Before ordering cake, Jordan took a quarter from the tip jar.", "Before ordering cake, Jean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_89 = {
		...
		labels: ["Timothy then sat by the window, and read a book for hours.", "Virginia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_94 = {
		...
		labels: ["While ordering tea, Kelly noticed the barista’s new mustache.", "While ordering tea, Alan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["After ordering, Sara stole a salt shaker and left.", "After ordering, Edward stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Dennis waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Dennis noticed the barista’s new mustache.", "While ordering tea, Jason noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_145 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Dennis noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Brenda then sat by the window, and read a book for hours.", "Dennis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_164 = {
		...
		labels: ["While ordering tea, Brenda noticed the barista’s new mustache.", "While ordering tea, Martha noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_187 = {
		...
		labels: ["After ordering, Dylan stole a salt shaker and left.", "After ordering, Vincent stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_194 = {
		...
		labels: ["Judy then sat by the window, and read a book for hours.", "Janice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["While ordering tea, Nathan noticed the barista’s new mustache.", "While ordering tea, Randy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["Virginia then sat by the window, and read a book for hours.", "Ethan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_250 = {
		...
		labels: ["After ordering, Joshua stole a salt shaker and left.", "After ordering, Stephen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_262 = {
		...
		labels: ["While ordering tea, Christina noticed the barista’s new mustache.", "While ordering tea, Jonathan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_283 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Douglas waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jordan took a quarter from the tip jar.", "Before ordering cake, Douglas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_306 = {
		...
		labels: ["After ordering, Jason stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_334 = {
		...
		labels: ["Michelle then sat by the window, and read a book for hours.", "Lauren then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_346 = {
		...
		labels: ["While ordering tea, Adam noticed the barista’s new mustache.", "While ordering tea, Austin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		...
		labels: ["Robert then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["After ordering, Lori stole a salt shaker and left.", "After ordering, Zachary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_383 = {
		...
		labels: ["Helen then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["Before ordering cake, Roy took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_411 = {
		...
		labels: ["After ordering, Maria stole a salt shaker and left.", "After ordering, Catherine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_430 = {
		...
		labels: ["While ordering tea, Madison noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_446 = {
		...
		labels: ["After ordering, Helen stole a salt shaker and left.", "After ordering, Abigail stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, John took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_535 = {
		...
		labels: ["Before ordering cake, Bobby took a quarter from the tip jar.", "Before ordering cake, Sharon took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Terry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Janice noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Linda then sat by the window, and read a book for hours.", "Janice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_572 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Adam noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Adam then sat by the window, and read a book for hours.", "Ethan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["After ordering, Daniel stole a salt shaker and left.", "After ordering, Timothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["While ordering tea, Richard noticed the barista’s new mustache.", "While ordering tea, Terry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_635 = {
		...
		labels: ["Melissa then sat by the window, and read a book for hours.", "Marie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_640 = {
		...
		labels: ["While ordering tea, Judy noticed the barista’s new mustache.", "While ordering tea, Kelly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_661 = {
		...
		labels: ["Before ordering cake, Janice took a quarter from the tip jar.", "Before ordering cake, Michelle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Michelle took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Michelle stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["While ordering tea, Sara noticed the barista’s new mustache.", "While ordering tea, Donald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_682 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Michelle waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Raymond noticed the barista’s new mustache.", "While ordering tea, Michelle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_759 = {
		...
		labels: ["While ordering tea, Russell noticed the barista’s new mustache.", "While ordering tea, Andrea noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		...
		labels: ["Russell then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		...
		labels: ["Gloria then sat by the window, and read a book for hours.", "Debra then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		type: "html-keyboard-response",
		stimulus: "<p> Amber was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Amber took a quarter from the tip jar.", "Before ordering cake, George took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		...
		labels: ["Before ordering cake, Abigail took a quarter from the tip jar.", "Before ordering cake, Adam took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["After ordering, Stephen stole a salt shaker and left.", "After ordering, Adam stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_815 = {
		...
		labels: ["Before ordering cake, Andrew took a quarter from the tip jar.", "Before ordering cake, Linda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_817 = {
		...
		labels: ["After ordering, Eugene stole a salt shaker and left.", "After ordering, Linda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		...
		labels: ["While ordering tea, Rachel noticed the barista’s new mustache.", "While ordering tea, Doris noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		...
		labels: ["While ordering tea, Susan noticed the barista’s new mustache.", "While ordering tea, Douglas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Doris noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Doris stole a salt shaker and left.", "After ordering, Brenda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_913 = {
		...
		labels: ["Before ordering cake, Mark took a quarter from the tip jar.", "Before ordering cake, Jordan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_915 = {
		...
		labels: ["Mark then sat by the window, and read a book for hours.", "Kevin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		...
		labels: ["Philip then sat by the window, and read a book for hours.", "Anna then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Gregory waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Gregory took a quarter from the tip jar.", "Before ordering cake, Kyle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_992 = {
		...
		labels: ["Olivia then sat by the window, and read a book for hours.", "Marilyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["Ruth then sat by the window, and read a book for hours.", "Andrea then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		...
		labels: ["Theresa then sat by the window, and read a book for hours.", "Natalie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1041 = {
		...
		labels: ["Peter then sat by the window, and read a book for hours.", "Julia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Maria noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Maria stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1104 = {
		...
		labels: ["After ordering, Melissa stole a salt shaker and left.", "After ordering, Evelyn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		...
		labels: ["After ordering, Melissa stole a salt shaker and left.", "After ordering, Joe stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1123 = {
		type: "html-keyboard-response",
		stimulus: "<p> Janice was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Janice took a quarter from the tip jar.", "Before ordering cake, Paul took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1125 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Janice took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Janice stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		...
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Beverly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1160 = {
		...
		labels: ["Kelly then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1179 = {
		...
		labels: ["While ordering tea, Jacob noticed the barista’s new mustache.", "While ordering tea, Samuel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1242 = {
		type: "html-keyboard-response",
		stimulus: "<p> Anna was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Anna took a quarter from the tip jar.", "Before ordering cake, Henry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		...
		labels: ["Before ordering cake, Jean took a quarter from the tip jar.", "Before ordering cake, Katherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1277 = {
		...
		labels: ["Before ordering cake, Cheryl took a quarter from the tip jar.", "Before ordering cake, Ralph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1314 = {
		...
		labels: ["After ordering, Joe stole a salt shaker and left.", "After ordering, Kelly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1321 = {
		...
		labels: ["Gary then sat by the window, and read a book for hours.", "Tiffany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1347 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Robert waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Joshua noticed the barista’s new mustache.", "While ordering tea, Robert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		...
		labels: ["Amy then sat by the window, and read a book for hours.", "Nicole then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1384 = {
		...
		labels: ["Alice then sat by the window, and read a book for hours.", "Jesse then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
