...
// CODE BODY START
	...
	var q_38 = {
		...
		labels: ["Before ordering cake, Alexander took a quarter from the tip jar.", "Before ordering cake, Tyler took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_94 = {
		...
		labels: ["While ordering tea, Kelly noticed the barista’s new mustache.", "While ordering tea, Carol noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_103 = {
		...
		labels: ["After ordering, Brittany stole a salt shaker and left.", "After ordering, Lori stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_124 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_129 = {
		...
		labels: ["Before ordering cake, Anthony took a quarter from the tip jar.", "Before ordering cake, Kelly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_131 = {
		...
		labels: ["After ordering, Kelly stole a salt shaker and left.", "After ordering, George stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Thomas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_220 = {
		...
		labels: ["While ordering tea, Kathryn noticed the barista’s new mustache.", "While ordering tea, Brian noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["Before ordering cake, Arthur took a quarter from the tip jar.", "Before ordering cake, Alexander took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_229 = {
		...
		labels: ["After ordering, Arthur stole a salt shaker and left.", "After ordering, Sharon stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_241 = {
		...
		labels: ["While ordering tea, Matthew noticed the barista’s new mustache.", "While ordering tea, Julie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["Matthew then sat by the window, and read a book for hours.", "Alexis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Before ordering cake, Kimberly took a quarter from the tip jar.", "Before ordering cake, Bryan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["After ordering, Mark stole a salt shaker and left.", "After ordering, Willie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_283 = {
		...
		labels: ["Before ordering cake, William took a quarter from the tip jar.", "Before ordering cake, James took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, William took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["William then sat by the window, and read a book for hours.", "Joe then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_299 = {
		...
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Janet stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_306 = {
		...
		labels: ["After ordering, Benjamin stole a salt shaker and left.", "After ordering, Sandra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Diane noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Frances stole a salt shaker and left.", "After ordering, Diane stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["While ordering tea, Raymond noticed the barista’s new mustache.", "While ordering tea, Patricia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_362 = {
		...
		labels: ["Jordan then sat by the window, and read a book for hours.", "Ethan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_383 = {
		...
		labels: ["After ordering, Timothy stole a salt shaker and left.", "After ordering, Michelle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_395 = {
		...
		labels: ["While ordering tea, Christine noticed the barista’s new mustache.", "While ordering tea, Joan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		...
		labels: ["Before ordering cake, Danielle took a quarter from the tip jar.", "Before ordering cake, Donna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Harold waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Harold took a quarter from the tip jar.", "Before ordering cake, Arthur took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_493 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Roger waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Roger noticed the barista’s new mustache.", "While ordering tea, Joyce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Janet then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		...
		labels: ["Before ordering cake, Donald took a quarter from the tip jar.", "Before ordering cake, Alan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_530 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Karen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_535 = {
		...
		labels: ["While ordering tea, Maria noticed the barista’s new mustache.", "While ordering tea, Donna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["Before ordering cake, Lisa took a quarter from the tip jar.", "Before ordering cake, Carolyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_558 = {
		...
		labels: ["After ordering, Carolyn stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_591 = {
		...
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Doris took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_661 = {
		...
		labels: ["While ordering tea, Pamela noticed the barista’s new mustache.", "While ordering tea, Joe noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		...
		labels: ["Joe then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["While ordering tea, Ralph noticed the barista’s new mustache.", "While ordering tea, Janet noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_677 = {
		...
		labels: ["Ralph then sat by the window, and read a book for hours.", "Tiffany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_691 = {
		...
		labels: ["After ordering, Linda stole a salt shaker and left.", "After ordering, Timothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		...
		labels: ["Albert then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		...
		labels: ["While ordering tea, Tyler noticed the barista’s new mustache.", "While ordering tea, Larry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_710 = {
		...
		labels: ["Before ordering cake, Olivia took a quarter from the tip jar.", "Before ordering cake, Willie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_724 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Janet waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Janet took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_733 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Rose noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Samantha stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		...
		labels: ["Before ordering cake, Mary took a quarter from the tip jar.", "Before ordering cake, Virginia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["After ordering, Kelly stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		...
		labels: ["While ordering tea, Jonathan noticed the barista’s new mustache.", "While ordering tea, Anna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_817 = {
		...
		labels: ["Sean then sat by the window, and read a book for hours.", "Catherine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Margaret waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Nicholas noticed the barista’s new mustache.", "While ordering tea, Margaret noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["Randy then sat by the window, and read a book for hours.", "Michael then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		type: "html-keyboard-response",
		stimulus: "<p> Linda was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Linda noticed the barista’s new mustache.", "While ordering tea, Peter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_850 = {
		...
		labels: ["While ordering tea, Megan noticed the barista’s new mustache.", "While ordering tea, Doris noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["After ordering, Julie stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Teresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_871 = {
		type: "html-keyboard-response",
		stimulus: "<p> Alan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Alan noticed the barista’s new mustache.", "While ordering tea, Sharon noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_927 = {
		...
		labels: ["Before ordering cake, Pamela took a quarter from the tip jar.", "Before ordering cake, Austin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		...
		labels: ["After ordering, Austin stole a salt shaker and left.", "After ordering, Roy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_971 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Anna noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Anna then sat by the window, and read a book for hours.", "Austin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["While ordering tea, Logan noticed the barista’s new mustache.", "While ordering tea, Victoria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_997 = {
		...
		labels: ["While ordering tea, Lawrence noticed the barista’s new mustache.", "While ordering tea, Lauren noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1018 = {
		...
		labels: ["Before ordering cake, Nancy took a quarter from the tip jar.", "Before ordering cake, Billy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1027 = {
		...
		labels: ["Gabriel then sat by the window, and read a book for hours.", "David then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Maria waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Maria took a quarter from the tip jar.", "Before ordering cake, Kathleen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1067 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Austin waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Austin noticed the barista’s new mustache.", "While ordering tea, Barbara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Austin noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Austin then sat by the window, and read a book for hours.", "Michelle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1097 = {
		...
		labels: ["Dylan then sat by the window, and read a book for hours.", "Helen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		...
		labels: ["Sharon then sat by the window, and read a book for hours.", "Brandon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		...
		labels: ["Denise then sat by the window, and read a book for hours.", "Jordan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Stephanie took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Jeremy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Henry stole a salt shaker and left.", "After ordering, Willie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1188 = {
		...
		labels: ["Abigail then sat by the window, and read a book for hours.", "Virginia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1214 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jean was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Lauren took a quarter from the tip jar.", "Before ordering cake, Jean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1256 = {
		...
		labels: ["Before ordering cake, Maria took a quarter from the tip jar.", "Before ordering cake, Justin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Cheryl noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Cheryl stole a salt shaker and left.", "After ordering, Christine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Amanda took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Jeremy then sat by the window, and read a book for hours.", "Amanda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		type: "html-keyboard-response",
		stimulus: "<p> Nicholas was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Sandra noticed the barista’s new mustache.", "While ordering tea, Nicholas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1319 = {
		...
		labels: ["Before ordering cake, Ronald took a quarter from the tip jar.", "Before ordering cake, Abigail took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1321 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Abigail took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Zachary then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		type: "html-keyboard-response",
		stimulus: "<p> Mark was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Mark noticed the barista’s new mustache.", "While ordering tea, Patricia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1328 = {
		...
		labels: ["After ordering, Mark stole a salt shaker and left.", "After ordering, Judy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1340 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Melissa waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Theresa noticed the barista’s new mustache.", "While ordering tea, Melissa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		...
		labels: ["Christina then sat by the window, and read a book for hours.", "Catherine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1354 = {
		...
		labels: ["Before ordering cake, Douglas took a quarter from the tip jar.", "Before ordering cake, Ashley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1382 = {
		...
		labels: ["Before ordering cake, Samuel took a quarter from the tip jar.", "Before ordering cake, Christopher took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1389 = {
		type: "html-keyboard-response",
		stimulus: "<p> Danielle was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Janice took a quarter from the tip jar.", "Before ordering cake, Danielle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Sean waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Maria noticed the barista’s new mustache.", "While ordering tea, Sean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
