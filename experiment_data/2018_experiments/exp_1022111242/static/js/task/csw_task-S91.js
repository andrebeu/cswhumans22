...
// CODE BODY START
	...
	var q_17 = {
		...
		labels: ["While ordering tea, Brittany noticed the barista’s new mustache.", "While ordering tea, Alan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_24 = {
		...
		labels: ["Before ordering cake, Rebecca took a quarter from the tip jar.", "Before ordering cake, Patrick took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_31 = {
		...
		labels: ["While ordering tea, Nancy noticed the barista’s new mustache.", "While ordering tea, Terry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_47 = {
		...
		labels: ["After ordering, Joseph stole a salt shaker and left.", "After ordering, Joyce stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_52 = {
		...
		labels: ["While ordering tea, Danielle noticed the barista’s new mustache.", "While ordering tea, Donna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_54 = {
		...
		labels: ["Danielle then sat by the window, and read a book for hours.", "Steven then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["Before ordering cake, Deborah took a quarter from the tip jar.", "Before ordering cake, Jason took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["Before ordering cake, George took a quarter from the tip jar.", "Before ordering cake, Alexander took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_75 = {
		...
		labels: ["John then sat by the window, and read a book for hours.", "George then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_89 = {
		...
		labels: ["After ordering, Abigail stole a salt shaker and left.", "After ordering, Rebecca stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_108 = {
		...
		labels: ["Before ordering cake, Theresa took a quarter from the tip jar.", "Before ordering cake, Martha took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_110 = {
		...
		labels: ["Martha then sat by the window, and read a book for hours.", "Scott then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_117 = {
		...
		labels: ["Janet then sat by the window, and read a book for hours.", "Gregory then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["David then sat by the window, and read a book for hours.", "Stephen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_145 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Randy took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, John stole a salt shaker and left.", "After ordering, Randy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_192 = {
		...
		labels: ["Before ordering cake, Jessica took a quarter from the tip jar.", "Before ordering cake, Christine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_194 = {
		...
		labels: ["After ordering, Helen stole a salt shaker and left.", "After ordering, Jessica stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_229 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Before ordering cake, Kathleen took a quarter from the tip jar.", "Before ordering cake, Scott took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_264 = {
		...
		labels: ["Patricia then sat by the window, and read a book for hours.", "Betty then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_283 = {
		...
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_311 = {
		...
		labels: ["While ordering tea, Larry noticed the barista’s new mustache.", "While ordering tea, Raymond noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		...
		labels: ["John then sat by the window, and read a book for hours.", "Ashley then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Bobby stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["Wayne then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["Before ordering cake, Cheryl took a quarter from the tip jar.", "Before ordering cake, Russell took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_437 = {
		...
		labels: ["Before ordering cake, Michelle took a quarter from the tip jar.", "Before ordering cake, Paul took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_521 = {
		...
		labels: ["While ordering tea, Kenneth noticed the barista’s new mustache.", "While ordering tea, Michelle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["After ordering, Kenneth stole a salt shaker and left.", "After ordering, Jeffrey stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_537 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Billy noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Billy stole a salt shaker and left.", "After ordering, Lisa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		...
		labels: ["While ordering tea, Jordan noticed the barista’s new mustache.", "While ordering tea, Victoria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_558 = {
		...
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Victoria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["Jerry then sat by the window, and read a book for hours.", "Rose then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		...
		labels: ["Before ordering cake, Emma took a quarter from the tip jar.", "Before ordering cake, Logan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_607 = {
		...
		labels: ["After ordering, Emma stole a salt shaker and left.", "After ordering, Linda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["Before ordering cake, Henry took a quarter from the tip jar.", "Before ordering cake, Olivia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_661 = {
		...
		labels: ["Before ordering cake, Brandon took a quarter from the tip jar.", "Before ordering cake, Tiffany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		...
		labels: ["Madison then sat by the window, and read a book for hours.", "Tiffany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_691 = {
		...
		labels: ["Cheryl then sat by the window, and read a book for hours.", "Noah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_696 = {
		type: "html-keyboard-response",
		stimulus: "<p> Evelyn was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Evelyn noticed the barista’s new mustache.", "While ordering tea, Rose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_710 = {
		...
		labels: ["While ordering tea, Willie noticed the barista’s new mustache.", "While ordering tea, Tyler noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_719 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Sandra took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Sandra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_752 = {
		...
		labels: ["Before ordering cake, Jean took a quarter from the tip jar.", "Before ordering cake, Beverly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		...
		labels: ["After ordering, Thomas stole a salt shaker and left.", "After ordering, Brenda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_766 = {
		...
		labels: ["While ordering tea, Nancy noticed the barista’s new mustache.", "While ordering tea, Ashley noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Pamela waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_782 = {
		...
		labels: ["Willie then sat by the window, and read a book for hours.", "Pamela then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Harry waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Harry took a quarter from the tip jar.", "Before ordering cake, Douglas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		...
		labels: ["Before ordering cake, Julia took a quarter from the tip jar.", "Before ordering cake, Randy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		...
		labels: ["Before ordering cake, Lori took a quarter from the tip jar.", "Before ordering cake, Kelly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_850 = {
		...
		labels: ["While ordering tea, Donald noticed the barista’s new mustache.", "While ordering tea, Jane noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Harry waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Harry noticed the barista’s new mustache.", "While ordering tea, Carol noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["Jacqueline then sat by the window, and read a book for hours.", "Harry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["After ordering, Steven stole a salt shaker and left.", "After ordering, Debra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		...
		labels: ["Before ordering cake, Denise took a quarter from the tip jar.", "Before ordering cake, Eugene took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_894 = {
		...
		labels: ["After ordering, Teresa stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_901 = {
		...
		labels: ["Margaret then sat by the window, and read a book for hours.", "Diane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_920 = {
		...
		labels: ["Before ordering cake, Gerald took a quarter from the tip jar.", "Before ordering cake, Amber took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_922 = {
		...
		labels: ["Timothy then sat by the window, and read a book for hours.", "Gerald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_955 = {
		...
		labels: ["While ordering tea, Kevin noticed the barista’s new mustache.", "While ordering tea, Frances noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		...
		labels: ["While ordering tea, Christina noticed the barista’s new mustache.", "While ordering tea, Alice noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1004 = {
		...
		labels: ["Before ordering cake, David took a quarter from the tip jar.", "Before ordering cake, Andrea took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["After ordering, Debra stole a salt shaker and left.", "After ordering, Jose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1053 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Abigail waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Abigail took a quarter from the tip jar.", "Before ordering cake, Judy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1060 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jerry was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Amanda noticed the barista’s new mustache.", "While ordering tea, Jerry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1069 = {
		...
		labels: ["Victoria then sat by the window, and read a book for hours.", "Eric then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1074 = {
		...
		labels: ["While ordering tea, Bryan noticed the barista’s new mustache.", "While ordering tea, Gregory noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1081 = {
		type: "html-keyboard-response",
		stimulus: "<p> Heather was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Diana noticed the barista’s new mustache.", "While ordering tea, Heather noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Willie took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Willie then sat by the window, and read a book for hours.", "Jonathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1123 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Dennis waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Dennis noticed the barista’s new mustache.", "While ordering tea, Philip noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Tyler noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Marilyn then sat by the window, and read a book for hours.", "Tyler then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1137 = {
		...
		labels: ["While ordering tea, Jennifer noticed the barista’s new mustache.", "While ordering tea, Henry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1151 = {
		...
		labels: ["Before ordering cake, Jeremy took a quarter from the tip jar.", "Before ordering cake, Aaron took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1153 = {
		...
		labels: ["After ordering, Aaron stole a salt shaker and left.", "After ordering, Douglas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1160 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Gary noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Ann then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1165 = {
		...
		labels: ["While ordering tea, Shirley noticed the barista’s new mustache.", "While ordering tea, Nancy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Madison stole a salt shaker and left.", "After ordering, Jeremy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1179 = {
		...
		labels: ["While ordering tea, Natalie noticed the barista’s new mustache.", "While ordering tea, Kyle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1186 = {
		...
		labels: ["While ordering tea, Emma noticed the barista’s new mustache.", "While ordering tea, Elizabeth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1193 = {
		...
		labels: ["Before ordering cake, Gerald took a quarter from the tip jar.", "Before ordering cake, Matthew took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1200 = {
		...
		labels: ["Before ordering cake, Denise took a quarter from the tip jar.", "Before ordering cake, Evelyn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1228 = {
		...
		labels: ["Before ordering cake, Judith took a quarter from the tip jar.", "Before ordering cake, Cynthia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1249 = {
		...
		labels: ["Before ordering cake, Louis took a quarter from the tip jar.", "Before ordering cake, Ashley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1272 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Peter took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, John stole a salt shaker and left.", "After ordering, Peter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		type: "html-keyboard-response",
		stimulus: "<p> Philip was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Amy took a quarter from the tip jar.", "Before ordering cake, Philip took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1286 = {
		...
		labels: ["After ordering, Brittany stole a salt shaker and left.", "After ordering, Philip stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Harry noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Barbara then sat by the window, and read a book for hours.", "Harry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		...
		labels: ["While ordering tea, Carl noticed the barista’s new mustache.", "While ordering tea, Madison noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1354 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Daniel waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Daniel took a quarter from the tip jar.", "Before ordering cake, Dylan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1363 = {
		...
		labels: ["Anthony then sat by the window, and read a book for hours.", "Ronald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1389 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jane waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jane took a quarter from the tip jar.", "Before ordering cake, Kathryn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
