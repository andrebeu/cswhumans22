...
// CODE BODY START
	...
	var q_5 = {
		...
		labels: ["After ordering, Gary stole a salt shaker and left.", "After ordering, Gerald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_33 = {
		...
		labels: ["After ordering, David stole a salt shaker and left.", "After ordering, Anthony stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_52 = {
		...
		labels: ["Before ordering cake, Brandon took a quarter from the tip jar.", "Before ordering cake, Jessica took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Stephen stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_75 = {
		...
		labels: ["Bruce then sat by the window, and read a book for hours.", "Carol then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_82 = {
		...
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Julie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_87 = {
		...
		labels: ["While ordering tea, Andrew noticed the barista’s new mustache.", "While ordering tea, Jordan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_101 = {
		...
		labels: ["Before ordering cake, Lisa took a quarter from the tip jar.", "Before ordering cake, Shirley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_131 = {
		...
		labels: ["Nicole then sat by the window, and read a book for hours.", "Michael then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_150 = {
		...
		labels: ["While ordering tea, Roy noticed the barista’s new mustache.", "While ordering tea, Philip noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_185 = {
		...
		labels: ["Before ordering cake, Jose took a quarter from the tip jar.", "Before ordering cake, Jacqueline took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["Andrea then sat by the window, and read a book for hours.", "Willie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_213 = {
		...
		labels: ["Before ordering cake, Justin took a quarter from the tip jar.", "Before ordering cake, Ronald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["Before ordering cake, Jason took a quarter from the tip jar.", "Before ordering cake, Rose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_241 = {
		...
		labels: ["While ordering tea, Dylan noticed the barista’s new mustache.", "While ordering tea, Marilyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_255 = {
		...
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Ashley took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_262 = {
		...
		labels: ["While ordering tea, Bobby noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Judith took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jack stole a salt shaker and left.", "After ordering, Judith stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_292 = {
		...
		labels: ["After ordering, Carolyn stole a salt shaker and left.", "After ordering, Alice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_299 = {
		...
		labels: ["Jacqueline then sat by the window, and read a book for hours.", "Albert then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["While ordering tea, Carolyn noticed the barista’s new mustache.", "While ordering tea, Gary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_334 = {
		...
		labels: ["Carolyn then sat by the window, and read a book for hours.", "Betty then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Sharon then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["While ordering tea, Olivia noticed the barista’s new mustache.", "While ordering tea, Philip noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_402 = {
		...
		labels: ["Before ordering cake, Catherine took a quarter from the tip jar.", "Before ordering cake, Sean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_425 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Raymond took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Gregory stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_474 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Judith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_481 = {
		...
		labels: ["After ordering, Brenda stole a salt shaker and left.", "After ordering, Jean stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		...
		labels: ["Margaret then sat by the window, and read a book for hours.", "Harold then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["After ordering, Arthur stole a salt shaker and left.", "After ordering, Emily stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		type: "html-keyboard-response",
		stimulus: "<p> Laura was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Marie noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		type: "html-keyboard-response",
		stimulus: "<p> David was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, David took a quarter from the tip jar.", "Before ordering cake, Linda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, David took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, David stole a salt shaker and left.", "After ordering, Julie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_570 = {
		...
		labels: ["While ordering tea, Gloria noticed the barista’s new mustache.", "While ordering tea, Timothy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		...
		labels: ["Before ordering cake, Gerald took a quarter from the tip jar.", "Before ordering cake, Edward took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jerry was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Brittany took a quarter from the tip jar.", "Before ordering cake, Jerry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Bruce waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Timothy noticed the barista’s new mustache.", "While ordering tea, Bruce noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		...
		labels: ["After ordering, Sandra stole a salt shaker and left.", "After ordering, Donna stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_670 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Brian then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_682 = {
		type: "html-keyboard-response",
		stimulus: "<p> Nathan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Julia noticed the barista’s new mustache.", "While ordering tea, Nathan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		...
		labels: ["Gregory then sat by the window, and read a book for hours.", "Joyce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_726 = {
		...
		labels: ["Anna then sat by the window, and read a book for hours.", "Terry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["Before ordering cake, Bryan took a quarter from the tip jar.", "Before ordering cake, Justin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_745 = {
		...
		labels: ["While ordering tea, Harry noticed the barista’s new mustache.", "While ordering tea, Christine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		...
		labels: ["Ralph then sat by the window, and read a book for hours.", "Harry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_752 = {
		...
		labels: ["Before ordering cake, Joseph took a quarter from the tip jar.", "Before ordering cake, Alexander took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_759 = {
		...
		labels: ["While ordering tea, Ralph noticed the barista’s new mustache.", "While ordering tea, Joshua noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_782 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Bobby took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Billy then sat by the window, and read a book for hours.", "Bobby then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		...
		labels: ["After ordering, Noah stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["Andrea then sat by the window, and read a book for hours.", "Keith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		...
		labels: ["Before ordering cake, Megan took a quarter from the tip jar.", "Before ordering cake, Michelle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_824 = {
		...
		labels: ["Michelle then sat by the window, and read a book for hours.", "Janice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["After ordering, Alexis stole a salt shaker and left.", "After ordering, Matthew stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["Maria then sat by the window, and read a book for hours.", "Kathryn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_878 = {
		...
		labels: ["While ordering tea, Beverly noticed the barista’s new mustache.", "While ordering tea, Steven noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_906 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Philip waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Philip noticed the barista’s new mustache.", "While ordering tea, Juan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_908 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Philip noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Philip then sat by the window, and read a book for hours.", "Brenda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_920 = {
		...
		labels: ["Before ordering cake, Christopher took a quarter from the tip jar.", "Before ordering cake, Jeremy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_936 = {
		...
		labels: ["Dennis then sat by the window, and read a book for hours.", "Keith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		...
		labels: ["Before ordering cake, Sharon took a quarter from the tip jar.", "Before ordering cake, Dorothy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_957 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Doris stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		...
		labels: ["While ordering tea, Emma noticed the barista’s new mustache.", "While ordering tea, Judith noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["While ordering tea, Charles noticed the barista’s new mustache.", "While ordering tea, Randy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_983 = {
		...
		labels: ["Before ordering cake, Albert took a quarter from the tip jar.", "Before ordering cake, Frances took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		...
		labels: ["While ordering tea, Sara noticed the barista’s new mustache.", "While ordering tea, Jordan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1006 = {
		...
		labels: ["Aaron then sat by the window, and read a book for hours.", "Randy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1018 = {
		...
		labels: ["While ordering tea, Nicole noticed the barista’s new mustache.", "While ordering tea, Roger noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		...
		labels: ["Roger then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["While ordering tea, Joe noticed the barista’s new mustache.", "While ordering tea, Walter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		...
		labels: ["Michelle then sat by the window, and read a book for hours.", "Benjamin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1067 = {
		...
		labels: ["While ordering tea, Adam noticed the barista’s new mustache.", "While ordering tea, Lori noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1083 = {
		...
		labels: ["After ordering, Jesse stole a salt shaker and left.", "After ordering, Steven stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		...
		labels: ["Before ordering cake, Henry took a quarter from the tip jar.", "Before ordering cake, Gary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1097 = {
		...
		labels: ["After ordering, Teresa stole a salt shaker and left.", "After ordering, Karen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1123 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Anna waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Willie noticed the barista’s new mustache.", "While ordering tea, Anna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1130 = {
		...
		labels: ["While ordering tea, Scott noticed the barista’s new mustache.", "While ordering tea, Brittany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Scott then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1153 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Donald noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Natalie then sat by the window, and read a book for hours.", "Donald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1160 = {
		...
		labels: ["After ordering, Richard stole a salt shaker and left.", "After ordering, Wayne stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Abigail stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1179 = {
		...
		labels: ["While ordering tea, Gerald noticed the barista’s new mustache.", "While ordering tea, Jesse noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1181 = {
		...
		labels: ["Jesse then sat by the window, and read a book for hours.", "Kyle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1202 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Thomas took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Jessica then sat by the window, and read a book for hours.", "Thomas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Eugene noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Helen stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1223 = {
		...
		labels: ["Catherine then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1244 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Sean took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Ronald then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		...
		labels: ["While ordering tea, Amanda noticed the barista’s new mustache.", "While ordering tea, Bobby noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Melissa waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jonathan noticed the barista’s new mustache.", "While ordering tea, Melissa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		...
		labels: ["While ordering tea, Christian noticed the barista’s new mustache.", "While ordering tea, Steven noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Andrea took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Melissa stole a salt shaker and left.", "After ordering, Andrea stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1321 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Richard noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Dennis then sat by the window, and read a book for hours.", "Richard then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1333 = {
		...
		labels: ["While ordering tea, Julie noticed the barista’s new mustache.", "While ordering tea, Maria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1335 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Maria noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Rebecca stole a salt shaker and left.", "After ordering, Maria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1340 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Harold waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jeremy took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1361 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Andrea waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Andrea took a quarter from the tip jar.", "Before ordering cake, Jacob took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1370 = {
		...
		labels: ["Jessica then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		...
		labels: ["Larry then sat by the window, and read a book for hours.", "Mark then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
