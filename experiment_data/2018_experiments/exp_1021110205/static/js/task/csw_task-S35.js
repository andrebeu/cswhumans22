...
// CODE BODY START
	...
	var q_45 = {
		...
		labels: ["While ordering tea, Jean noticed the barista’s new mustache.", "While ordering tea, Martha noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["While ordering tea, Hannah noticed the barista’s new mustache.", "While ordering tea, Roger noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_66 = {
		...
		labels: ["Before ordering cake, Diana took a quarter from the tip jar.", "Before ordering cake, Steven took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Diana stole a salt shaker and left.", "After ordering, Thomas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Hannah waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Robert noticed the barista’s new mustache.", "While ordering tea, Hannah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["While ordering tea, Natalie noticed the barista’s new mustache.", "While ordering tea, Barbara noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["Danielle then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_192 = {
		...
		labels: ["While ordering tea, Karen noticed the barista’s new mustache.", "While ordering tea, Kevin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["James then sat by the window, and read a book for hours.", "Raymond then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["While ordering tea, Donna noticed the barista’s new mustache.", "While ordering tea, Patrick noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_229 = {
		...
		labels: ["After ordering, Ann stole a salt shaker and left.", "After ordering, Donna stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_241 = {
		...
		labels: ["Before ordering cake, Roger took a quarter from the tip jar.", "Before ordering cake, Gregory took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_262 = {
		...
		labels: ["While ordering tea, Joyce noticed the barista’s new mustache.", "While ordering tea, Olivia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["After ordering, Lisa stole a salt shaker and left.", "After ordering, Joyce stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_290 = {
		...
		labels: ["While ordering tea, Amber noticed the barista’s new mustache.", "While ordering tea, Jordan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["While ordering tea, Alexis noticed the barista’s new mustache.", "While ordering tea, Jeffrey noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["While ordering tea, Janet noticed the barista’s new mustache.", "While ordering tea, Teresa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_341 = {
		...
		labels: ["Betty then sat by the window, and read a book for hours.", "Andrea then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_367 = {
		...
		labels: ["Before ordering cake, Kathryn took a quarter from the tip jar.", "Before ordering cake, Robert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["After ordering, Virginia stole a salt shaker and left.", "After ordering, Robert stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_390 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Sharon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		...
		labels: ["While ordering tea, Joe noticed the barista’s new mustache.", "While ordering tea, Jonathan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_500 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Brittany waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kevin took a quarter from the tip jar.", "Before ordering cake, Brittany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Brittany took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Brittany then sat by the window, and read a book for hours.", "Karen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["Alexis then sat by the window, and read a book for hours.", "Judith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		...
		labels: ["While ordering tea, Jacob noticed the barista’s new mustache.", "While ordering tea, Russell noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["Before ordering cake, Steven took a quarter from the tip jar.", "Before ordering cake, Cheryl took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["Steven then sat by the window, and read a book for hours.", "Mark then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["Before ordering cake, Madison took a quarter from the tip jar.", "Before ordering cake, Kevin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_572 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Ryan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Ryan stole a salt shaker and left.", "After ordering, Brian stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_584 = {
		...
		labels: ["Before ordering cake, Donna took a quarter from the tip jar.", "Before ordering cake, Christine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["Before ordering cake, Mary took a quarter from the tip jar.", "Before ordering cake, Walter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		...
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Betty stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_649 = {
		...
		labels: ["After ordering, Keith stole a salt shaker and left.", "After ordering, Victoria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_675 = {
		...
		labels: ["Before ordering cake, Edward took a quarter from the tip jar.", "Before ordering cake, Emily took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["While ordering tea, Lauren noticed the barista’s new mustache.", "While ordering tea, Brittany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_766 = {
		...
		labels: ["While ordering tea, Austin noticed the barista’s new mustache.", "While ordering tea, Gary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		...
		labels: ["After ordering, Rachel stole a salt shaker and left.", "After ordering, Austin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		...
		labels: ["After ordering, Rose stole a salt shaker and left.", "After ordering, Peter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		...
		labels: ["Before ordering cake, Jack took a quarter from the tip jar.", "Before ordering cake, Danielle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_850 = {
		type: "html-keyboard-response",
		stimulus: "<p> Brittany was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Sandra took a quarter from the tip jar.", "Before ordering cake, Brittany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["After ordering, Bruce stole a salt shaker and left.", "After ordering, Joan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["Before ordering cake, Charles took a quarter from the tip jar.", "Before ordering cake, Richard took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_899 = {
		...
		labels: ["Before ordering cake, Ronald took a quarter from the tip jar.", "Before ordering cake, James took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_901 = {
		...
		labels: ["After ordering, Ronald stole a salt shaker and left.", "After ordering, Aaron stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		...
		labels: ["After ordering, Bobby stole a salt shaker and left.", "After ordering, Natalie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Natalie waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Mark noticed the barista’s new mustache.", "While ordering tea, Natalie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1032 = {
		...
		labels: ["Before ordering cake, Evelyn took a quarter from the tip jar.", "Before ordering cake, Judith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["Roy then sat by the window, and read a book for hours.", "Diane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1053 = {
		type: "html-keyboard-response",
		stimulus: "<p> Mark was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Donna noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Nicole noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Nicole stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1104 = {
		...
		labels: ["After ordering, Charles stole a salt shaker and left.", "After ordering, Kathleen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1118 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Gabriel took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Sharon then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1125 = {
		...
		labels: ["Ann then sat by the window, and read a book for hours.", "Bobby then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Logan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Jessica then sat by the window, and read a book for hours.", "Logan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1137 = {
		type: "html-keyboard-response",
		stimulus: "<p> Adam was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Adam took a quarter from the tip jar.", "Before ordering cake, Theresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Adam took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Adam stole a salt shaker and left.", "After ordering, Nancy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1144 = {
		...
		labels: ["Before ordering cake, Sharon took a quarter from the tip jar.", "Before ordering cake, Vincent took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1186 = {
		...
		labels: ["Before ordering cake, Alan took a quarter from the tip jar.", "Before ordering cake, Julie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1214 = {
		...
		labels: ["While ordering tea, Heather noticed the barista’s new mustache.", "While ordering tea, Walter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1256 = {
		...
		labels: ["Before ordering cake, Shirley took a quarter from the tip jar.", "Before ordering cake, Elizabeth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Tiffany noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Tiffany stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Austin noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Austin stole a salt shaker and left.", "After ordering, Margaret stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		...
		labels: ["While ordering tea, Kyle noticed the barista’s new mustache.", "While ordering tea, Kelly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1305 = {
		type: "html-keyboard-response",
		stimulus: "<p> Tiffany was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Benjamin noticed the barista’s new mustache.", "While ordering tea, Tiffany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Tiffany noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Tiffany stole a salt shaker and left.", "After ordering, Arthur stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1321 = {
		...
		labels: ["After ordering, Madison stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1349 = {
		...
		labels: ["Billy then sat by the window, and read a book for hours.", "Helen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1354 = {
		...
		labels: ["Before ordering cake, Sarah took a quarter from the tip jar.", "Before ordering cake, Terry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1391 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Andrea stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		...
		labels: ["Before ordering cake, Alice took a quarter from the tip jar.", "Before ordering cake, Christina took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
