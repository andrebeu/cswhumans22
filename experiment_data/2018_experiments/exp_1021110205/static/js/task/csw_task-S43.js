...
// CODE BODY START
	...
	var q_3 = {
		...
		labels: ["Before ordering cake, Eric took a quarter from the tip jar.", "Before ordering cake, Henry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
	...
	var q_24 = {
		...
		labels: ["While ordering tea, Stephanie noticed the barista’s new mustache.", "While ordering tea, Julia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		...
		labels: ["While ordering tea, Alexander noticed the barista’s new mustache.", "While ordering tea, Jennifer noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["While ordering tea, Samuel noticed the barista’s new mustache.", "While ordering tea, Gabriel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_96 = {
		...
		labels: ["After ordering, Carol stole a salt shaker and left.", "After ordering, Kathryn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["While ordering tea, Christopher noticed the barista’s new mustache.", "While ordering tea, Rachel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["After ordering, Thomas stole a salt shaker and left.", "After ordering, Joe stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_164 = {
		...
		labels: ["Before ordering cake, Benjamin took a quarter from the tip jar.", "Before ordering cake, Alice took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_180 = {
		...
		labels: ["Jean then sat by the window, and read a book for hours.", "Karen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_199 = {
		...
		labels: ["Before ordering cake, Scott took a quarter from the tip jar.", "Before ordering cake, Gerald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jennifer noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Jennifer then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_236 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["Ronald then sat by the window, and read a book for hours.", "Lori then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_255 = {
		...
		labels: ["While ordering tea, Ralph noticed the barista’s new mustache.", "While ordering tea, Judith noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		...
		labels: ["After ordering, Jane stole a salt shaker and left.", "After ordering, Benjamin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_318 = {
		type: "html-keyboard-response",
		stimulus: "<p> Diane was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Diane noticed the barista’s new mustache.", "While ordering tea, George noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_334 = {
		...
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Barbara noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Barbara stole a salt shaker and left.", "After ordering, Patrick stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_374 = {
		...
		labels: ["While ordering tea, Carolyn noticed the barista’s new mustache.", "While ordering tea, Jerry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		...
		labels: ["Before ordering cake, Brenda took a quarter from the tip jar.", "Before ordering cake, Gary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_411 = {
		...
		labels: ["Brenda then sat by the window, and read a book for hours.", "Gregory then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_432 = {
		...
		labels: ["Cheryl then sat by the window, and read a book for hours.", "Brenda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_453 = {
		...
		labels: ["Joshua then sat by the window, and read a book for hours.", "Deborah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_460 = {
		...
		labels: ["After ordering, Nancy stole a salt shaker and left.", "After ordering, Jerry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_472 = {
		...
		labels: ["While ordering tea, Philip noticed the barista’s new mustache.", "While ordering tea, Kathleen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_530 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Andrea then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["After ordering, Jacob stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_551 = {
		...
		labels: ["After ordering, Olivia stole a salt shaker and left.", "After ordering, Jack stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["After ordering, Billy stole a salt shaker and left.", "After ordering, Kyle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Alan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["While ordering tea, Carolyn noticed the barista’s new mustache.", "While ordering tea, Rachel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_626 = {
		type: "html-keyboard-response",
		stimulus: "<p> Christina was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Louis noticed the barista’s new mustache.", "While ordering tea, Christina noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_640 = {
		...
		labels: ["Before ordering cake, Jonathan took a quarter from the tip jar.", "Before ordering cake, Tiffany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_675 = {
		...
		labels: ["While ordering tea, Jonathan noticed the barista’s new mustache.", "While ordering tea, Sharon noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_689 = {
		...
		labels: ["While ordering tea, Shirley noticed the barista’s new mustache.", "While ordering tea, Alan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_710 = {
		...
		labels: ["Before ordering cake, Pamela took a quarter from the tip jar.", "Before ordering cake, Frances took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_717 = {
		...
		labels: ["While ordering tea, Wayne noticed the barista’s new mustache.", "While ordering tea, Kathryn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_719 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Kathryn noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Katherine then sat by the window, and read a book for hours.", "Kathryn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["While ordering tea, Zachary noticed the barista’s new mustache.", "While ordering tea, Rebecca noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		...
		labels: ["After ordering, Andrew stole a salt shaker and left.", "After ordering, Grace stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		type: "html-keyboard-response",
		stimulus: "<p> Victoria was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Victoria took a quarter from the tip jar.", "Before ordering cake, Christine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_845 = {
		...
		labels: ["Sarah then sat by the window, and read a book for hours.", "Christian then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_850 = {
		...
		labels: ["Before ordering cake, Jean took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_908 = {
		...
		labels: ["Benjamin then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_920 = {
		...
		labels: ["While ordering tea, Brenda noticed the barista’s new mustache.", "While ordering tea, Marilyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		...
		labels: ["Before ordering cake, Juan took a quarter from the tip jar.", "Before ordering cake, Robert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_950 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Nathan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jeremy stole a salt shaker and left.", "After ordering, Nathan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_955 = {
		type: "html-keyboard-response",
		stimulus: "<p> Cynthia was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Rebecca noticed the barista’s new mustache.", "While ordering tea, Cynthia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		...
		labels: ["Before ordering cake, Tiffany took a quarter from the tip jar.", "Before ordering cake, Billy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_971 = {
		...
		labels: ["Billy then sat by the window, and read a book for hours.", "Timothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["Before ordering cake, Marilyn took a quarter from the tip jar.", "Before ordering cake, Danielle took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_978 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Danielle took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Christine then sat by the window, and read a book for hours.", "Danielle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_992 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Vincent took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jane stole a salt shaker and left.", "After ordering, Vincent stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["After ordering, Marie stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1006 = {
		...
		labels: ["Russell then sat by the window, and read a book for hours.", "Ashley then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1095 = {
		...
		labels: ["While ordering tea, Daniel noticed the barista’s new mustache.", "While ordering tea, Gerald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1104 = {
		...
		labels: ["After ordering, Dennis stole a salt shaker and left.", "After ordering, Bobby stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1123 = {
		...
		labels: ["Before ordering cake, Ashley took a quarter from the tip jar.", "Before ordering cake, Anthony took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		...
		labels: ["Jacqueline then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1188 = {
		...
		labels: ["John then sat by the window, and read a book for hours.", "Lawrence then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1195 = {
		...
		labels: ["Theresa then sat by the window, and read a book for hours.", "Julia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1214 = {
		...
		labels: ["Before ordering cake, Bobby took a quarter from the tip jar.", "Before ordering cake, Katherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1235 = {
		...
		labels: ["While ordering tea, Debra noticed the barista’s new mustache.", "While ordering tea, Vincent noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1244 = {
		...
		labels: ["Nicholas then sat by the window, and read a book for hours.", "Larry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1251 = {
		...
		labels: ["Cheryl then sat by the window, and read a book for hours.", "Edward then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Julia waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, John noticed the barista’s new mustache.", "While ordering tea, Julia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1305 = {
		...
		labels: ["While ordering tea, Betty noticed the barista’s new mustache.", "While ordering tea, Jeffrey noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1319 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Benjamin waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Benjamin noticed the barista’s new mustache.", "While ordering tea, Beverly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Helen noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Helen then sat by the window, and read a book for hours.", "Julie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		type: "html-keyboard-response",
		stimulus: "<p> Christina was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Andrea took a quarter from the tip jar.", "Before ordering cake, Christina took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Christina took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Christina stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
