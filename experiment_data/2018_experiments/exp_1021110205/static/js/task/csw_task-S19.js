...
// CODE BODY START
	...
	var q_3 = {
		...
		labels: ["While ordering tea, Bobby noticed the barista’s new mustache.", "While ordering tea, Jordan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
	...
	var q_33 = {
		...
		labels: ["After ordering, Maria stole a salt shaker and left.", "After ordering, David stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		...
		labels: ["Before ordering cake, Daniel took a quarter from the tip jar.", "Before ordering cake, David took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_89 = {
		...
		labels: ["Nicholas then sat by the window, and read a book for hours.", "Natalie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_101 = {
		type: "html-keyboard-response",
		stimulus: "<p> Rose was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Cynthia noticed the barista’s new mustache.", "While ordering tea, Rose noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_110 = {
		...
		labels: ["Kelly then sat by the window, and read a book for hours.", "Margaret then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["Before ordering cake, Joan took a quarter from the tip jar.", "Before ordering cake, Nicholas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_117 = {
		...
		labels: ["Sean then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["Before ordering cake, Lori took a quarter from the tip jar.", "Before ordering cake, Donald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_124 = {
		...
		labels: ["Alexis then sat by the window, and read a book for hours.", "Lori then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_131 = {
		...
		labels: ["After ordering, Amanda stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_136 = {
		...
		labels: ["Before ordering cake, Eric took a quarter from the tip jar.", "Before ordering cake, Sandra took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_150 = {
		...
		labels: ["Before ordering cake, Teresa took a quarter from the tip jar.", "Before ordering cake, Jacob took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_171 = {
		...
		labels: ["While ordering tea, Gregory noticed the barista’s new mustache.", "While ordering tea, Jonathan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_185 = {
		...
		labels: ["Before ordering cake, Noah took a quarter from the tip jar.", "Before ordering cake, Arthur took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_199 = {
		...
		labels: ["Before ordering cake, Timothy took a quarter from the tip jar.", "Before ordering cake, Anna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["Gary then sat by the window, and read a book for hours.", "Jessica then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_213 = {
		...
		labels: ["While ordering tea, Jeremy noticed the barista’s new mustache.", "While ordering tea, Deborah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_222 = {
		...
		labels: ["Christian then sat by the window, and read a book for hours.", "Billy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Before ordering cake, Julie took a quarter from the tip jar.", "Before ordering cake, Kathryn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["After ordering, Anthony stole a salt shaker and left.", "After ordering, Ethan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["Before ordering cake, Douglas took a quarter from the tip jar.", "Before ordering cake, Richard took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_283 = {
		...
		labels: ["While ordering tea, Christina noticed the barista’s new mustache.", "While ordering tea, Patrick noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_297 = {
		...
		labels: ["While ordering tea, Jane noticed the barista’s new mustache.", "While ordering tea, Michelle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_304 = {
		...
		labels: ["While ordering tea, Eric noticed the barista’s new mustache.", "While ordering tea, Theresa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_311 = {
		...
		labels: ["While ordering tea, Laura noticed the barista’s new mustache.", "While ordering tea, Frances noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_325 = {
		...
		labels: ["Before ordering cake, Jacqueline took a quarter from the tip jar.", "Before ordering cake, Vincent took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_327 = {
		...
		labels: ["Vincent then sat by the window, and read a book for hours.", "Dylan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_346 = {
		...
		labels: ["While ordering tea, Walter noticed the barista’s new mustache.", "While ordering tea, Danielle noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		type: "html-keyboard-response",
		stimulus: "<p> Kathryn was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Kathryn noticed the barista’s new mustache.", "While ordering tea, Ryan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["Emily then sat by the window, and read a book for hours.", "Heather then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_397 = {
		...
		labels: ["Scott then sat by the window, and read a book for hours.", "Zachary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_451 = {
		...
		labels: ["Before ordering cake, Tyler took a quarter from the tip jar.", "Before ordering cake, Stephen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["While ordering tea, Amy noticed the barista’s new mustache.", "While ordering tea, Grace noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_460 = {
		...
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Grace then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_465 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Christian waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Christian noticed the barista’s new mustache.", "While ordering tea, Ryan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_486 = {
		...
		labels: ["While ordering tea, Louis noticed the barista’s new mustache.", "While ordering tea, Philip noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_495 = {
		...
		labels: ["Ashley then sat by the window, and read a book for hours.", "Michelle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		...
		labels: ["While ordering tea, Randy noticed the barista’s new mustache.", "While ordering tea, Jesse noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_516 = {
		...
		labels: ["Edward then sat by the window, and read a book for hours.", "Wayne then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		...
		labels: ["Before ordering cake, Steven took a quarter from the tip jar.", "Before ordering cake, Brenda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Albert waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Albert noticed the barista’s new mustache.", "While ordering tea, Jeremy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		type: "html-keyboard-response",
		stimulus: "<p> Frances was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Russell noticed the barista’s new mustache.", "While ordering tea, Frances noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_584 = {
		type: "html-keyboard-response",
		stimulus: "<p> Richard was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Alice noticed the barista’s new mustache.", "While ordering tea, Richard noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_586 = {
		...
		labels: ["After ordering, Timothy stole a salt shaker and left.", "After ordering, Richard stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_593 = {
		...
		labels: ["After ordering, Mark stole a salt shaker and left.", "After ordering, Arthur stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		type: "html-keyboard-response",
		stimulus: "<p> Roy was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Daniel noticed the barista’s new mustache.", "While ordering tea, Roy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Benjamin stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_621 = {
		...
		labels: ["After ordering, Victoria stole a salt shaker and left.", "After ordering, Margaret stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		...
		labels: ["Judy then sat by the window, and read a book for hours.", "Janet then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		...
		labels: ["Frank then sat by the window, and read a book for hours.", "Philip then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["While ordering tea, Andrea noticed the barista’s new mustache.", "While ordering tea, Jerry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_682 = {
		...
		labels: ["Before ordering cake, Mary took a quarter from the tip jar.", "Before ordering cake, Jack took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_684 = {
		...
		labels: ["Joe then sat by the window, and read a book for hours.", "Mary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_696 = {
		...
		labels: ["Before ordering cake, Louis took a quarter from the tip jar.", "Before ordering cake, Marie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_710 = {
		...
		labels: ["While ordering tea, Kevin noticed the barista’s new mustache.", "While ordering tea, Michael noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_717 = {
		...
		labels: ["While ordering tea, Angela noticed the barista’s new mustache.", "While ordering tea, Joe noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_724 = {
		...
		labels: ["While ordering tea, Megan noticed the barista’s new mustache.", "While ordering tea, Gerald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_731 = {
		...
		labels: ["While ordering tea, Shirley noticed the barista’s new mustache.", "While ordering tea, Paul noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_745 = {
		...
		labels: ["Before ordering cake, Shirley took a quarter from the tip jar.", "Before ordering cake, Debra took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["Before ordering cake, Eugene took a quarter from the tip jar.", "Before ordering cake, Tiffany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Andrea noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Eugene then sat by the window, and read a book for hours.", "Andrea then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		...
		labels: ["Before ordering cake, Janice took a quarter from the tip jar.", "Before ordering cake, Brian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_817 = {
		...
		labels: ["After ordering, Zachary stole a salt shaker and left.", "After ordering, Harry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		...
		labels: ["After ordering, Andrew stole a salt shaker and left.", "After ordering, Samuel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		...
		labels: ["While ordering tea, Melissa noticed the barista’s new mustache.", "While ordering tea, Tyler noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_845 = {
		...
		labels: ["After ordering, Patrick stole a salt shaker and left.", "After ordering, Melissa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_852 = {
		...
		labels: ["Shirley then sat by the window, and read a book for hours.", "Joe then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_873 = {
		...
		labels: ["After ordering, Amber stole a salt shaker and left.", "After ordering, Samantha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_887 = {
		...
		labels: ["Kathleen then sat by the window, and read a book for hours.", "Kelly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_894 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jeremy took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Joe then sat by the window, and read a book for hours.", "Jeremy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_899 = {
		...
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Jack noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_901 = {
		...
		labels: ["After ordering, Jose stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_915 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Susan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Patrick stole a salt shaker and left.", "After ordering, Susan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_948 = {
		...
		labels: ["While ordering tea, Debra noticed the barista’s new mustache.", "While ordering tea, Steven noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_955 = {
		type: "html-keyboard-response",
		stimulus: "<p> Terry was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Terry noticed the barista’s new mustache.", "While ordering tea, Raymond noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_971 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Harry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, Kelly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_992 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Janice took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Gregory stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_997 = {
		...
		labels: ["While ordering tea, Michelle noticed the barista’s new mustache.", "While ordering tea, Harold noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1018 = {
		...
		labels: ["While ordering tea, Theresa noticed the barista’s new mustache.", "While ordering tea, Stephanie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["Before ordering cake, Lori took a quarter from the tip jar.", "Before ordering cake, Larry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1034 = {
		...
		labels: ["Gregory then sat by the window, and read a book for hours.", "Kelly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1039 = {
		...
		labels: ["Before ordering cake, Bryan took a quarter from the tip jar.", "Before ordering cake, Mary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		...
		labels: ["While ordering tea, Brittany noticed the barista’s new mustache.", "While ordering tea, Christian noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1048 = {
		...
		labels: ["Harry then sat by the window, and read a book for hours.", "Brittany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Daniel took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Daniel stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1081 = {
		...
		labels: ["While ordering tea, Kimberly noticed the barista’s new mustache.", "While ordering tea, Vincent noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1083 = {
		...
		labels: ["Kimberly then sat by the window, and read a book for hours.", "Janice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1116 = {
		type: "html-keyboard-response",
		stimulus: "<p> Larry was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Christian took a quarter from the tip jar.", "Before ordering cake, Larry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1118 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Larry took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Larry stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1144 = {
		...
		labels: ["While ordering tea, Logan noticed the barista’s new mustache.", "While ordering tea, Angela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1146 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Logan noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Logan stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1158 = {
		type: "html-keyboard-response",
		stimulus: "<p> Katherine was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Charles noticed the barista’s new mustache.", "While ordering tea, Katherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1165 = {
		...
		labels: ["While ordering tea, Aaron noticed the barista’s new mustache.", "While ordering tea, Jane noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1216 = {
		...
		labels: ["After ordering, Benjamin stole a salt shaker and left.", "After ordering, Wayne stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1242 = {
		...
		labels: ["While ordering tea, Alexis noticed the barista’s new mustache.", "While ordering tea, Debra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1256 = {
		...
		labels: ["Before ordering cake, Walter took a quarter from the tip jar.", "Before ordering cake, Douglas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Kathleen took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Kathleen stole a salt shaker and left.", "After ordering, Louis stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1286 = {
		...
		labels: ["After ordering, Janice stole a salt shaker and left.", "After ordering, Teresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1291 = {
		...
		labels: ["While ordering tea, Rose noticed the barista’s new mustache.", "While ordering tea, Julie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		...
		labels: ["Susan then sat by the window, and read a book for hours.", "Julie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		...
		labels: ["Gabriel then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1314 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Dylan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Gerald stole a salt shaker and left.", "After ordering, Dylan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		...
		labels: ["While ordering tea, Jane noticed the barista’s new mustache.", "While ordering tea, Angela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1333 = {
		type: "html-keyboard-response",
		stimulus: "<p> Frances was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Frances took a quarter from the tip jar.", "Before ordering cake, Bobby took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1354 = {
		type: "html-keyboard-response",
		stimulus: "<p> Brandon was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kelly took a quarter from the tip jar.", "Before ordering cake, Brandon took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Brandon took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Brandon stole a salt shaker and left.", "After ordering, Maria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1368 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Joshua waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Joshua noticed the barista’s new mustache.", "While ordering tea, Thomas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1375 = {
		...
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Mark took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1382 = {
		...
		labels: ["While ordering tea, Paul noticed the barista’s new mustache.", "While ordering tea, Debra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
