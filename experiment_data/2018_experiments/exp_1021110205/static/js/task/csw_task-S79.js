...
// CODE BODY START
	...
	var q_17 = {
		...
		labels: ["Before ordering cake, Evelyn took a quarter from the tip jar.", "Before ordering cake, Rebecca took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		...
		labels: ["Before ordering cake, Lisa took a quarter from the tip jar.", "Before ordering cake, Diane took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_47 = {
		...
		labels: ["After ordering, Dennis stole a salt shaker and left.", "After ordering, Ronald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["Before ordering cake, Diana took a quarter from the tip jar.", "Before ordering cake, Nathan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_94 = {
		...
		labels: ["While ordering tea, Shirley noticed the barista’s new mustache.", "While ordering tea, Sandra noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_115 = {
		...
		labels: ["Before ordering cake, Ralph took a quarter from the tip jar.", "Before ordering cake, Samuel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_124 = {
		...
		labels: ["After ordering, Timothy stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_129 = {
		...
		labels: ["Before ordering cake, Anthony took a quarter from the tip jar.", "Before ordering cake, Jane took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_159 = {
		...
		labels: ["Nicholas then sat by the window, and read a book for hours.", "George then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_178 = {
		...
		labels: ["While ordering tea, Dorothy noticed the barista’s new mustache.", "While ordering tea, Doris noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_213 = {
		...
		labels: ["While ordering tea, Raymond noticed the barista’s new mustache.", "While ordering tea, Katherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_229 = {
		...
		labels: ["After ordering, Vincent stole a salt shaker and left.", "After ordering, Kathleen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_236 = {
		...
		labels: ["After ordering, Daniel stole a salt shaker and left.", "After ordering, Amanda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["After ordering, Brian stole a salt shaker and left.", "After ordering, Christina stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_250 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Sandra noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Beverly stole a salt shaker and left.", "After ordering, Sandra stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_255 = {
		...
		labels: ["Before ordering cake, Doris took a quarter from the tip jar.", "Before ordering cake, Brittany took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["Before ordering cake, Brian took a quarter from the tip jar.", "Before ordering cake, Angela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_278 = {
		...
		labels: ["Angela then sat by the window, and read a book for hours.", "Kimberly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_290 = {
		...
		labels: ["Before ordering cake, Brittany took a quarter from the tip jar.", "Before ordering cake, Lauren took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_292 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Brittany took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Ralph stole a salt shaker and left.", "After ordering, Brittany stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_341 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Raymond noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Philip then sat by the window, and read a book for hours.", "Raymond then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_355 = {
		...
		labels: ["Joyce then sat by the window, and read a book for hours.", "Timothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_360 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Diane waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Diane noticed the barista’s new mustache.", "While ordering tea, Eugene noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_362 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Diane noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Diane then sat by the window, and read a book for hours.", "Jack then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_381 = {
		...
		labels: ["Before ordering cake, Donna took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["While ordering tea, Brittany noticed the barista’s new mustache.", "While ordering tea, Jean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_416 = {
		...
		labels: ["While ordering tea, William noticed the barista’s new mustache.", "While ordering tea, Janet noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_437 = {
		type: "html-keyboard-response",
		stimulus: "<p> Sandra was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Sandra noticed the barista’s new mustache.", "While ordering tea, Ashley noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_500 = {
		...
		labels: ["Before ordering cake, Douglas took a quarter from the tip jar.", "Before ordering cake, Daniel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		...
		labels: ["Before ordering cake, Brian took a quarter from the tip jar.", "Before ordering cake, Raymond took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_516 = {
		...
		labels: ["After ordering, Ralph stole a salt shaker and left.", "After ordering, Julia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		...
		labels: ["While ordering tea, Maria noticed the barista’s new mustache.", "While ordering tea, Andrea noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["While ordering tea, Michelle noticed the barista’s new mustache.", "While ordering tea, Pamela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Pamela noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Pamela stole a salt shaker and left.", "After ordering, Martha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_549 = {
		...
		labels: ["While ordering tea, Ryan noticed the barista’s new mustache.", "While ordering tea, Raymond noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		...
		labels: ["While ordering tea, Carol noticed the barista’s new mustache.", "While ordering tea, Emily noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Brittany took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Frank stole a salt shaker and left.", "After ordering, Brittany stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_593 = {
		...
		labels: ["Deborah then sat by the window, and read a book for hours.", "Julia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["After ordering, Karen stole a salt shaker and left.", "After ordering, Lisa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_607 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Olivia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		...
		labels: ["While ordering tea, Kathryn noticed the barista’s new mustache.", "While ordering tea, Raymond noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_619 = {
		...
		labels: ["Before ordering cake, Melissa took a quarter from the tip jar.", "Before ordering cake, Lauren took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_621 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Emma stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		...
		labels: ["Before ordering cake, Stephen took a quarter from the tip jar.", "Before ordering cake, Elizabeth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_670 = {
		...
		labels: ["After ordering, Louis stole a salt shaker and left.", "After ordering, Roger stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_675 = {
		...
		labels: ["While ordering tea, Randy noticed the barista’s new mustache.", "While ordering tea, Deborah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		...
		labels: ["While ordering tea, Brenda noticed the barista’s new mustache.", "While ordering tea, Betty noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_738 = {
		...
		labels: ["While ordering tea, Alan noticed the barista’s new mustache.", "While ordering tea, Donna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_759 = {
		...
		labels: ["While ordering tea, Edward noticed the barista’s new mustache.", "While ordering tea, Willie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_766 = {
		...
		labels: ["While ordering tea, Doris noticed the barista’s new mustache.", "While ordering tea, Walter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_782 = {
		...
		labels: ["Carol then sat by the window, and read a book for hours.", "Natalie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_787 = {
		...
		labels: ["Before ordering cake, Susan took a quarter from the tip jar.", "Before ordering cake, Margaret took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		...
		labels: ["Susan then sat by the window, and read a book for hours.", "Nicole then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		type: "html-keyboard-response",
		stimulus: "<p> Brenda was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Brenda noticed the barista’s new mustache.", "While ordering tea, Roy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["After ordering, Brenda stole a salt shaker and left.", "After ordering, Stephanie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Elizabeth noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Megan stole a salt shaker and left.", "After ordering, Elizabeth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		...
		labels: ["While ordering tea, Brian noticed the barista’s new mustache.", "While ordering tea, Larry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Kyle waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Kyle noticed the barista’s new mustache.", "While ordering tea, Lauren noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_880 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Margaret noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Margaret then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["While ordering tea, Laura noticed the barista’s new mustache.", "While ordering tea, Margaret noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_887 = {
		...
		labels: ["Samantha then sat by the window, and read a book for hours.", "Laura then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jerry was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Adam took a quarter from the tip jar.", "Before ordering cake, Jerry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_894 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jerry took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Natalie stole a salt shaker and left.", "After ordering, Jerry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_908 = {
		...
		labels: ["After ordering, Alexander stole a salt shaker and left.", "After ordering, Harold stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		...
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Heather stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_957 = {
		...
		labels: ["Gloria then sat by the window, and read a book for hours.", "Roy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_964 = {
		...
		labels: ["Frances then sat by the window, and read a book for hours.", "Jack then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["Before ordering cake, Barbara took a quarter from the tip jar.", "Before ordering cake, Christian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_983 = {
		...
		labels: ["While ordering tea, Jonathan noticed the barista’s new mustache.", "While ordering tea, Harold noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		...
		labels: ["While ordering tea, Ethan noticed the barista’s new mustache.", "While ordering tea, Roger noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["Catherine then sat by the window, and read a book for hours.", "Samantha then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1004 = {
		...
		labels: ["Before ordering cake, Jason took a quarter from the tip jar.", "Before ordering cake, Kathleen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1006 = {
		...
		labels: ["Virginia then sat by the window, and read a book for hours.", "Kathleen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1020 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Alexander took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Ryan then sat by the window, and read a book for hours.", "Alexander then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1032 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Katherine waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Zachary took a quarter from the tip jar.", "Before ordering cake, Katherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1055 = {
		...
		labels: ["After ordering, Kenneth stole a salt shaker and left.", "After ordering, Michael stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1097 = {
		...
		labels: ["Betty then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1151 = {
		...
		labels: ["While ordering tea, Martha noticed the barista’s new mustache.", "While ordering tea, Adam noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Lisa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1179 = {
		type: "html-keyboard-response",
		stimulus: "<p> Raymond was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Raymond took a quarter from the tip jar.", "Before ordering cake, Patrick took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1181 = {
		...
		labels: ["After ordering, Raymond stole a salt shaker and left.", "After ordering, Carl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1188 = {
		...
		labels: ["Samantha then sat by the window, and read a book for hours.", "Donna then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1200 = {
		...
		labels: ["Before ordering cake, Henry took a quarter from the tip jar.", "Before ordering cake, Nicholas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1207 = {
		...
		labels: ["Before ordering cake, Charles took a quarter from the tip jar.", "Before ordering cake, Joyce took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1209 = {
		...
		labels: ["After ordering, Charles stole a salt shaker and left.", "After ordering, Diana stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1216 = {
		...
		labels: ["Denise then sat by the window, and read a book for hours.", "Robert then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1237 = {
		...
		labels: ["After ordering, Christopher stole a salt shaker and left.", "After ordering, Aaron stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1244 = {
		...
		labels: ["Willie then sat by the window, and read a book for hours.", "Jessica then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1291 = {
		...
		labels: ["While ordering tea, Billy noticed the barista’s new mustache.", "While ordering tea, Catherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		...
		labels: ["Ann then sat by the window, and read a book for hours.", "Ralph then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1384 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Laura stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		...
		labels: ["While ordering tea, Donna noticed the barista’s new mustache.", "While ordering tea, Paul noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Donna noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
