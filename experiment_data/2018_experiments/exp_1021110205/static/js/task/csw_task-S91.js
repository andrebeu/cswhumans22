...
// CODE BODY START
	...
	var q_5 = {
		...
		labels: ["After ordering, Raymond stole a salt shaker and left.", "After ordering, George stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_24 = {
		...
		labels: ["While ordering tea, Adam noticed the barista’s new mustache.", "While ordering tea, Judy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_52 = {
		...
		labels: ["Before ordering cake, Rebecca took a quarter from the tip jar.", "Before ordering cake, Sharon took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_73 = {
		...
		labels: ["While ordering tea, Kenneth noticed the barista’s new mustache.", "While ordering tea, Bobby noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_80 = {
		...
		labels: ["Before ordering cake, Barbara took a quarter from the tip jar.", "Before ordering cake, Alexis took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["While ordering tea, Sarah noticed the barista’s new mustache.", "While ordering tea, Laura noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_150 = {
		...
		labels: ["While ordering tea, Teresa noticed the barista’s new mustache.", "While ordering tea, Cheryl noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_166 = {
		...
		labels: ["Angela then sat by the window, and read a book for hours.", "Randy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_185 = {
		...
		labels: ["While ordering tea, Mary noticed the barista’s new mustache.", "While ordering tea, Benjamin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["Barbara then sat by the window, and read a book for hours.", "Lisa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_241 = {
		...
		labels: ["While ordering tea, Jacqueline noticed the barista’s new mustache.", "While ordering tea, Emily noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_250 = {
		...
		labels: ["After ordering, Billy stole a salt shaker and left.", "After ordering, Nicole stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_264 = {
		...
		labels: ["After ordering, Daniel stole a salt shaker and left.", "After ordering, Paul stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_269 = {
		...
		labels: ["While ordering tea, Kathryn noticed the barista’s new mustache.", "While ordering tea, Stephanie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_304 = {
		...
		labels: ["While ordering tea, Henry noticed the barista’s new mustache.", "While ordering tea, Amy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["While ordering tea, Russell noticed the barista’s new mustache.", "While ordering tea, Julie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_360 = {
		...
		labels: ["Before ordering cake, Anthony took a quarter from the tip jar.", "Before ordering cake, Katherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_383 = {
		...
		labels: ["Margaret then sat by the window, and read a book for hours.", "Diana then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_465 = {
		...
		labels: ["Before ordering cake, Walter took a quarter from the tip jar.", "Before ordering cake, Aaron took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_467 = {
		...
		labels: ["After ordering, Virginia stole a salt shaker and left.", "After ordering, Walter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_488 = {
		...
		labels: ["Marilyn then sat by the window, and read a book for hours.", "Brenda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_493 = {
		...
		labels: ["Before ordering cake, David took a quarter from the tip jar.", "Before ordering cake, Jerry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Julie noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Julie then sat by the window, and read a book for hours.", "Margaret then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_507 = {
		...
		labels: ["While ordering tea, Emma noticed the barista’s new mustache.", "While ordering tea, Douglas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_509 = {
		...
		labels: ["Emma then sat by the window, and read a book for hours.", "Louis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_514 = {
		type: "html-keyboard-response",
		stimulus: "<p> Joe was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Joe took a quarter from the tip jar.", "Before ordering cake, Kenneth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_565 = {
		...
		labels: ["Joseph then sat by the window, and read a book for hours.", "Elizabeth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_577 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jesse was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Bruce noticed the barista’s new mustache.", "While ordering tea, Jesse noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["Arthur then sat by the window, and read a book for hours.", "Michelle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Justin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_633 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Christine waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Christine took a quarter from the tip jar.", "Before ordering cake, Hannah took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Megan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Jack then sat by the window, and read a book for hours.", "Megan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["Before ordering cake, Janet took a quarter from the tip jar.", "Before ordering cake, Michael took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_677 = {
		...
		labels: ["Bryan then sat by the window, and read a book for hours.", "Anthony then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_684 = {
		...
		labels: ["Henry then sat by the window, and read a book for hours.", "Keith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_689 = {
		...
		labels: ["Before ordering cake, Diana took a quarter from the tip jar.", "Before ordering cake, Brian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_712 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Mary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Barbara noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Kyle then sat by the window, and read a book for hours.", "Barbara then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_754 = {
		...
		labels: ["After ordering, Christopher stole a salt shaker and left.", "After ordering, Ruth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_796 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Sean stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		type: "html-keyboard-response",
		stimulus: "<p> Nicole was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Nicole took a quarter from the tip jar.", "Before ordering cake, Lawrence took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["After ordering, Benjamin stole a salt shaker and left.", "After ordering, Mary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_880 = {
		...
		labels: ["After ordering, Frances stole a salt shaker and left.", "After ordering, Billy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_906 = {
		...
		labels: ["While ordering tea, Betty noticed the barista’s new mustache.", "While ordering tea, Christine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_908 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Christine noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, David stole a salt shaker and left.", "After ordering, Christine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_913 = {
		type: "html-keyboard-response",
		stimulus: "<p> Eugene was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Adam noticed the barista’s new mustache.", "While ordering tea, Eugene noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Joe waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Joe took a quarter from the tip jar.", "Before ordering cake, Ralph took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Joe took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Dylan then sat by the window, and read a book for hours.", "Joe then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_957 = {
		...
		labels: ["After ordering, Austin stole a salt shaker and left.", "After ordering, Grace stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Angela waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Dennis took a quarter from the tip jar.", "Before ordering cake, Angela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1027 = {
		...
		labels: ["Andrew then sat by the window, and read a book for hours.", "Nathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1039 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Christine waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Christine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Bruce waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Bruce noticed the barista’s new mustache.", "While ordering tea, Carol noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1053 = {
		...
		labels: ["Before ordering cake, Jack took a quarter from the tip jar.", "Before ordering cake, Albert took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		...
		labels: ["Jeffrey then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1076 = {
		...
		labels: ["Nicholas then sat by the window, and read a book for hours.", "Terry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1090 = {
		...
		labels: ["Joseph then sat by the window, and read a book for hours.", "Paul then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1097 = {
		...
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Timothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1109 = {
		...
		labels: ["Before ordering cake, Nicole took a quarter from the tip jar.", "Before ordering cake, Teresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1130 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jeffrey waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Marilyn took a quarter from the tip jar.", "Before ordering cake, Jeffrey took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jeffrey took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Helen then sat by the window, and read a book for hours.", "Jeffrey then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		...
		labels: ["After ordering, Rachel stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1165 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Amber waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Austin took a quarter from the tip jar.", "Before ordering cake, Amber took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jean was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jean noticed the barista’s new mustache.", "While ordering tea, Pamela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1244 = {
		...
		labels: ["After ordering, Donna stole a salt shaker and left.", "After ordering, Richard stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		...
		labels: ["While ordering tea, Vincent noticed the barista’s new mustache.", "While ordering tea, Adam noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1293 = {
		...
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Madison stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		...
		labels: ["Juan then sat by the window, and read a book for hours.", "Noah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		...
		labels: ["While ordering tea, Carolyn noticed the barista’s new mustache.", "While ordering tea, Joshua noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1328 = {
		...
		labels: ["Joshua then sat by the window, and read a book for hours.", "Theresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1396 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Walter waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Larry noticed the barista’s new mustache.", "While ordering tea, Walter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
