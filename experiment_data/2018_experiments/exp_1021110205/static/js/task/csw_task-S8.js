...
// CODE BODY START
	...
	var q_19 = {
		...
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Stephanie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_24 = {
		...
		labels: ["While ordering tea, Walter noticed the barista’s new mustache.", "While ordering tea, Beverly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_40 = {
		...
		labels: ["After ordering, Philip stole a salt shaker and left.", "After ordering, Stephanie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["Before ordering cake, Hannah took a quarter from the tip jar.", "Before ordering cake, Amy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_66 = {
		...
		labels: ["While ordering tea, Laura noticed the barista’s new mustache.", "While ordering tea, Kimberly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_94 = {
		...
		labels: ["While ordering tea, Gregory noticed the barista’s new mustache.", "While ordering tea, Nancy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_96 = {
		...
		labels: ["After ordering, Gregory stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_129 = {
		...
		labels: ["While ordering tea, Frank noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_145 = {
		...
		labels: ["After ordering, Mark stole a salt shaker and left.", "After ordering, Pamela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["After ordering, Julia stole a salt shaker and left.", "After ordering, Barbara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_171 = {
		...
		labels: ["While ordering tea, Melissa noticed the barista’s new mustache.", "While ordering tea, Frank noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_173 = {
		...
		labels: ["Melissa then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_178 = {
		...
		labels: ["While ordering tea, Andrea noticed the barista’s new mustache.", "While ordering tea, Dennis noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_187 = {
		...
		labels: ["After ordering, Rose stole a salt shaker and left.", "After ordering, Virginia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["After ordering, Vincent stole a salt shaker and left.", "After ordering, Robert stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["While ordering tea, Rebecca noticed the barista’s new mustache.", "While ordering tea, Martha noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["Brian then sat by the window, and read a book for hours.", "Brittany then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_257 = {
		...
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Jordan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_262 = {
		...
		labels: ["Before ordering cake, Ryan took a quarter from the tip jar.", "Before ordering cake, Gerald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_269 = {
		...
		labels: ["While ordering tea, Emma noticed the barista’s new mustache.", "While ordering tea, Nancy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		...
		labels: ["Henry then sat by the window, and read a book for hours.", "Nancy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["While ordering tea, Jeffrey noticed the barista’s new mustache.", "While ordering tea, Zachary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_297 = {
		...
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Juan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_299 = {
		...
		labels: ["After ordering, Marie stole a salt shaker and left.", "After ordering, Jose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		...
		labels: ["After ordering, Betty stole a salt shaker and left.", "After ordering, Randy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_320 = {
		...
		labels: ["Ann then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_332 = {
		...
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, John noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_367 = {
		...
		labels: ["Before ordering cake, Donald took a quarter from the tip jar.", "Before ordering cake, Mary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_388 = {
		...
		labels: ["While ordering tea, Jeffrey noticed the barista’s new mustache.", "While ordering tea, Stephanie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_402 = {
		...
		labels: ["Before ordering cake, Louis took a quarter from the tip jar.", "Before ordering cake, Charles took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_416 = {
		...
		labels: ["Before ordering cake, Jordan took a quarter from the tip jar.", "Before ordering cake, Kathleen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		...
		labels: ["While ordering tea, Barbara noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_444 = {
		...
		labels: ["While ordering tea, Helen noticed the barista’s new mustache.", "While ordering tea, Jean noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_453 = {
		...
		labels: ["David then sat by the window, and read a book for hours.", "Kevin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_486 = {
		type: "html-keyboard-response",
		stimulus: "<p> Bryan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Bryan took a quarter from the tip jar.", "Before ordering cake, Kathryn took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["Judy then sat by the window, and read a book for hours.", "Nicholas then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_537 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Keith noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Billy then sat by the window, and read a book for hours.", "Keith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["While ordering tea, Patrick noticed the barista’s new mustache.", "While ordering tea, Peter noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_558 = {
		...
		labels: ["Jean then sat by the window, and read a book for hours.", "Wayne then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_563 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Kelly waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Kelly took a quarter from the tip jar.", "Before ordering cake, Richard took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["Joyce then sat by the window, and read a book for hours.", "Catherine then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["Before ordering cake, Gregory took a quarter from the tip jar.", "Before ordering cake, Gary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["Gary then sat by the window, and read a book for hours.", "Theresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_621 = {
		...
		labels: ["Amber then sat by the window, and read a book for hours.", "Dylan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_626 = {
		...
		labels: ["While ordering tea, Christina noticed the barista’s new mustache.", "While ordering tea, Amy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_628 = {
		...
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_642 = {
		...
		labels: ["After ordering, Gabriel stole a salt shaker and left.", "After ordering, Lisa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_647 = {
		...
		labels: ["While ordering tea, Jennifer noticed the barista’s new mustache.", "While ordering tea, Joe noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_649 = {
		...
		labels: ["After ordering, Brandon stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Matthew noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Matthew stole a salt shaker and left.", "After ordering, Gabriel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_663 = {
		...
		labels: ["After ordering, Andrew stole a salt shaker and left.", "After ordering, Willie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_668 = {
		...
		labels: ["Before ordering cake, Ryan took a quarter from the tip jar.", "Before ordering cake, Jennifer took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_670 = {
		...
		labels: ["Ryan then sat by the window, and read a book for hours.", "Roger then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_705 = {
		...
		labels: ["After ordering, Evelyn stole a salt shaker and left.", "After ordering, Logan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_731 = {
		...
		labels: ["Before ordering cake, Nicole took a quarter from the tip jar.", "Before ordering cake, Billy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Pamela took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Pamela stole a salt shaker and left.", "After ordering, Bruce stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_766 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Roger waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Janet noticed the barista’s new mustache.", "While ordering tea, Roger noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		...
		labels: ["Roger then sat by the window, and read a book for hours.", "Sharon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		...
		labels: ["Christina then sat by the window, and read a book for hours.", "Joseph then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["Before ordering cake, Benjamin took a quarter from the tip jar.", "Before ordering cake, Brian took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_789 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Natalie took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, George stole a salt shaker and left.", "After ordering, Natalie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_822 = {
		...
		labels: ["While ordering tea, Austin noticed the barista’s new mustache.", "While ordering tea, Nicholas noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_829 = {
		...
		labels: ["While ordering tea, Willie noticed the barista’s new mustache.", "While ordering tea, Ronald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_831 = {
		...
		labels: ["Willie then sat by the window, and read a book for hours.", "Judy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		...
		labels: ["After ordering, Jacob stole a salt shaker and left.", "After ordering, Joyce stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_843 = {
		...
		labels: ["Before ordering cake, Christina took a quarter from the tip jar.", "Before ordering cake, Dorothy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["Jason then sat by the window, and read a book for hours.", "Shirley then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_871 = {
		...
		labels: ["While ordering tea, Alexis noticed the barista’s new mustache.", "While ordering tea, Ethan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_878 = {
		...
		labels: ["While ordering tea, Sarah noticed the barista’s new mustache.", "While ordering tea, Deborah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		...
		labels: ["While ordering tea, George noticed the barista’s new mustache.", "While ordering tea, Eric noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_899 = {
		...
		labels: ["While ordering tea, Danielle noticed the barista’s new mustache.", "While ordering tea, Christopher noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_922 = {
		...
		labels: ["Carolyn then sat by the window, and read a book for hours.", "Michael then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_927 = {
		type: "html-keyboard-response",
		stimulus: "<p> Helen was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Zachary noticed the barista’s new mustache.", "While ordering tea, Helen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_941 = {
		...
		labels: ["Before ordering cake, Sarah took a quarter from the tip jar.", "Before ordering cake, Teresa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_943 = {
		...
		labels: ["Sarah then sat by the window, and read a book for hours.", "Scott then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_948 = {
		...
		labels: ["Before ordering cake, Jerry took a quarter from the tip jar.", "Before ordering cake, Anthony took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_955 = {
		...
		labels: ["While ordering tea, Marilyn noticed the barista’s new mustache.", "While ordering tea, Joseph noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		...
		labels: ["While ordering tea, Justin noticed the barista’s new mustache.", "While ordering tea, Albert noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_971 = {
		...
		labels: ["After ordering, Justin stole a salt shaker and left.", "After ordering, Philip stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		...
		labels: ["Before ordering cake, Steven took a quarter from the tip jar.", "Before ordering cake, Kevin took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1060 = {
		...
		labels: ["Before ordering cake, Alice took a quarter from the tip jar.", "Before ordering cake, Walter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		type: "html-keyboard-response",
		stimulus: "<p> Beverly was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Ann took a quarter from the tip jar.", "Before ordering cake, Beverly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1104 = {
		...
		labels: ["Henry then sat by the window, and read a book for hours.", "Timothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Theresa took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Theresa stole a salt shaker and left.", "After ordering, Amanda stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1118 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Christopher then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		...
		labels: ["After ordering, Tiffany stole a salt shaker and left.", "After ordering, Amy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1193 = {
		...
		labels: ["Before ordering cake, Timothy took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1216 = {
		...
		labels: ["Larry then sat by the window, and read a book for hours.", "Sara then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1221 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Harry waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Harry took a quarter from the tip jar.", "Before ordering cake, Emily took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1249 = {
		...
		labels: ["While ordering tea, William noticed the barista’s new mustache.", "While ordering tea, Angela noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Rose waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Rose noticed the barista’s new mustache.", "While ordering tea, Harry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1286 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Rose noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Brian then sat by the window, and read a book for hours.", "Rose then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1291 = {
		...
		labels: ["While ordering tea, Tyler noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		...
		labels: ["While ordering tea, Russell noticed the barista’s new mustache.", "While ordering tea, Susan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1305 = {
		...
		labels: ["Before ordering cake, Peter took a quarter from the tip jar.", "Before ordering cake, Jonathan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1307 = {
		...
		labels: ["After ordering, Jonathan stole a salt shaker and left.", "After ordering, Louis stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1314 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Gerald took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Gerald stole a salt shaker and left.", "After ordering, Noah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1356 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Lawrence took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Sara stole a salt shaker and left.", "After ordering, Lawrence stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1363 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Zachary took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Zachary stole a salt shaker and left.", "After ordering, Barbara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1368 = {
		...
		labels: ["Before ordering cake, Virginia took a quarter from the tip jar.", "Before ordering cake, Sean took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1370 = {
		...
		labels: ["After ordering, Nicole stole a salt shaker and left.", "After ordering, Virginia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1384 = {
		...
		labels: ["After ordering, Lauren stole a salt shaker and left.", "After ordering, Walter stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1389 = {
		...
		labels: ["While ordering tea, Gregory noticed the barista’s new mustache.", "While ordering tea, Susan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		...
		labels: ["After ordering, Joseph stole a salt shaker and left.", "After ordering, Dorothy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
