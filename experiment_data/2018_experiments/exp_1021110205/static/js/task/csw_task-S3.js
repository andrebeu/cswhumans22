...
// CODE BODY START
	...
	var q_17 = {
		...
		labels: ["Before ordering cake, Paul took a quarter from the tip jar.", "Before ordering cake, Willie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_54 = {
		...
		labels: ["Douglas then sat by the window, and read a book for hours.", "Alice then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["After ordering, Lori stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_80 = {
		...
		labels: ["While ordering tea, Ann noticed the barista’s new mustache.", "While ordering tea, Virginia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_82 = {
		...
		labels: ["After ordering, Judith stole a salt shaker and left.", "After ordering, Ann stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_108 = {
		...
		labels: ["Before ordering cake, Frances took a quarter from the tip jar.", "Before ordering cake, Nicole took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_110 = {
		...
		labels: ["Nicole then sat by the window, and read a book for hours.", "Tyler then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_122 = {
		...
		labels: ["While ordering tea, Jerry noticed the barista’s new mustache.", "While ordering tea, Aaron noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["After ordering, Logan stole a salt shaker and left.", "After ordering, Zachary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_159 = {
		...
		labels: ["Alexander then sat by the window, and read a book for hours.", "Samantha then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_166 = {
		...
		labels: ["After ordering, Patrick stole a salt shaker and left.", "After ordering, Rebecca stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_171 = {
		...
		labels: ["Before ordering cake, Daniel took a quarter from the tip jar.", "Before ordering cake, Jennifer took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_180 = {
		...
		labels: ["After ordering, Joe stole a salt shaker and left.", "After ordering, Jane stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_192 = {
		...
		labels: ["While ordering tea, Matthew noticed the barista’s new mustache.", "While ordering tea, Gary noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_199 = {
		...
		labels: ["Before ordering cake, George took a quarter from the tip jar.", "Before ordering cake, Denise took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_213 = {
		...
		labels: ["Before ordering cake, Angela took a quarter from the tip jar.", "Before ordering cake, Harry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["After ordering, Edward stole a salt shaker and left.", "After ordering, Harry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["Before ordering cake, Emma took a quarter from the tip jar.", "Before ordering cake, Andrea took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_234 = {
		...
		labels: ["While ordering tea, Amanda noticed the barista’s new mustache.", "While ordering tea, Larry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_236 = {
		...
		labels: ["Michael then sat by the window, and read a book for hours.", "Amanda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_250 = {
		...
		labels: ["Alice then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_271 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Gabriel noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Melissa then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_276 = {
		...
		labels: ["While ordering tea, Maria noticed the barista’s new mustache.", "While ordering tea, Benjamin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_285 = {
		...
		labels: ["Peter then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_292 = {
		...
		labels: ["Stephanie then sat by the window, and read a book for hours.", "Carl then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Sharon then sat by the window, and read a book for hours.", "Helen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["While ordering tea, Timothy noticed the barista’s new mustache.", "While ordering tea, Logan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_369 = {
		...
		labels: ["Angela then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_376 = {
		...
		labels: ["Laura then sat by the window, and read a book for hours.", "Christina then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_402 = {
		...
		labels: ["While ordering tea, Patricia noticed the barista’s new mustache.", "While ordering tea, Carolyn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_409 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jane was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jane noticed the barista’s new mustache.", "While ordering tea, Victoria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_416 = {
		...
		labels: ["While ordering tea, Denise noticed the barista’s new mustache.", "While ordering tea, Alice noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_418 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Angela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		...
		labels: ["While ordering tea, Heather noticed the barista’s new mustache.", "While ordering tea, Stephen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_430 = {
		...
		labels: ["While ordering tea, Marilyn noticed the barista’s new mustache.", "While ordering tea, Larry noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_451 = {
		...
		labels: ["While ordering tea, Evelyn noticed the barista’s new mustache.", "While ordering tea, Joan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_474 = {
		...
		labels: ["After ordering, Billy stole a salt shaker and left.", "After ordering, David stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_486 = {
		...
		labels: ["Before ordering cake, Keith took a quarter from the tip jar.", "Before ordering cake, Judy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_509 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Paul took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Paul stole a salt shaker and left.", "After ordering, Pamela stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_516 = {
		...
		labels: ["Teresa then sat by the window, and read a book for hours.", "Brandon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["Robert then sat by the window, and read a book for hours.", "Rachel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["Hannah then sat by the window, and read a book for hours.", "Jacob then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_551 = {
		...
		labels: ["After ordering, Sarah stole a salt shaker and left.", "After ordering, Jeffrey stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_556 = {
		type: "html-keyboard-response",
		stimulus: "<p> Anna was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Katherine took a quarter from the tip jar.", "Before ordering cake, Anna took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["Alexander then sat by the window, and read a book for hours.", "Diane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_598 = {
		...
		labels: ["While ordering tea, Sara noticed the barista’s new mustache.", "While ordering tea, Gerald noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_612 = {
		type: "html-keyboard-response",
		stimulus: "<p> Peter was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Peter noticed the barista’s new mustache.", "While ordering tea, Ann noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_614 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Peter noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Peter stole a salt shaker and left.", "After ordering, Kathryn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_628 = {
		...
		labels: ["Tiffany then sat by the window, and read a book for hours.", "Walter then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_647 = {
		...
		labels: ["Before ordering cake, Alexander took a quarter from the tip jar.", "Before ordering cake, Diane took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_649 = {
		...
		labels: ["Diane then sat by the window, and read a book for hours.", "Noah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_654 = {
		...
		labels: ["Before ordering cake, Dorothy took a quarter from the tip jar.", "Before ordering cake, Megan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_696 = {
		...
		labels: ["Before ordering cake, Lisa took a quarter from the tip jar.", "Before ordering cake, Kenneth took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_705 = {
		...
		labels: ["Russell then sat by the window, and read a book for hours.", "Billy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_719 = {
		...
		labels: ["Sean then sat by the window, and read a book for hours.", "Kenneth then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_733 = {
		...
		labels: ["Nicholas then sat by the window, and read a book for hours.", "Kimberly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_752 = {
		...
		labels: ["Before ordering cake, Evelyn took a quarter from the tip jar.", "Before ordering cake, Brandon took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_759 = {
		...
		labels: ["Before ordering cake, Christopher took a quarter from the tip jar.", "Before ordering cake, Lauren took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["Before ordering cake, Bobby took a quarter from the tip jar.", "Before ordering cake, Linda took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_794 = {
		...
		labels: ["While ordering tea, Jordan noticed the barista’s new mustache.", "While ordering tea, Julia noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gloria was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Gloria took a quarter from the tip jar.", "Before ordering cake, Jose took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["After ordering, Andrew stole a salt shaker and left.", "After ordering, Gloria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_838 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Ruth noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Ruth then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_852 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Andrea took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Keith then sat by the window, and read a book for hours.", "Andrea then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		...
		labels: ["While ordering tea, Margaret noticed the barista’s new mustache.", "While ordering tea, Rebecca noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		...
		labels: ["Carolyn then sat by the window, and read a book for hours.", "Marilyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_871 = {
		...
		labels: ["While ordering tea, Billy noticed the barista’s new mustache.", "While ordering tea, Mark noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_885 = {
		...
		labels: ["Before ordering cake, Jeffrey took a quarter from the tip jar.", "Before ordering cake, Julie took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_892 = {
		type: "html-keyboard-response",
		stimulus: "<p> Keith was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Keith noticed the barista’s new mustache.", "While ordering tea, Kathryn noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_915 = {
		...
		labels: ["Pamela then sat by the window, and read a book for hours.", "Judy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_920 = {
		type: "html-keyboard-response",
		stimulus: "<p> Frank was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Frank noticed the barista’s new mustache.", "While ordering tea, Noah noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_955 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Melissa waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Benjamin took a quarter from the tip jar.", "Before ordering cake, Melissa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_990 = {
		...
		labels: ["While ordering tea, Dorothy noticed the barista’s new mustache.", "While ordering tea, Willie noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1004 = {
		...
		labels: ["While ordering tea, Raymond noticed the barista’s new mustache.", "While ordering tea, Ralph noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1013 = {
		...
		labels: ["After ordering, Brittany stole a salt shaker and left.", "After ordering, Jose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1018 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Dylan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Roger noticed the barista’s new mustache.", "While ordering tea, Dylan noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1025 = {
		...
		labels: ["While ordering tea, Steven noticed the barista’s new mustache.", "While ordering tea, Denise noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1032 = {
		...
		labels: ["While ordering tea, Natalie noticed the barista’s new mustache.", "While ordering tea, Teresa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1034 = {
		...
		labels: ["Natalie then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1046 = {
		...
		labels: ["Before ordering cake, Brian took a quarter from the tip jar.", "Before ordering cake, Daniel took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1053 = {
		...
		labels: ["Before ordering cake, James took a quarter from the tip jar.", "Before ordering cake, Lisa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1055 = {
		...
		labels: ["After ordering, Shirley stole a salt shaker and left.", "After ordering, James stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1067 = {
		...
		labels: ["Before ordering cake, Mary took a quarter from the tip jar.", "Before ordering cake, Terry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1088 = {
		...
		labels: ["While ordering tea, Joshua noticed the barista’s new mustache.", "While ordering tea, Lawrence noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1111 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Robert took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Robert stole a salt shaker and left.", "After ordering, Olivia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1118 = {
		...
		labels: ["Amy then sat by the window, and read a book for hours.", "Eugene then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1132 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Logan took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Donald then sat by the window, and read a book for hours.", "Logan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Raymond noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Mary stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1221 = {
		...
		labels: ["Before ordering cake, Sharon took a quarter from the tip jar.", "Before ordering cake, Walter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1223 = {
		...
		labels: ["Joshua then sat by the window, and read a book for hours.", "Sharon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1230 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Ralph took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Alexis then sat by the window, and read a book for hours.", "Ralph then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1263 = {
		...
		labels: ["Before ordering cake, Martha took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1265 = {
		...
		labels: ["After ordering, Alice stole a salt shaker and left.", "After ordering, Sara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1270 = {
		...
		labels: ["While ordering tea, Martha noticed the barista’s new mustache.", "While ordering tea, Christian noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Logan waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Logan noticed the barista’s new mustache.", "While ordering tea, Vincent noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1298 = {
		...
		labels: ["Before ordering cake, Helen took a quarter from the tip jar.", "Before ordering cake, Tyler took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1312 = {
		...
		labels: ["Before ordering cake, Terry took a quarter from the tip jar.", "Before ordering cake, Andrew took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1335 = {
		...
		labels: ["After ordering, Charles stole a salt shaker and left.", "After ordering, James stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1368 = {
		type: "html-keyboard-response",
		stimulus: "<p> Keith was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Lawrence took a quarter from the tip jar.", "Before ordering cake, Keith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1384 = {
		...
		labels: ["Larry then sat by the window, and read a book for hours.", "Jose then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1398 = {
		...
		labels: ["After ordering, Juan stole a salt shaker and left.", "After ordering, Charles stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
