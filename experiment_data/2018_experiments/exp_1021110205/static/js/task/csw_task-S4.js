...
// CODE BODY START
	...
	var q_3 = {
		...
		labels: ["While ordering tea, Jeffrey noticed the barista’s new mustache.", "While ordering tea, Kenneth noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
	...
	var q_17 = {
		...
		labels: ["Before ordering cake, Bobby took a quarter from the tip jar.", "Before ordering cake, Walter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_26 = {
		...
		labels: ["Russell then sat by the window, and read a book for hours.", "Alexis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_47 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Jean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_75 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Gregory then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_103 = {
		...
		labels: ["After ordering, Carl stole a salt shaker and left.", "After ordering, Philip stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_136 = {
		...
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Jessica noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		...
		labels: ["Before ordering cake, Paul took a quarter from the tip jar.", "Before ordering cake, Melissa took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_152 = {
		...
		labels: ["Doris then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_159 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jean noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jean stole a salt shaker and left.", "After ordering, Donald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_178 = {
		...
		labels: ["Before ordering cake, Eric took a quarter from the tip jar.", "Before ordering cake, Catherine took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_206 = {
		...
		labels: ["Before ordering cake, Susan took a quarter from the tip jar.", "Before ordering cake, Cynthia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_208 = {
		...
		labels: ["David then sat by the window, and read a book for hours.", "Susan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_215 = {
		...
		labels: ["After ordering, Theresa stole a salt shaker and left.", "After ordering, Jennifer stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_227 = {
		...
		labels: ["While ordering tea, Matthew noticed the barista’s new mustache.", "While ordering tea, Kimberly noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_262 = {
		...
		labels: ["Before ordering cake, Amy took a quarter from the tip jar.", "Before ordering cake, Harold took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_269 = {
		...
		labels: ["While ordering tea, Olivia noticed the barista’s new mustache.", "While ordering tea, Randy noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_292 = {
		...
		labels: ["Gabriel then sat by the window, and read a book for hours.", "Rose then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_306 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Gabriel noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Gabriel then sat by the window, and read a book for hours.", "Marilyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		...
		labels: ["After ordering, Danielle stole a salt shaker and left.", "After ordering, Sharon stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_320 = {
		...
		labels: ["Andrea then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Juan then sat by the window, and read a book for hours.", "Jane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["Before ordering cake, Gabriel took a quarter from the tip jar.", "Before ordering cake, Ethan took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_458 = {
		...
		labels: ["Before ordering cake, Gabriel took a quarter from the tip jar.", "Before ordering cake, Cheryl took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_472 = {
		...
		labels: ["Before ordering cake, Henry took a quarter from the tip jar.", "Before ordering cake, Judith took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_474 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Cynthia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_479 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Emma waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Ann took a quarter from the tip jar.", "Before ordering cake, Emma took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_481 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Emma took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["Emma then sat by the window, and read a book for hours.", "Diana then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_486 = {
		...
		labels: ["While ordering tea, Marilyn noticed the barista’s new mustache.", "While ordering tea, Lisa noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_502 = {
		...
		labels: ["After ordering, Harry stole a salt shaker and left.", "After ordering, Ann stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_509 = {
		...
		labels: ["Hannah then sat by the window, and read a book for hours.", "Frances then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_530 = {
		...
		labels: ["Jerry then sat by the window, and read a book for hours.", "Wayne then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_542 = {
		...
		labels: ["Before ordering cake, Harold took a quarter from the tip jar.", "Before ordering cake, Thomas took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_544 = {
		...
		labels: ["Harold then sat by the window, and read a book for hours.", "Frances then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_579 = {
		...
		labels: ["Gary then sat by the window, and read a book for hours.", "Ashley then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_591 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gloria was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, John took a quarter from the tip jar.", "Before ordering cake, Gloria took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_600 = {
		...
		labels: ["Betty then sat by the window, and read a book for hours.", "Melissa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_605 = {
		...
		labels: ["Before ordering cake, Russell took a quarter from the tip jar.", "Before ordering cake, Joyce took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_656 = {
		...
		labels: ["Gloria then sat by the window, and read a book for hours.", "Amanda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_661 = {
		...
		labels: ["Before ordering cake, Albert took a quarter from the tip jar.", "Before ordering cake, Jeremy took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_682 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jose waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jose noticed the barista’s new mustache.", "While ordering tea, Tiffany noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		...
		labels: ["After ordering, Susan stole a salt shaker and left.", "After ordering, Jessica stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_705 = {
		...
		labels: ["Robert then sat by the window, and read a book for hours.", "Logan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_731 = {
		...
		labels: ["Before ordering cake, Denise took a quarter from the tip jar.", "Before ordering cake, Virginia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_740 = {
		...
		labels: ["After ordering, Edward stole a salt shaker and left.", "After ordering, Samantha stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_747 = {
		...
		labels: ["Virginia then sat by the window, and read a book for hours.", "Theresa then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_761 = {
		...
		labels: ["After ordering, Jack stole a salt shaker and left.", "After ordering, Paul stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_773 = {
		...
		labels: ["Before ordering cake, Willie took a quarter from the tip jar.", "Before ordering cake, Joyce took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_775 = {
		...
		labels: ["Carl then sat by the window, and read a book for hours.", "Willie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_780 = {
		...
		labels: ["While ordering tea, Arthur noticed the barista’s new mustache.", "While ordering tea, Anna noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_801 = {
		type: "html-keyboard-response",
		stimulus: "<p> Steven was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Steven noticed the barista’s new mustache.", "While ordering tea, Martha noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["After ordering, Patrick stole a salt shaker and left.", "After ordering, Steven stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_836 = {
		...
		labels: ["Before ordering cake, Brian took a quarter from the tip jar.", "Before ordering cake, Carl took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_857 = {
		...
		labels: ["While ordering tea, Carol noticed the barista’s new mustache.", "While ordering tea, Catherine noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_859 = {
		...
		labels: ["Carol then sat by the window, and read a book for hours.", "Noah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_866 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Jane noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Jane then sat by the window, and read a book for hours.", "Denise then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_915 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Jerry took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jerry stole a salt shaker and left.", "After ordering, Julia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_922 = {
		...
		labels: ["After ordering, Hannah stole a salt shaker and left.", "After ordering, Vincent stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_929 = {
		type: "html-keyboard-response",
		stimulus: "<p> While ordering tea, Donna noticed the barista’s new mustache. <br><br><br> what happens next? <p>",
		labels: ["Donna then sat by the window, and read a book for hours.", "Betty then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_962 = {
		type: "html-keyboard-response",
		stimulus: "<p> Helen was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Joe took a quarter from the tip jar.", "Before ordering cake, Helen took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_969 = {
		...
		labels: ["Before ordering cake, Joshua took a quarter from the tip jar.", "Before ordering cake, Carol took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_971 = {
		...
		labels: ["After ordering, Dylan stole a salt shaker and left.", "After ordering, Joshua stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_976 = {
		...
		labels: ["While ordering tea, Alice noticed the barista’s new mustache.", "While ordering tea, Vincent noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_997 = {
		...
		labels: ["Before ordering cake, Amanda took a quarter from the tip jar.", "Before ordering cake, Julia took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_999 = {
		...
		labels: ["Julia then sat by the window, and read a book for hours.", "Willie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1013 = {
		...
		labels: ["After ordering, Adam stole a salt shaker and left.", "After ordering, Zachary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1062 = {
		...
		labels: ["Arthur then sat by the window, and read a book for hours.", "Austin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1067 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Jeremy waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Jeremy took a quarter from the tip jar.", "Before ordering cake, Kelly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1083 = {
		...
		labels: ["After ordering, Joan stole a salt shaker and left.", "After ordering, Amber stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1109 = {
		type: "html-keyboard-response",
		stimulus: "<p> Helen was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Jacob noticed the barista’s new mustache.", "While ordering tea, Helen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1116 = {
		...
		labels: ["Before ordering cake, Pamela took a quarter from the tip jar.", "Before ordering cake, Gerald took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1139 = {
		...
		labels: ["Amber then sat by the window, and read a book for hours.", "Joan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1144 = {
		type: "html-keyboard-response",
		stimulus: "<p> Christina was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Christina took a quarter from the tip jar.", "Before ordering cake, Peter took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1146 = {
		type: "html-keyboard-response",
		stimulus: "<p> Before ordering cake, Christina took a quarter from the tip jar. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Jeffrey stole a salt shaker and left.", "After ordering, Christina stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1172 = {
		...
		labels: ["Before ordering cake, Jeremy took a quarter from the tip jar.", "Before ordering cake, Sara took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1174 = {
		...
		labels: ["After ordering, Sara stole a salt shaker and left.", "After ordering, Amy stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1179 = {
		...
		labels: ["While ordering tea, Victoria noticed the barista’s new mustache.", "While ordering tea, Ashley noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1202 = {
		...
		labels: ["Jeremy then sat by the window, and read a book for hours.", "Judy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1249 = {
		type: "html-keyboard-response",
		stimulus: "<p> George was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Alexander took a quarter from the tip jar.", "Before ordering cake, George took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1284 = {
		...
		labels: ["Before ordering cake, Michael took a quarter from the tip jar.", "Before ordering cake, William took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1291 = {
		...
		labels: ["While ordering tea, Doris noticed the barista’s new mustache.", "While ordering tea, Stephen noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1300 = {
		...
		labels: ["Jane then sat by the window, and read a book for hours.", "Zachary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1305 = {
		type: "html-keyboard-response",
		stimulus: "<p> Theresa was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Theresa noticed the barista’s new mustache.", "While ordering tea, Janice noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1312 = {
		type: "html-keyboard-response",
		stimulus: "<p> Donna was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["While ordering tea, Donna noticed the barista’s new mustache.", "While ordering tea, Gloria noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1326 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Gary waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Carolyn took a quarter from the tip jar.", "Before ordering cake, Gary took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1328 = {
		...
		labels: ["Emma then sat by the window, and read a book for hours.", "Gary then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1361 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Gerald waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Before ordering cake, Gerald took a quarter from the tip jar.", "Before ordering cake, Tyler took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_1391 = {
		...
		labels: ["After ordering, Gabriel stole a salt shaker and left.", "After ordering, George stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
