...
// CODE BODY START
	...
	var q_228 = {
		...
		labels: ["Aaron then sat by the window, and read a book for hours.", "Jennifer then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_253 = {
		...
		labels: ["Justin then sat by the window, and read a book for hours.", "Megan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_258 = {
		...
		labels: ["After ordering, Angela stole a salt shaker and left.", "After ordering, Evelyn stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_323 = {
		...
		labels: ["After ordering, Jacqueline stole a salt shaker and left.", "After ordering, Juan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_353 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_413 = {
		...
		labels: ["After ordering, Carl stole a salt shaker and left.", "After ordering, Andrew stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_448 = {
		...
		labels: ["After ordering, Christina stole a salt shaker and left.", "After ordering, Carl stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_508 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Donald then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_518 = {
		...
		labels: ["After ordering, Martha stole a salt shaker and left.", "After ordering, Julie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_588 = {
		...
		labels: ["After ordering, Harry stole a salt shaker and left.", "After ordering, Deborah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_613 = {
		...
		labels: ["David then sat by the window, and read a book for hours.", "Sarah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_618 = {
		...
		labels: ["Mary then sat by the window, and read a book for hours.", "Diane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_853 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Dennis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_863 = {
		...
		labels: ["Christine then sat by the window, and read a book for hours.", "Joshua then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_873 = {
		...
		labels: ["After ordering, Jennifer stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
