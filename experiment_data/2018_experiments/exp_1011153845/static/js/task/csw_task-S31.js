...
// CODE BODY START
	...
	var q_148 = {
		...
		labels: ["After ordering, Emily stole a salt shaker and left.", "After ordering, Lawrence stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_153 = {
		...
		labels: ["After ordering, Karen stole a salt shaker and left.", "After ordering, Stephanie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_248 = {
		...
		labels: ["Natalie then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_258 = {
		...
		labels: ["Ethan then sat by the window, and read a book for hours.", "Harold then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_328 = {
		...
		labels: ["After ordering, Jerry stole a salt shaker and left.", "After ordering, Marie stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_403 = {
		...
		labels: ["Alexander then sat by the window, and read a book for hours.", "Sean then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_513 = {
		...
		labels: ["After ordering, Janet stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_523 = {
		...
		labels: ["Michelle then sat by the window, and read a book for hours.", "Patrick then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_583 = {
		...
		labels: ["After ordering, Bryan stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_688 = {
		...
		labels: ["Albert then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_703 = {
		...
		labels: ["After ordering, Ethan stole a salt shaker and left.", "After ordering, Michael stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_798 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Logan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
