...
// CODE BODY START
	...
	var q_43 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Natalie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
	...
	var q_48 = {
		...
		labels: ["Kenneth then sat by the window, and read a book for hours.", "Hannah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_58 = {
		...
		labels: ["Ashley then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_63 = {
		...
		labels: ["Nancy then sat by the window, and read a book for hours.", "Jason then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_143 = {
		...
		labels: ["Brian then sat by the window, and read a book for hours.", "Sarah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_158 = {
		...
		labels: ["Steven then sat by the window, and read a book for hours.", "Samantha then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_238 = {
		...
		labels: ["Christine then sat by the window, and read a book for hours.", "Sharon then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_318 = {
		type: "html-keyboard-response",
		stimulus: "<p> Anna was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Anna stole a salt shaker and left.", "After ordering, Deborah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_328 = {
		...
		labels: ["Samantha then sat by the window, and read a book for hours.", "Jesse then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_333 = {
		...
		labels: ["Christopher then sat by the window, and read a book for hours.", "Amanda then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_338 = {
		...
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Joe stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_423 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Henry waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Henry then sat by the window, and read a book for hours.", "Marie then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_503 = {
		...
		labels: ["After ordering, Carol stole a salt shaker and left.", "After ordering, Theresa stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_508 = {
		type: "html-keyboard-response",
		stimulus: "<p> Janice was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_513 = {
		...
		labels: ["Sara then sat by the window, and read a book for hours.", "Louis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_608 = {
		...
		labels: ["After ordering, Aaron stole a salt shaker and left.", "After ordering, Tiffany stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_618 = {
		...
		labels: ["After ordering, Emma stole a salt shaker and left.", "After ordering, Ryan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_688 = {
		...
		labels: ["After ordering, Lisa stole a salt shaker and left.", "After ordering, Christine stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_888 = {
		...
		labels: ["After ordering, Jennifer stole a salt shaker and left.", "After ordering, Kenneth stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
