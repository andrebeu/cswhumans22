...
// CODE BODY START
	...
	var q_133 = {
		...
		labels: ["After ordering, Nathan stole a salt shaker and left.", "After ordering, Lawrence stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_138 = {
		...
		labels: ["After ordering, Samantha stole a salt shaker and left.", "After ordering, Brandon stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_153 = {
		...
		labels: ["Kyle then sat by the window, and read a book for hours.", "Judith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_163 = {
		...
		labels: ["Diana then sat by the window, and read a book for hours.", "Jessica then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_268 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Dylan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_338 = {
		...
		labels: ["Lisa then sat by the window, and read a book for hours.", "Billy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["James then sat by the window, and read a book for hours.", "Jack then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_403 = {
		...
		labels: ["Kelly then sat by the window, and read a book for hours.", "Carolyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_443 = {
		...
		labels: ["After ordering, Adam stole a salt shaker and left.", "After ordering, Roger stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_448 = {
		...
		labels: ["Megan then sat by the window, and read a book for hours.", "Timothy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_533 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Anna then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_538 = {
		...
		labels: ["After ordering, Kevin stole a salt shaker and left.", "After ordering, Zachary stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_588 = {
		...
		labels: ["After ordering, Betty stole a salt shaker and left.", "After ordering, Joseph stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_593 = {
		...
		labels: ["Amy then sat by the window, and read a book for hours.", "Walter then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_808 = {
		...
		labels: ["Jacqueline then sat by the window, and read a book for hours.", "Alan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
