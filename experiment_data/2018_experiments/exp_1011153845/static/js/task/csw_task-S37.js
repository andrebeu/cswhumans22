...
// CODE BODY START
	...
	var q_83 = {
		...
		labels: ["Jacob then sat by the window, and read a book for hours.", "Marilyn then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_148 = {
		...
		labels: ["Dennis then sat by the window, and read a book for hours.", "Angela then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_153 = {
		...
		labels: ["Roy then sat by the window, and read a book for hours.", "Gregory then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_333 = {
		...
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Denise stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_433 = {
		...
		labels: ["Matthew then sat by the window, and read a book for hours.", "Rebecca then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		...
		labels: ["After ordering, Dorothy stole a salt shaker and left.", "After ordering, Danielle stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		...
		labels: ["Harry then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_868 = {
		...
		labels: ["After ordering, Ralph stole a salt shaker and left.", "After ordering, Maria stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_888 = {
		...
		labels: ["Brittany then sat by the window, and read a book for hours.", "Beverly then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
