...
// CODE BODY START
	...
	var q_58 = {
		...
		labels: ["Roger then sat by the window, and read a book for hours.", "Laura then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_63 = {
		...
		labels: ["After ordering, Katherine stole a salt shaker and left.", "After ordering, Donald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_88 = {
		...
		labels: ["Kathleen then sat by the window, and read a book for hours.", "Gabriel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_173 = {
		...
		labels: ["Dennis then sat by the window, and read a book for hours.", "Doris then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_223 = {
		...
		labels: ["After ordering, Joyce stole a salt shaker and left.", "After ordering, Deborah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_228 = {
		...
		labels: ["Mary then sat by the window, and read a book for hours.", "Jane then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_243 = {
		...
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Stephen stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		...
		labels: ["Gabriel then sat by the window, and read a book for hours.", "Frank then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_413 = {
		...
		labels: ["After ordering, Maria stole a salt shaker and left.", "After ordering, Andrew stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_513 = {
		...
		labels: ["After ordering, Michael stole a salt shaker and left.", "After ordering, Raymond stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_583 = {
		...
		labels: ["Madison then sat by the window, and read a book for hours.", "Maria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_683 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Olivia waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["After ordering, Debra stole a salt shaker and left.", "After ordering, Olivia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		...
		labels: ["After ordering, Betty stole a salt shaker and left.", "After ordering, Sara stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		...
		labels: ["After ordering, Judith stole a salt shaker and left.", "After ordering, Susan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_773 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jordan was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["Jordan then sat by the window, and read a book for hours.", "Terry then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_788 = {
		...
		labels: ["After ordering, Samuel stole a salt shaker and left.", "After ordering, Jason stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_858 = {
		...
		labels: ["Judith then sat by the window, and read a book for hours.", "Deborah then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_863 = {
		...
		labels: ["George then sat by the window, and read a book for hours.", "Louis then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_868 = {
		...
		labels: ["After ordering, Amy stole a salt shaker and left.", "After ordering, Margaret stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["After ordering, Justin stole a salt shaker and left.", "After ordering, Nathan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
