...
// CODE BODY START
	...
	var q_53 = {
		...
		labels: ["Rose then sat by the window, and read a book for hours.", "Danielle then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_68 = {
		...
		labels: ["Nicholas then sat by the window, and read a book for hours.", "Benjamin then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_258 = {
		...
		labels: ["Gregory then sat by the window, and read a book for hours.", "Jennifer then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_333 = {
		...
		labels: ["After ordering, Donald stole a salt shaker and left.", "After ordering, Mark stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_348 = {
		...
		labels: ["Alexander then sat by the window, and read a book for hours.", "George then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_418 = {
		...
		labels: ["Frances then sat by the window, and read a book for hours.", "Rose then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_428 = {
		...
		labels: ["Christina then sat by the window, and read a book for hours.", "Virginia then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_438 = {
		...
		labels: ["After ordering, Christopher stole a salt shaker and left.", "After ordering, Dylan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_528 = {
		...
		labels: ["After ordering, Zachary stole a salt shaker and left.", "After ordering, Gregory stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_608 = {
		...
		labels: ["After ordering, Jane stole a salt shaker and left.", "After ordering, Anthony stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_693 = {
		...
		labels: ["Russell then sat by the window, and read a book for hours.", "Kathleen then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["Nancy then sat by the window, and read a book for hours.", "Joyce then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_853 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Judith waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Judith then sat by the window, and read a book for hours.", "Nancy then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_863 = {
		...
		labels: ["Bryan then sat by the window, and read a book for hours.", "Peter then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_893 = {
		...
		labels: ["After ordering, Elizabeth stole a salt shaker and left.", "After ordering, Gabriel stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
