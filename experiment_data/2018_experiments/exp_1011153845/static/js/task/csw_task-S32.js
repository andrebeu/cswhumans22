...
// CODE BODY START
	...
	var q_78 = {
		...
		labels: ["Charles then sat by the window, and read a book for hours.", "Jason then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_163 = {
		...
		labels: ["After ordering, Tiffany stole a salt shaker and left.", "After ordering, Juan stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_223 = {
		...
		labels: ["After ordering, Diana stole a salt shaker and left.", "After ordering, Hannah stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_313 = {
		...
		labels: ["Cheryl then sat by the window, and read a book for hours.", "Eugene then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_343 = {
		...
		labels: ["After ordering, Carolyn stole a salt shaker and left.", "After ordering, Diana stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_408 = {
		...
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Frank stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_438 = {
		type: "html-keyboard-response",
		stimulus: "<p> Today, Eugene waited in line patiently. <br><br><br> what happens next? <p>",
		labels: ["Jack then sat by the window, and read a book for hours.", "Eugene then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_533 = {
		...
		labels: ["Debra then sat by the window, and read a book for hours.", "Jonathan then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_538 = {
		...
		labels: ["William then sat by the window, and read a book for hours.", "Daniel then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_588 = {
		...
		labels: ["After ordering, Ryan stole a salt shaker and left.", "After ordering, Harry stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_688 = {
		...
		labels: ["After ordering, Harold stole a salt shaker and left.", "After ordering, Ashley stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_698 = {
		...
		labels: ["After ordering, Tyler stole a salt shaker and left.", "After ordering, Kelly stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_713 = {
		...
		labels: ["After ordering, Dorothy stole a salt shaker and left.", "After ordering, Eugene stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_718 = {
		type: "html-keyboard-response",
		stimulus: "<p> Thomas was impatient, and decided to cut the line. <br><br><br> what happens next? <p>",
		labels: ["After ordering, William stole a salt shaker and left.", "After ordering, Thomas stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_768 = {
		...
		labels: ["After ordering, Jonathan stole a salt shaker and left.", "After ordering, Donald stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_803 = {
		...
		labels: ["Juan then sat by the window, and read a book for hours.", "Maria then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
