...
// CODE BODY START
	...
	var q_4 = {
		...
		labels: ["Before ordering cake, Ethan took a quarter from the tip jar.", "Before ordering cake, Henry took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
	...
	var q_19 = {
		type: "html-keyboard-response",
		stimulus: "<p> Michelle wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Michelle decides to go to the Jungle Brew House.", "Michelle decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_28 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jacqueline wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Jacqueline decides to go to the Deep Ocean Cafe.", "Jacqueline decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_45 = {
		type: "html-keyboard-response",
		stimulus: "<p> Rose wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Rose decides to go to the Deep Ocean Cafe.", "Rose decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_50 = {
		...
		labels: ["After ordering, Tyler stole a salt shaker and left.", "After ordering, Rose stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_54 = {
		type: "html-keyboard-response",
		stimulus: "<p> Andrea wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Andrea decides to go to the Deep Ocean Cafe.", "Andrea decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
