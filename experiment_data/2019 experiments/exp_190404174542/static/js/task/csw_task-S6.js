...
// CODE BODY START
	...
	var q_2 = {
		type: "html-keyboard-response",
		stimulus: "<p> Walter wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Walter decides to go to the Jungle Brew House.", "Walter decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
	...
	var q_14 = {
		...
		labels: ["Before ordering cake, Shirley took a quarter from the tip jar.", "Before ordering cake, Kelly took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		type: "html-keyboard-response",
		stimulus: "<p> Grace wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Grace decides to go to the Jungle Brew House.", "Grace decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_56 = {
		type: "html-keyboard-response",
		stimulus: "<p> Jesse wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Jesse decides to go to the Jungle Brew House.", "Jesse decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_67 = {
		...
		labels: ["While ordering tea, Robert noticed the barista’s new mustache.", "While ordering tea, Janice noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_69 = {
		...
		labels: ["After ordering, Zachary stole a salt shaker and left.", "After ordering, Janice stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_75 = {
		...
		labels: ["Before ordering cake, Frank took a quarter from the tip jar.", "Before ordering cake, Eugene took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
