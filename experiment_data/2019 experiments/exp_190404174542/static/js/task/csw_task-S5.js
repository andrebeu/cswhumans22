...
// CODE BODY START
	...
	var q_2 = {
		...
		labels: ["Megan decides to go to the Deep Ocean Cafe.", "Megan decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
	...
	var q_32 = {
		...
		labels: ["While ordering tea, Charles noticed the barista’s new mustache.", "While ordering tea, Anthony noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_59 = {
		...
		labels: ["Lauren then sat by the window, and read a book for hours.", "Judith then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_63 = {
		...
		labels: ["Logan decides to go to the Jungle Brew House.", "Logan decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
