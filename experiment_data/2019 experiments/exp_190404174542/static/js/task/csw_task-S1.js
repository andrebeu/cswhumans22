...
// CODE BODY START
	...
	var q_5 = {
		...
		labels: ["While ordering tea, Abigail noticed the barista’s new mustache.", "While ordering tea, Lori noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_7 = {
		...
		labels: ["Raymond then sat by the window, and read a book for hours.", "Abigail then sat by the window, and read a book for hours."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_13 = {
		...
		labels: ["Before ordering cake, Gerald took a quarter from the tip jar.", "Before ordering cake, Pamela took a quarter from the tip jar."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_19 = {
		type: "html-keyboard-response",
		stimulus: "<p> Rachel wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Rachel decides to go to the Deep Ocean Cafe.", "Rachel decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_22 = {
		...
		labels: ["While ordering tea, Louis noticed the barista’s new mustache.", "While ordering tea, Rachel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_28 = {
		type: "html-keyboard-response",
		stimulus: "<p> Diane wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Diane decides to go to the Deep Ocean Cafe.", "Diane decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_37 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gabriel wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Gabriel decides to go to the Jungle Brew House.", "Gabriel decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_40 = {
		...
		labels: ["While ordering tea, Christian noticed the barista’s new mustache.", "While ordering tea, Gabriel noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_46 = {
		type: "html-keyboard-response",
		stimulus: "<p> Gloria wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Gloria decides to go to the Deep Ocean Cafe.", "Gloria decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_64 = {
		type: "html-keyboard-response",
		stimulus: "<p> Randy wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Randy decides to go to the Jungle Brew House.", "Randy decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
