...
// CODE BODY START
	...
	var q_2 = {
		type: "html-keyboard-response",
		stimulus: "<p> Christopher wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Christopher decides to go to the Deep Ocean Cafe.", "Christopher decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
	...
	var q_14 = {
		...
		labels: ["While ordering tea, Christine noticed the barista’s new mustache.", "While ordering tea, Justin noticed the barista’s new mustache."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_20 = {
		type: "html-keyboard-response",
		stimulus: "<p> Larry wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Larry decides to go to the Jungle Brew House.", "Larry decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_34 = {
		...
		labels: ["After ordering, Randy stole a salt shaker and left.", "After ordering, Patricia stole a salt shaker and left."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_38 = {
		type: "html-keyboard-response",
		stimulus: "<p> Heather wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Heather decides to go to the Deep Ocean Cafe.", "Heather decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_47 = {
		type: "html-keyboard-response",
		stimulus: "<p> Roy wants to go out today. <br><br><br> what happens next? <p>",
		labels: ["Roy decides to go to the Jungle Brew House.", "Roy decides to go to the Deep Ocean Cafe."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
	...
	var q_64 = {
		...
		labels: ["Brian decides to go to the Deep Ocean Cafe.", "Brian decides to go to the Jungle Brew House."],
		choices: jsPsych.NO_KEYS,
		trial_duration: MIN_QUESTION_ITI
	}
